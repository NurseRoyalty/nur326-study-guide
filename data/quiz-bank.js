...
window.QUIZ_BANK = {
  ...
  topics: [
    ...
    {
      /* Pathopharm Review topic — see CLAUDE.md's "Exception — Pathopharm
         Review has no live lecture at all" for why these topics carry
         extraPractice questions with mustKnow/eaq left empty, unlike the
         Stage 2 pipeline used everywhere else on this site. No `week` —
         Pathopharm Review isn't numbered like Week 1/2, so the row just
         shows its label with no "Week N" badge.

         Pathopharm Review topics/pages are organized by clinical subject,
         not by the original 7-module scoping (see CLAUDE.md and
         SESSION-LOG.md's 2026-08-21 "reorganize by topic, not module"
         entry for why) — each topic below matches one page 1:1. */
      id: "review-pharm-foundations",
    ...
    {
      id: "review-cellular-immunity",
      label: "Cellular Adaptation, Infection &amp; Immunity",
      sets: {
        mustKnow: [],
        extraPractice: [
          {
            ...
            topic: "Cellular Adaptation, Infection &amp; Immunity",
            source: "quiz-bank"
          },
          {
    ...
    {
      id: "review-diabetes-metsyn",
      label: "Diabetes/Metabolic Syndrome",
      sets: {
        mustKnow: [],
        extraPractice: [
          {
    ...
    {
      id: "review-coagulation-dvt",
      label: "Coagulation/DVT",
      sets: {
        mustKnow: [],
        extraPractice: [
          {
    ...
    {
      id: "review-blood-cells-cbc",
      label: "Blood Cells/CBC Interpretation",
      sets: {
        mustKnow: [],
        extraPractice: [
          {
            ...
            topic: "Blood Cells/CBC Interpretation",
            source: "quiz-bank"
          },
          {
    ...
    {
      id: "review-dementia-depression-sud",
      label: "Dementia, Depression &amp; SUD",
      sets: {
        mustKnow: [],
        extraPractice: [
          {
    ...
    {
      id: "review-gi-gu-skin-hypersensitivity",
      label: "GI, GU, Skin &amp; Hypersensitivity",
      sets: {
        mustKnow: [],
        extraPractice: [
          {
            ...
            topic: "GI, GU, Skin &amp; Hypersensitivity",
            source: "quiz-bank"
          },
          {
    ...
    {
      id: "review-stress-steroids",
      label: "Stress &amp; Steroids",
      sets: {
        mustKnow: [],
        extraPractice: [
          {
...
window.TOPIC_ORDER = ["Antimicrobials &amp; Antibiotics (ABX)", "Antivirals", "HIV &amp; Antiretroviral Therapy (ART)", "Pharmacology Foundations", "Cellular Adaptation, Infection &amp; Immunity", "HTN/HLD", "Diabetes/Metabolic Syndrome", "Coagulation/DVT", "Blood Cells/CBC Interpretation", "Fluid/Electrolytes", "Pain/Seizures", "Dementia, Depression &amp; SUD", "GI, GU, Skin &amp; Hypersensitivity", "Stress &amp; Steroids"];
