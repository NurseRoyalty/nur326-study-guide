  ...
  questions: [
    {
      ...
      options: [
        { text: "Acute bronchitis; risk for secondary bacterial pneumonia" },
        { text: "Epiglottitis; risk for airway obstruction from swelling" },
        { text: "Croup (laryngotracheobronchitis); risk for bronchospasm" },
        { text: "Pharyngitis; risk for peritonsillar abscess formation" }
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        { text: "These symptoms indicate probable influenza; the patient should begin oseltamivir within 24 hours for optimal effectiveness" },
        { text: "This is likely a viral URI that will resolve in 3 days; supportive care with fluids and rest is sufficient treatment" },
        { text: "These symptoms could indicate early sepsis; blood cultures and antibiotics must be started immediately" },
        { text: "This is probable influenza with rapid onset; the flu vaccine will provide immediate protection against this strain" }
      ],
      answer: 0,
    ...
    },
    {
      ...
      options: [
        { text: "Bacterial superinfection from antibiotics; switch to only supportive care and antihistamines" },
        { text: "Viral sinusitis that resolves in 5-7 days; the patient's 3-week duration indicates bacterial infection requiring longer antibiotics" },
        { text: "Underlying allergic inflammation creating obstruction and fluid accumulation that promotes recurrent bacterial infection; treat allergies with antihistamines and consider allergy/ENT evaluation" },
        { text: "Antibiotic resistance; prescribe broader-spectrum antibiotics to cover more organisms" }
      ],
      answer: 2,
    ...
    },
    {
      ...
      options: [
        { text: "Ventilator-associated pneumonia (VAP) occurs because the endotracheal tube bypasses normal upper airway defenses, and bacterial biofilms on the tube can aspirate into lower airways" },
        { text: "The mechanical ventilator aerosolizes bacteria in the ICU environment, increasing exposure to resistant organisms" },
        { text: "Sedation and paralysis medications used with mechanical ventilation suppress the immune system, allowing opportunistic infections" },
        { text: "Prolonged hospitalization increases risk of C. difficile superinfection that migrates to the lungs" }
      ],
      answer: 0,
    ...
    },
    {
      ...
      options: [
        { text: "The rusty-colored sputum is classic for Streptococcus pneumoniae bacterial pneumonia" },
        { text: "This is community-acquired pneumonia (CAP) with better prognosis than hospital-acquired pneumonia" },
        { text: "The progression from URI to pneumonia indicates the patient has severely impaired immunity" },
        { text: "Pleuritic chest pain results from inflammation of the pleura, which contains pain-sensing nerves" },
        { text: "Sputum culture and sensitivity testing should be obtained before starting antibiotics to guide therapy" }
      ],
      answers: [0, 1, 3, 4],
    ...
    },
    {
      ...
      options: [
        { text: "Altered level of consciousness impairs protective airway reflexes and increases silent aspiration risk" },
        { text: "The nasogastric tube bypasses the normal swallowing mechanism and can facilitate reflux" },
        { text: "Acidic gastric contents if aspirated cause more inflammatory damage than neutral pH aspirate" },
        { text: "Proton pump inhibitors should be discontinued because they reduce stomach acid that helps kill aspirated bacteria" },
        { text: "Head-of-bed elevation to 30 degrees and careful monitoring during feeding reduce aspiration risk" }
      ],
      answers: [0, 1, 2, 4],
    ...
    },
    {
      ...
      options: [
        { text: "These findings indicate early respiratory distress and increased work of breathing; the patient is compensating but still managing oxygenation" },
        { text: "These findings indicate respiratory failure; the patient cannot maintain adequate oxygenation and needs immediate intervention" },
        { text: "These findings are expected recovery signs and indicate the patient is clearing the infection; discharge can proceed as planned" },
        { text: "These findings indicate the patient has developed a hospital-acquired secondary pneumonia" }
      ],
      answer: 0,
    ...
    },
    {
      ...
      options: [
        { text: "PCV13 covers 13 strains of Streptococcus pneumoniae, and PPSV23 covers 23 additional strains, providing broader protection when given together" },
        { text: "PCV13 is given first because it stimulates better immunity; PPSV23 is given later to boost protection against strains not covered by PCV13" },
        { text: "PPSV23 is older and has been replaced; patients who received it previously need PCV13 to get updated protection" },
        { text: "The two-vaccine strategy provides redundant coverage of the same 13 strains, which improves immune memory" }
      ],
      answer: 0,
    ...
    },
    {
      ...
      options: [
        { text: "Acute bronchitis is viral (80% of cases) and self-limiting in 3-4 weeks; chronic bronchitis involves airflow obstruction and persistent symptoms for 3+ months per year for 2+ years" },
        { text: "Acute bronchitis causes consolidation on chest X-ray; chronic bronchitis does not" },
        { text: "Acute bronchitis always requires antibiotics; chronic bronchitis is managed with bronchodilators only" },
        { text: "Chronic bronchitis is always caused by smoking; acute bronchitis can be caused by any infection" }
      ],
      answer: 0,
    ...
    },
    {
      ...
      options: [
        { text: "Active URI causes mucosal inflammation and edema; anesthesia and intubation can trigger bronchoconstriction. Postponing 1-2 weeks allows inflammation to resolve and significantly reduces this risk" },
        { text: "URI increases risk only in patients with asthma history; healthy patients can proceed safely with prophylactic bronchodilators" },
        { text: "Anesthesia itself causes bronchospasm regardless of URI status; proceeding is safe if the patient receives post-operative incentive spirometry" },
        { text: "URI increases aspiration risk during intubation, not bronchospasm risk; the procedure can proceed with careful airway management" }
      ],
      answer: 0,
