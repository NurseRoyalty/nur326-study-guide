  ...
  ,
    {
        ...
        "sets": {
            ...
            "extraPractice": [
                                 {
                                     "stem": "A nurse is assessing two clients with urinary symptoms. Client A reports a gradual onset of dysuria, frequency, and urgency but otherwise feels well. Client B reports sudden onset of fever, chills, and flank pain along with frequency and dysuria, and appears acutely ill. Which statement correctly identifies the client with pyelonephritis?",
                                     "options": [
                                         "Client B, whose acute illness reflects kidney-level infection",
                                         "Client A, whose gradual symptoms reflect ascending lower tract infection",
                                         "Client B, whose frequency and urgency appear without any dysuria",
                                         "Client A, whose gradual onset includes chills and CVA tenderness"
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: Pyelonephritis presents with sudden onset, systemic illness, fever, chills, and CVA/flank tenderness plus lower tract symptoms, matching Client B; a lower UTI has gradual onset with the client otherwise feeling well, matching Client A. Incorrect: Client A's gradual, otherwise-well presentation is a lower UTI, not pyelonephritis. Pyelonephritis still includes lower tract symptoms like dysuria in addition to systemic illness, not frequency/urgency alone without dysuria. CVA tenderness and chills are sudden-onset systemic findings of pyelonephritis, not features of Client A's gradual lower UTI presentation.",
                                     "topic": "Renal Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client was treated for a lower UTI with an antibiotic that the causative organism was later found to be resistant to. Several days later, the client develops sudden fever, chills, and flank tenderness. What is the most likely explanation for this change?",
                                     "options": [
                                         "The client developed a new, unrelated bloodstream infection",
                                         "The infection ascended into the kidney, causing pyelonephritis",
                                         "The client is having an expected side effect of the antibiotic",
                                         "The client has developed a stone obstructing the ureter"
                                     ],
                                     "answer": 1,
                                     "rationale": "Correct: An antibiotic-resistant organism means the lower UTI was never actually treated, allowing it to ascend into the kidney and become pyelonephritis, which presents with sudden fever, chills, and flank/CVA tenderness. Incorrect: A bloodstream infection is a separate risk factor for pyelonephritis but nothing in the stem supports a new, unrelated source. Antibiotics are not described on the page as causing fever and flank pain as a side effect. Nothing in the stem indicates a stone; obstruction was not part of this client's history.",
                                     "topic": "Renal Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "Four clients are diagnosed with pyelonephritis and are candidates for first-line treatment with Bactrim (trimethoprim-sulfamethoxazole) or ciprofloxacin. For which client should the nurse anticipate that both of these first-line options will be avoided?",
                                     "options": [
                                         "A client with an uncomplicated, community-acquired infection and low resistance risk",
                                         "A client with recurrent UTIs who will receive a conventional 7 to 14 day course",
                                         "A client who is currently pregnant and managing this infection",
                                         "A client whose culture and sensitivity results are still pending review"
                                     ],
                                     "answer": 2,
                                     "rationale": "Correct: Bactrim and ciprofloxacin are both avoided in pregnancy, which narrows treatment options for a population already at higher risk for pyelonephritis. Incorrect: Uncomplicated community-acquired cases with low resistance risk are exactly the population for whom Bactrim or ciprofloxacin is first-line. Recurrent UTI clients still receive a longer conventional course of these same antibiotics unless pregnant. Pending culture results only mean broad-spectrum therapy is started and later narrowed; it does not rule out these first-line agents.",
                                     "topic": "Renal Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "An elderly client with a known lower UTI develops new confusion and a drop in blood pressure. Which finding should most concern the nurse for progression toward urosepsis rather than an uncomplicated lower UTI?",
                                     "options": [
                                         "The client's baseline report of dysuria and urinary frequency",
                                         "A gradual onset of symptoms over the past several days",
                                         "The client's age as the only risk factor present",
                                         "New confusion and hypotension signaling a systemic response"
                                     ],
                                     "answer": 3,
                                     "rationale": "Correct: Urosepsis is a severe systemic response to a UTI (upper or lower) that is more likely in elderly or already-sick clients; new confusion and hypotension indicate this systemic decline, not a localized bladder infection. Incorrect: Dysuria and frequency are expected baseline lower UTI findings, not signs of sepsis. A gradual onset is typical of an uncomplicated lower UTI, not a sepsis warning. Age alone is a risk factor for urosepsis but is not itself evidence that sepsis is occurring.",
                                     "topic": "Renal Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "Client A develops sudden, severe flank pain from a stone lodged in the ureter. Client B has gradually worsening urinary retention over several years from an enlarging prostate. Based on the drivers of obstructive pain, which client is expected to report more severe pain?",
                                     "options": [
                                         "Client A, because the fast onset and narrow ureteral lumen both worsen pain",
                                         "Client B, because the prostate obstruction is located outside the urinary tract",
                                         "Client A, because external compression from the stone increases pain",
                                         "Client B, because chronic obstruction is inherently more painful than acute obstruction"
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: Speed of onset is the biggest driver of obstructive pain, and a narrow structure like the ureter is far less tolerant of a sudden blockage than a slow-developing obstruction, making Client A's presentation more severe. Incorrect: The prostate is part of the urinary tract, not outside it, and location alone does not explain the pain difference. The stone is an internal obstruction, not an external compressive one. Slow-developing obstructions like BPH are far more tolerable than fast-onset ones, not more painful.",
                                     "topic": "Renal Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with benign prostatic hyperplasia has a history of recurrent UTIs from residual urine. The client now presents with a sudden drop in urine output and hydronephrosis on ultrasound. Which complication of obstruction is now developing?",
                                     "options": [
                                         "A recurrence of the same infectious complication seen previously",
                                         "Retained urine causing back-pressure toward postrenal injury",
                                         "A new stone has formed within the bladder itself",
                                         "Neurogenic bladder unrelated to the prostate obstruction"
                                     ],
                                     "answer": 1,
                                     "rationale": "Correct: Because the kidneys keep producing urine even when it cannot exit, pressure builds upstream of the blockage, causing hydroureter/hydronephrosis that can progress to postrenal AKI and typically requires emergency surgical correction. Incorrect: The infection complication was the prior recurrent UTI pattern, not the new oliguria and hydronephrosis. Stones do not form in the bladder; they form at the kidney/nephron level. Neurogenic bladder is a distinct, non-obstructive process related to spinal or neuromuscular injury, not this client's BPH-driven back-pressure.",
                                     "topic": "Renal Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client who passed a kidney stone states, 'The stone must have formed in my bladder since that's where I felt the sharpest pain before I passed it.' How should the nurse respond?",
                                     "options": [
                                         "Confirm this is correct, since stones commonly form where urine collects in the bladder",
                                         "Explain that stones typically form in the ureter due to urine stasis at that level",
                                         "Explain that crystals always begin forming at the kidney/nephron level, not the bladder",
                                         "Explain that stone location depends on which type of crystal is involved"
                                     ],
                                     "answer": 2,
                                     "rationale": "Correct: Crystal formation always occurs at the level of the kidney/nephron, where urine first becomes supersaturated with solutes; stones never begin forming in the bladder or ureter. Incorrect: Stones do not form in the bladder; the client's sharp pain there reflects the stone's passage, not its origin. Stones also do not begin forming in the ureter. Regardless of stone type (calcium, struvite, uric acid, cystine), formation always starts at the kidney/nephron level.",
                                     "topic": "Renal Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with a long-standing history of gout and a family history of calcium stones develops a new kidney stone. Based on this presentation, which stone type should the nurse most suspect?",
                                     "options": [
                                         "A cystine stone, given the client's combined risk factors",
                                         "A calcium stone, since family history is the primary driver of calcium stone formation",
                                         "A struvite (staghorn) stone, given the client's chronic underlying condition",
                                         "A uric acid stone, since active gout is the strongest predictor here"
                                     ],
                                     "answer": 3,
                                     "rationale": "Correct: A client with gout who develops a kidney stone most likely has a uric acid stone, since uric acid stones are specifically linked to gout. Incorrect: Cystine stones are rare, accounting for less than 1% of stones, and are not linked to gout or family history. Family history is associated with calcium stones, but the client's active gout is the more specific predictor here of a uric acid stone rather than calcium. Struvite (staghorn) stones are related to UTIs, not gout.",
                                     "topic": "Renal Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client reports flank pain radiating to the groin in waves lasting about 30-45 minutes, along with nausea. The client also has a temperature of 101.8°F (38.8°C). How should the nurse interpret the fever in this presentation?",
                                     "options": [
                                         "A coexisting pyelonephritis infection is likely present",
                                         "Fever is an expected feature of uncomplicated renal colic",
                                         "Fever reflects the normal 20-60 minute pain wave pattern",
                                         "Fever indicates the stone has now reached the urethra"
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: Fever is not a typical symptom of renal colic alone; fever accompanying a kidney stone points toward a coexisting infection, most likely pyelonephritis, from urine backing up behind the stone. Incorrect: Renal colic itself does not typically cause fever; nausea, sharp pain, and waves of about 20-60 minutes are expected without infection. The pain wave pattern is unrelated to temperature. Stones rarely reach the urethra, and doing so would not explain a fever.",
                                     "topic": "Renal Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client has recurrent staghorn calculi and a history of chronic urinary tract infections. Which prevention strategy is most appropriate for this client?",
                                     "options": [
                                         "A thiazide diuretic to reduce urinary calcium excretion",
                                         "Antibiotics and fluids to treat the infection",
                                         "Allopurinol to lower uric acid production",
                                         "Scheduled IV ketorolac to prevent future colic episodes"
                                     ],
                                     "answer": 1,
                                     "rationale": "Correct: Struvite (staghorn) stones are related to UTIs, so prevention focuses on treating the underlying infection with antibiotics along with fluids. Incorrect: Thiazide diuretics prevent recurrent calcium stones, not struvite stones. Allopurinol treats the gout underlying uric acid stones, not struvite stones. Ketorolac (an NSAID) treats acute colic pain and is not a prevention strategy for recurrent stones.",
                                     "topic": "Renal Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "Client A, a long-time smoker, has a kidney mass found incidentally on CT and now reports CVA tenderness and cola-colored urine. Client B, also a long-time smoker, has hematuria noted only on urinalysis with no other symptoms. Which client's findings suggest disease that is more likely still curable at this stage?",
                                     "options": [
                                         "Client A, because incidental imaging findings always indicate early-stage disease",
                                         "Client A, because cola-colored urine is an early manifestation of kidney cancer",
                                         "Client B, because early hematuria on UA may allow detection before metastasis",
                                         "Client B, because smoking is a stronger risk factor for bladder cancer than kidney cancer"
                                     ],
                                     "answer": 2,
                                     "rationale": "Correct: Bladder cancer's early manifestation is hematuria, sometimes visible only on urinalysis, allowing detection and treatment (such as intravesical chemotherapy) before advanced disease develops. Incorrect: Kidney cancer has no early manifestations and is usually not found until metastasized, so an incidental mass with CVA tenderness and cola-colored urine (late manifestations) suggests more advanced disease, not an early finding. Cola-colored hematuria is a late, not early, manifestation of kidney cancer. Smoking is the number one risk factor for both kidney and bladder cancer equally, not more strongly linked to one.",
                                     "topic": "Renal Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with HIV/AIDS is scheduled to begin BCG intravesical therapy for early-stage bladder cancer. What is the nurse's priority action?",
                                     "options": [
                                         "Proceed as scheduled, since BCG only affects the bladder locally",
                                         "Reinforce the need to change position every 15 minutes during instillation",
                                         "Teach the client to disinfect urine with bleach for 6 hours after treatment",
                                         "Notify the provider; BCG should not be given to an immunocompromised client"
                                     ],
                                     "answer": 3,
                                     "rationale": "Correct: BCG is a live vaccine, and giving it to a client who is immunocompromised (such as with HIV/AIDS) risks development of a systemic infection from the weakened live bacteria, so the provider should be notified before proceeding. Incorrect: BCG is not purely local; its live bacterial component can cause systemic infection in an immunocompromised host, so proceeding as scheduled is unsafe. Position changes every 15 minutes and bleach disinfection of urine are both real components of BCG teaching, but they do not address the priority safety concern of administering a live vaccine to an immunocompromised client.",
                                     "topic": "Renal Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with nephrotic syndrome has lost more than 3 g of protein in a 24-hour urine collection. Which findings should the nurse expect as a result of this protein loss? Select all that apply.",
                                     "options": [
                                         "Peripheral edema and third-spacing from loss of oncotic pressure",
                                         "Increased risk for DVT/PE from loss of antithrombin III and plasminogen",
                                         "Hyperlipidemia from increased hepatic lipid production",
                                         "Hypertension from renin-angiotensin activation via sensed volume depletion",
                                         "Hematuria as the hallmark presenting sign, as in acute glomerulonephritis",
                                         "Hypocoagulability with increased bleeding tendency from clotting factor loss"
                                     ],
                                     "answers": [
                                         0,
                                         1,
                                     ...
                                     "rationale": "Correct: Loss of albumin removes the oncotic pressure that holds fluid in vessels, causing edema and third-spacing; loss of antithrombin III and plasminogen creates a hypercoagulable state raising DVT/PE risk; the liver increases lipid production in response to ongoing protein loss, causing hyperlipidemia; and reduced circulating volume activates the renin-angiotensin system, raising blood pressure. Incorrect: Hematuria is the hallmark of the HARP presentation in acute glomerulonephritis, not the protein-loss picture that defines nephrotic syndrome. Nephrotic syndrome causes hypercoagulability, not hypocoagulability, because clotting-inhibitor proteins (antithrombin III, plasminogen) are lost, not clotting factors themselves.",
                                     "topic": "Renal Disorders",
                                     "source": "quiz-bank"
                                 }
                             ],
    ...
    {
        "id": "week3-aki-ckd",
        "label": "Acute Kidney Injury &amp; Chronic Kidney Disease",
        "week": 3,
        "sets": {
            "mustKnow": [],
            "extraPractice": [
                                 {
                                     "stem": "A client develops oliguria after a motor vehicle collision requiring emergency surgery for significant blood loss. Which classification of acute kidney injury does this presentation reflect?",
                                     "options": [
                                         "Prerenal AKI from volume loss to the kidney",
                                         "Intrarenal AKI from acute tubular necrosis",
                                         "Postrenal AKI from urinary tract obstruction",
                                         "Intrarenal AKI from glomerulonephritis"
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: Prerenal AKI is the most common category, caused by volume loss (such as blood loss during surgery) reducing perfusion before blood reaches the kidney. Incorrect: Acute tubular necrosis and glomerulonephritis are intrarenal causes involving direct damage inside the kidney, not a volume problem; urinary tract obstruction is a postrenal cause, which is the least common category.",
                                     "topic": "Acute Kidney Injury &amp; Chronic Kidney Disease",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "Two days after a hypotensive episode during surgery, a client's urine output has been 250 mL over the past 24 hours. Which statement by the nurse about this finding is most accurate?",
                                     "options": [
                                         "Output above 30 mL/hr would reflect normal kidney function",
                                         "This fits AKI, starting about a day after hypotension",
                                         "Oliguria means less than 100 mL of urine per day",
                                         "This suggests postrenal obstruction, not a perfusion problem"
                                     ],
                                     "answer": 1,
                                     "rationale": "Correct: AKI-related oliguria (under 400 mL/24hr, under 30 mL/hr) typically begins about one day after a hypotensive event such as surgery, matching this timeline. Incorrect: 30 mL/hr is the oliguria threshold itself, not a marker of normal function; oliguria is defined as under 400 mL/24hr, not under 100 mL; the history of a hypotensive event points to a perfusion-related cause, not obstruction.",
                                     "topic": "Acute Kidney Injury &amp; Chronic Kidney Disease",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client's GFR is measured at 27 mL/hr. The nurse understands this value represents which condition, and what does it imply about the kidneys' remaining function?",
                                     "options": [
                                         "Normal GFR, so the kidneys are compensating fully",
                                         "Stage 5 CKD, meaning the client is uremic",
                                         "Renal insufficiency, about 25% of normal GFR",
                                         "Postrenal obstruction requiring immediate dialysis"
                                     ],
                                     "answer": 2,
                                     "rationale": "Correct: A GFR of about 25-30 mL/hr (roughly 25% of the normal, over-90 threshold) defines renal insufficiency, a state the body can compensate for temporarily before it may progress to chronic disease. Incorrect: Normal GFR is above 90; Stage 5/uremic CKD reflects near-total loss of function, well below this value; GFR alone does not indicate a postrenal cause or an immediate need for dialysis.",
                                     "topic": "Acute Kidney Injury &amp; Chronic Kidney Disease",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A nurse is developing a community screening program to reduce new cases of end-stage renal disease. Based on the leading causes of ESRD, which two chronic conditions should the program prioritize screening for?",
                                     "options": [
                                         "Glomerulonephritis and unresolved AKI",
                                         "Obesity and cigarette smoking",
                                         "Hyperlipidemia and coronary artery disease",
                                         "Diabetes and hypertension"
                                     ],
                                     "answer": 3,
                                     "rationale": "Correct: Diabetes (about 50%) and hypertension (about 30%) together cause about 80% of ESRD cases, making them the priority targets for prevention. Incorrect: Glomerulonephritis and unresolved AKI fall under the smaller 'other' (about 20%) category; obesity and smoking are risk factors but not the two leading causes; hyperlipidemia and CAD are other vascular risk factors, not the top two causes.",
                                     "topic": "Acute Kidney Injury &amp; Chronic Kidney Disease",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with CKD has a urinalysis showing significant protein and a blood pressure of 168/98 mmHg despite an increasing dose of antihypertensives. The nurse recognizes these two findings together as most concerning because they reflect which pathogenic cycle?",
                                     "options": [
                                         "Proteinuria and elevated angiotensin II, the biggest drivers of CKD",
                                         "Hyperkalemia and metabolic acidosis, the major electrolyte concern in CKD",
                                         "Hyperphosphatemia and hypermagnesemia, common CKD electrolyte findings",
                                         "Anemia and pericarditis, signs of advanced cardiovascular involvement"
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: Proteinuria (from a leaky, damaged glomerular basement membrane) and increased angiotensin II (a potent vasoconstrictor driving hypertension) are the two biggest indicators and drivers of worsening CKD, making blood pressure control and urine protein monitoring ongoing priorities. Incorrect: Hyperkalemia and metabolic acidosis are fluid-and-electrolyte manifestations of CKD, not the named progression drivers; hyperphosphatemia and hypermagnesemia are also fluid-and-electrolyte findings, not progression drivers; anemia and pericarditis are hematologic and cardiovascular manifestations, not the two drivers of worsening disease.",
                                     "topic": "Acute Kidney Injury &amp; Chronic Kidney Disease",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with CKD has a hemoglobin of 6.2 g/dL but reports only mild fatigue and continues most daily activities. Another client loses an equivalent amount of blood acutely during a GI bleed and becomes symptomatic with dizziness and tachycardia. What explains the CKD client's comparatively mild symptoms?",
                                     "options": [
                                         "The CKD client's kidneys are still producing adequate erythropoietin",
                                         "Its slow decline causes fewer symptoms than an equivalent acute loss",
                                         "Chronic acidosis in CKD offsets the effects of low hemoglobin",
                                         "Renal osteodystrophy has developed and is masking the anemia symptoms"
                                     ],
                                     "answer": 1,
                                     "rationale": "Correct: Because CKD-related anemia (from lost erythropoietin production) develops slowly and hemoglobin can fall as low as 5-6 g/dL over time, clients often have fewer symptoms than someone who loses the same amount of blood acutely. Incorrect: CKD anemia results from reduced, not adequate, erythropoietin production; metabolic acidosis is a separate CKD finding and does not offset anemia symptoms; renal osteodystrophy is a bone complication from loss of activated vitamin D and is unrelated to anemia symptom severity.",
                                     "topic": "Acute Kidney Injury &amp; Chronic Kidney Disease",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with CKD-related anemia is prescribed erythropoietin. Before administering the dose, which finding is most important for the nurse to verify given the drug's black-box warning?",
                                     "options": [
                                         "Serum phosphate level, since erythropoietin can worsen hyperphosphatemia",
                                         "Serum calcium level, to prevent hypercalcemia from the medication",
                                         "Current hemoglobin level, to avoid giving the drug above 10 g/dL",
                                         "Serum bicarbonate level, to confirm it is above the 18-20 goal range"
                                     ],
                                     "answer": 2,
                                     "rationale": "Correct: Erythropoietin carries a black-box warning for overcorrecting hemoglobin, so it should not be given when hemoglobin is already above 10 g/dL, since this raises the risk of stroke, MI, and thromboembolism. Incorrect: Phosphate and calcium levels relate to hyperphosphatemia/renal osteodystrophy treatment with calcium carbonate and calcitriol, not to erythropoietin's warning; bicarbonate relates to sodium bicarbonate therapy for metabolic acidosis, not erythropoietin.",
                                     "topic": "Acute Kidney Injury &amp; Chronic Kidney Disease",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A nurse is caring for two postoperative clients in pain: one with normal kidney function and one with severe, poorly-filtering CKD. Both are prescribed the same standard opioid dose. Which is the priority safety concern for the nurse?",
                                     "options": [
                                         "Opioids are not among the medications that need renal dose adjustment in CKD",
                                         "The CKD client should be switched to vancomycin, which has its own renal dosing protocol",
                                         "The CKD client's digoxin dose should be adjusted to offset the opioid's effects",
                                         "The CKD client will retain the opioid longer, raising respiratory depression risk"
                                     ],
                                     "answer": 3,
                                     "rationale": "Correct: In severe CKD the kidneys are not filtering effectively, so the opioid is retained far longer than normal, making respiratory depression the priority safety concern for this client. Incorrect: Opioids are specifically named as a medication needing renal dose adjustment in CKD, not an exception; vancomycin's dedicated renal dosing protocol applies to vancomycin itself, not to managing this client's opioid; digoxin also needs renal dosing, but adjusting it does not address the opioid retention risk.",
                                     "topic": "Acute Kidney Injury &amp; Chronic Kidney Disease",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with CKD-related hyperphosphatemia is taking both calcium carbonate and calcitriol. Which adverse effect should the nurse monitor for because it can result from either drug?",
                                     "options": [
                                         "Hypercalcemia",
                                         "Hyperkalemia",
                                         "Metabolic acidosis",
                                     ...
                                     "answer": 0,
                                     "rationale": "Correct: Calcium carbonate's adverse effect is hypercalcemia, and calcitriol's adverse effects are both hypercalcemia and hyperphosphatemia, so hypercalcemia can result from either drug, requiring close calcium and phosphate monitoring. Incorrect: Hyperkalemia and metabolic acidosis are not listed adverse effects of either drug; hypophosphatemia is the opposite of the hyperphosphatemia these drugs are meant to treat and is not an adverse effect of either.",
                                     "topic": "Acute Kidney Injury &amp; Chronic Kidney Disease",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with CKD asks the nurse why the provider will not prescribe both an ACE inhibitor and an ARB together to get her blood pressure 'as low as possible.' Which response by the nurse is most accurate?",
                                     "options": [
                                         "Combining them is required to reach the CKD BP goal of below 120/80",
                                         "They should never be combined; goal is systolic under 140, diastolic under 90",
                                         "Combining them is safe and recommended, since it will help reverse further kidney damage",
                                         "Combining them would help correct the client's metabolic acidosis faster"
                                     ],
                                     "answer": 1,
                                     "rationale": "Correct: ACE inhibitors and ARBs should never be combined, and the CKD blood pressure goal is systolic under 140 and diastolic under 90, not lowered too aggressively, since CKD kidneys are accustomed to higher perfusion pressure. Incorrect: A goal of below 120/80 is more aggressive than the stated CKD target; no CKD drug reverses kidney damage, so combining these agents would not do so; acidosis in CKD is corrected with sodium bicarbonate, not by combining ACE inhibitors and ARBs.",
                                     "topic": "Acute Kidney Injury &amp; Chronic Kidney Disease",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with CKD has a serum bicarbonate of 14 mEq/L. The nurse anticipates which treatment and expects it to achieve which goal?",
                                     "options": [
                                         "Calcitriol, to raise bicarbonate above 25",
                                         "Erythropoietin, to raise bicarbonate above 20",
                                         "Sodium bicarbonate, goal bicarb of 18-20",
                                         "Calcium carbonate, to raise bicarbonate above 15"
                                     ],
                                     "answer": 2,
                                     "rationale": "Correct: Sodium bicarbonate is the alkalinizing agent used for CKD-related metabolic acidosis, typically started when bicarbonate falls under 15, with a goal of raising it to 18-20. Incorrect: Calcitriol treats renal osteodystrophy/hyperphosphatemia, not acidosis; erythropoietin treats anemia; calcium carbonate binds phosphate, and 15 is the threshold for starting acidosis treatment, not a treatment goal itself, and neither drug raises bicarbonate.",
                                     "topic": "Acute Kidney Injury &amp; Chronic Kidney Disease",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A nurse reviews the plan of care for a client with CKD. Which complication-and-treatment pairs are correctly matched? Select all that apply.",
                                     "options": [
                                         "Volume overload: furosemide and a sodium-restricted diet of about 2g/day",
                                         "Hyperphosphatemia: calcium carbonate taken with meals",
                                         "Metabolic acidosis: sodium bicarbonate, with a goal bicarbonate of 18-20",
                                         "Anemia: calcitriol to stimulate erythropoietin production",
                                         "Hyperkalemia: erythropoietin given daily to lower serum potassium levels",
                                         "Renal osteodystrophy: calcitriol to aid calcium and phosphate absorption"
                                     ],
                                     "answers": [
                                         0,
                                         1,
                                     ...
                                     "rationale": "Correct: Volume overload is treated with a diuretic (usually furosemide) plus a roughly 2g/day sodium-restricted diet; hyperphosphatemia is treated with calcium carbonate, taken with meals to bind dietary phosphate; metabolic acidosis is treated with sodium bicarbonate, with a goal bicarbonate of 18-20; renal osteodystrophy is treated with calcitriol, which stimulates intestinal absorption of calcium and phosphate. Incorrect: Anemia is treated with erythropoietin, not calcitriol, which is used for osteodystrophy rather than to stimulate erythropoietin production; hyperkalemia is managed with a diuretic, Kayexalate, or dialysis, not erythropoietin, which treats anemia and carries a black-box warning for overcorrection.",
                                     "topic": "Acute Kidney Injury &amp; Chronic Kidney Disease",
                                     "source": "quiz-bank"
                                 }
                             ],
    ...
    {
        "id": "week3-male-reproductive-disorders",
        "label": "Male Reproductive Disorders",
        "week": 3,
        "sets": {
            "mustKnow": [],
            "extraPractice": [
                                 {
                                     "stem": "A 28-year-old man tells the nurse he had surgery for an undescended testicle at age 2 and asks whether his cancer risk is now the same as men without that history. Which response is accurate?",
                                     "options": [
                                         "Even though the testicle was corrected, your risk stays elevated for life.",
                                         "Because the testicle was corrected, your risk returned to the general population level.",
                                         "Your risk only applies if the correction happened after puberty began.",
                                         "Surgical correction removes risk as long as no mass has developed yet."
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: Cryptorchidism is the biggest risk factor for testicular cancer, and the risk remains elevated for life even after the undescended testicle is surgically corrected in childhood. Incorrect: Surgical correction does not return risk to baseline; the timing of correction relative to puberty is not the determining factor; and correction does not remove risk based on whether a mass has developed.",
                                     "topic": "Male Reproductive Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "Two men are newly diagnosed with germ cell testicular tumors. Client A's tumor is described as slower-growing and more radiosensitive; Client B's tumor is described as spreading more quickly. Which statement about their prognosis is correct?",
                                     "options": [
                                         "Client B's nonseminoma has a much lower overall survival rate than Client A's seminoma.",
                                         "Both tumor types have high overall survival despite differing growth rates.",
                                         "Client A's tumor must be nonseminoma since it is more radiosensitive.",
                                         "Only Client A's slower-growing tumor is classified as a germ cell tumor."
                                     ],
                                     "answer": 1,
                                     "rationale": "Correct: Seminoma grows more slowly and is more radiosensitive while nonseminoma spreads more quickly, but both germ cell tumor types have high overall survival rates. Incorrect: Nonseminoma's faster spread does not translate to a much lower survival rate; radiosensitivity and slower growth describe seminoma, not nonseminoma; and both tumor types described are germ cell tumors, not just the slower-growing one.",
                                     "topic": "Male Reproductive Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client newly diagnosed with BPH says, 'I read that if this isn't treated, it could turn into prostate cancer.' The client also reports urinary hesitancy and a weak stream. Which response addresses both the concern and the cause of the urinary symptoms?",
                                     "options": [
                                         "BPH symptoms occur because DHT directly damages the bladder wall, not because it develops into cancer.",
                                         "BPH will progress to prostate cancer over time, which is why your urinary symptoms have started.",
                                         "BPH does not turn into cancer; symptoms occur because the enlarged prostate squeezes the urethra.",
                                         "BPH symptoms occur because the tumor has spread to the bladder, but the prostate itself remains benign."
                                     ],
                                     "answer": 2,
                                     "rationale": "Correct: BPH is a benign overgrowth of prostate tissue that does not turn into cancer, and its urinary symptoms occur because the enlarged gland squeezes the urethra it surrounds. Incorrect: DHT accumulation is a proposed cause of the overgrowth itself, not direct bladder wall damage; BPH does not progress into prostate cancer; and BPH involves no tumor spread since it is non-malignant.",
                                     "topic": "Male Reproductive Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with moderate-to-severe BPH is prescribed both finasteride and tamsulosin and asks why two medications are needed. Which explanation is correct?",
                                     "options": [
                                         "Tamsulosin shrinks the prostate immediately, while finasteride relaxes smooth muscle over months.",
                                         "Both medications shrink the prostate gland at the same rate, so combining them shrinks it faster.",
                                         "Finasteride relieves symptoms within days, while tamsulosin takes months to shrink the gland.",
                                         "Tamsulosin relieves symptoms quickly, while finasteride shrinks the gland over months."
                                     ],
                                     "answer": 3,
                                     "rationale": "Correct: In combination therapy, the alpha-1 blocker tamsulosin relaxes smooth muscle to relieve symptoms right away while the 5-alpha reductase inhibitor finasteride shrinks the gland over months. Incorrect: Tamsulosin relaxes muscle rather than shrinking the gland immediately; the two drug classes do not shrink the gland at the same rate; and it is finasteride, not tamsulosin, that takes months and works by shrinking the gland.",
                                     "topic": "Male Reproductive Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with long-standing untreated BPH develops rising creatinine and bilateral hydronephrosis. Which complication does this most likely represent?",
                                     "options": [
                                         "Obstructive nephropathy from severe urethral obstruction causing urine backup to the kidneys.",
                                         "Acute prostatitis causing direct bacterial invasion of the kidney and urinary tract tissue.",
                                         "Malignant transformation of the prostate tissue that has metastasized to the kidneys directly.",
                                         "Priapism-related vascular congestion that reduces normal blood flow to the kidneys over time."
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: When BPH obstruction is severe or prolonged enough, urine can back up all the way to the kidneys, causing obstructive nephropathy. Incorrect: Prostatitis is not described as invading kidney tissue; BPH is benign and does not undergo malignant transformation or metastasis; and priapism is an unrelated erectile dysfunction emergency, not a cause of renal obstruction.",
                                     "topic": "Male Reproductive Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A 68-year-old man with a history of BPH has a mildly elevated PSA and anxiously requests an immediate prostate biopsy. Which teaching point addresses the limitation of PSA screening here?",
                                     "options": [
                                         "An elevated PSA is specific to prostate cancer, so biopsy should proceed without delay.",
                                         "PSA is elevated by BPH too, so it doesn't confirm cancer and risks overdiagnosis.",
                                         "PSA elevation only occurs with metastatic disease, so this result suggests advanced cancer.",
                                         "PSA is not affected by benign prostate conditions, so this elevation is concerning for malignancy."
                                     ],
                                     "answer": 1,
                                     "rationale": "Correct: PSA can be elevated by BPH and prostatitis as well as cancer, so it is not cancer-specific, and screening can lead to overdiagnosis and unnecessary biopsy. Incorrect: PSA is not specific to cancer; PSA elevation is not limited to metastatic disease and can occur early or from benign causes; and benign conditions like this client's BPH can and do raise PSA.",
                                     "topic": "Male Reproductive Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "One client has early-stage BPH and another has early-stage prostate cancer. Which statement correctly differentiates their expected presentations?",
                                     "options": [
                                         "Both conditions typically cause urinary symptoms early because both directly obstruct the urethra.",
                                         "The BPH client will be asymptomatic while the prostate cancer client develops bone pain immediately.",
                                         "BPH causes early obstructive symptoms; prostate cancer is usually asymptomatic until advanced.",
                                         "Neither condition typically causes symptoms until the disease has metastasized to bone."
                                     ],
                                     "answer": 2,
                                     "rationale": "Correct: BPH causes obstructive urinary symptoms early because of where it grows around the urethra, while prostate cancer is usually asymptomatic until it becomes advanced or metastatic. Incorrect: Prostate cancer, not BPH, is typically silent early; bone pain from metastasis develops only with advanced disease, not immediately; and BPH does cause early symptoms, so neither condition being symptom-free is inaccurate.",
                                     "topic": "Male Reproductive Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A biopsy report shows a high Gleason score with poorly differentiated tissue architecture. Which interpretation is correct?",
                                     "options": [
                                         "This finding indicates a slow-growing, well-differentiated tumor with a favorable prognosis.",
                                         "This finding is unrelated to tumor aggressiveness and reflects only tumor size.",
                                         "This finding indicates the tissue closely resembles normal prostate tissue.",
                                         "This finding indicates a more aggressive, less differentiated cancer."
                                     ],
                                     "answer": 3,
                                     "rationale": "Correct: A higher Gleason score reflects tissue that looks more abnormal and less differentiated under the microscope, indicating a more aggressive cancer. Incorrect: A high score with poor differentiation indicates aggressiveness, not a favorable, slow-growing profile; the Gleason score directly reflects aggressiveness, not size; and poorly differentiated tissue looks less like normal prostate tissue, not more.",
                                     "topic": "Male Reproductive Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client taking sildenafil for erectile dysfunction is prescribed nitroglycerin for chest pain. Which explanation describes why this combination is dangerous?",
                                     "options": [
                                         "Both drugs lower BP via the same NO/cGMP pathway, risking severe hypotension.",
                                         "Sildenafil increases PDE5 activity, which combines with nitroglycerin to cause hypertension.",
                                         "Nitroglycerin blocks the breakdown of cGMP, which combines with sildenafil to cause priapism.",
                                         "Both drugs act on androgen receptors, which combines to suppress testosterone production."
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: Sildenafil and nitrates both lower blood pressure through the same nitric oxide/cGMP pathway, and combining them can cause a severe, life-threatening drop in blood pressure. Incorrect: Sildenafil blocks PDE5 rather than increasing its activity, and the danger is hypotension, not hypertension; nitroglycerin does not block PDE5 breakdown of cGMP, and the risk is blood pressure drop, not priapism; and neither drug is described as acting on androgen receptors or testosterone.",
                                     "topic": "Male Reproductive Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "The nurse is teaching a client about erectile dysfunction and PDE5 inhibitor therapy. Which statements are accurate? Select all that apply.",
                                     "options": [
                                         "Vascular disease and diabetes are examples of organic causes of erectile dysfunction.",
                                         "Performance anxiety and relationship stress can cause erectile dysfunction even when blood flow and nerve function are normal.",
                                         "Sildenafil is taken as a standing daily dose to prevent erectile dysfunction.",
                                         "An erection lasting more than 4 hours unrelated to sexual stimulation is a urologic emergency requiring immediate medical attention.",
                                         "Pelvic surgery and low testosterone are classified as psychogenic causes of erectile dysfunction, distinct from vascular or neurologic organic causes.",
                                         "PDE5 inhibitors work by directly increasing nitric oxide release from penile nerve endings."
                                     ],
                                     "answers": [
                                         0,
                                         1,
                                     ...
                                     "rationale": "Correct: Vascular disease and diabetes are organic (primary) causes of ED; performance anxiety and relationship stress are psychogenic (secondary) causes that can occur even with normal blood flow and nerves; and priapism, an erection lasting more than 4 hours unrelated to stimulation, is a true urologic emergency requiring immediate attention. Incorrect: Sildenafil is taken before sexual activity, not as a standing daily dose for most patients; pelvic surgery and low testosterone are organic, not psychogenic, causes; and PDE5 inhibitors work by blocking the enzyme that breaks down cGMP, not by increasing nitric oxide release.",
                                     "topic": "Male Reproductive Disorders",
                                     "source": "quiz-bank"
                                 }
                             ],
    ...
    {
        "id": "week3-visual-sensory-disorders",
        "label": "Visual &amp; Sensory Disorders",
        "week": 3,
        "sets": {
            "mustKnow": [],
            "extraPractice": [
                                 {
                                     "stem": "A client arrives at the emergency department reporting sudden floaters, flashing lights, and a curtain-like shadow moving across the visual field in the left eye only, with no eye pain. The nurse recognizes these findings as most consistent with which condition?",
                                     "options": [
                                         "Retinal detachment",
                                     ...
                                     "answer": 0,
                                     "rationale": "Correct: Retinal detachment causes sudden, painless, unilateral floaters, flashing lights, and a curtain/shadow effect, and requires emergency treatment to prevent permanent vision loss. Incorrect: Acute closed-angle glaucoma is also sudden but is painful, often with headache, unlike this client's pain-free presentation. Open-angle glaucoma develops gradually from slowed drainage through the trabecular meshwork, not suddenly. Cataracts cause gradual, painless, often bilateral blurring from lens clouding, not sudden unilateral floaters.",
                                     "topic": "Visual &amp; Sensory Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "The nurse is assessing two clients before lunch. Client A reports sudden severe eye pain, headache, and halos around lights that began one hour ago. Client B reports blurry vision that has gradually worsened over the past two years with no pain. Which client should the nurse assess first?",
                                     "options": [
                                         "Client B, because slowly progressive vision loss always signals a retinal bleed",
                                         "Client A, because acute angle-closure can cause permanent loss within hours",
                                         "Client A, because open-angle glaucoma produces sudden painless pressure spikes",
                                         "Client B, because cataracts require same-day emergency lens removal"
                                     ],
                                     "answer": 1,
                                     "rationale": "Correct: Acute closed-angle glaucoma is a true emergency in which a sudden pressure spike from iris blockage of the drainage angle can cause permanent vision loss within hours, requiring immediate treatment rather than routine follow-up. Incorrect: Client B's gradual, painless vision loss over years is consistent with a chronic process such as cataracts, not an emergency retinal bleed. Open-angle glaucoma develops gradually from slow trabecular meshwork dysfunction, so it does not explain Client A's sudden painful presentation. Cataracts are treated surgically but are not a same-day emergency, since the clouding develops gradually.",
                                     "topic": "Visual &amp; Sensory Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client newly diagnosed with macular degeneration asks the nurse which form is most common. Which response by the nurse is accurate?",
                                     "options": [
                                         "About 90% of cases are wet, caused by abnormal new vessels leaking under the macula",
                                         "About 10% of cases are dry, caused by gradual thinning and breakdown of the macula",
                                         "About 90% of cases are dry, caused by gradual thinning and breakdown of the macula",
                                         "Both forms occur with equal frequency and involve new vessel growth under the macula"
                                     ],
                                     "answer": 2,
                                     "rationale": "Correct: Dry (non-neovascular) macular degeneration accounts for about 90% of cases and results from gradual thinning and breakdown of the macula over time. Incorrect: Wet (neovascular) macular degeneration, caused by abnormal vessel growth and leakage under the macula, accounts for only about 10% of cases, not 90%. Stating dry disease is only 10% reverses the actual proportions. The two forms do not occur with equal frequency, and new vessel growth is specific to the wet form, not the dry form.",
                                     "topic": "Visual &amp; Sensory Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with a history of open-angle glaucoma is prescribed a new medication for overactive bladder that has anticholinergic effects. The nurse recognizes this medication could precipitate which complication?",
                                     "options": [
                                         "Increased trabecular meshwork drainage causing gradual worsening of the open-angle glaucoma control",
                                         "Progression of diabetic retinopathy from the non-proliferative stage to the proliferative stage",
                                         "Reversal of hypertensive retinopathy damage from pupil dilation that improves retinal blood flow",
                                         "An acute closed-angle glaucoma attack from the dilated pupil blocking the drainage angle"
                                     ],
                                     "answer": 3,
                                     "rationale": "Correct: Anticholinergic drugs dilate the pupil, which can push the iris into the drainage angle and precipitate an acute closed-angle glaucoma attack, a sudden emergency. Incorrect: Open-angle glaucoma results from slowed drainage through the trabecular meshwork, not increased drainage, and is a gradual chronic process rather than a drug-triggered event. Diabetic retinopathy progression relates to poor blood flow causing fragile new vessel growth, not anticholinergic effects. Hypertensive retinopathy is reversible with blood pressure control, not with pupil dilation improving blood flow.",
                                     "topic": "Visual &amp; Sensory Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client using glaucoma eye drops asks the nurse which medication both reduces the amount of fluid the eye produces and increases how much fluid drains out. Which class should the nurse identify?",
                                     "options": [
                                     ...
                                     "answer": 0,
                                     "rationale": "Correct: Alpha-2 agonists such as brimonidine both decrease aqueous humor production and increase its outflow, making them unique among glaucoma drug classes. Incorrect: Beta blockers such as timolol only reduce aqueous humor production. Prostaglandin analogs such as latanoprost only increase outflow through an alternate drainage pathway. Carbonic anhydrase inhibitors such as dorzolamide only decrease production by inhibiting the carbonic anhydrase enzyme.",
                                     "topic": "Visual &amp; Sensory Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client is prescribed timolol eye drops for glaucoma. Which instruction should the nurse include to reduce the risk of systemic side effects?",
                                     "options": [
                                         "Blink rapidly several times right after instilling the drop into the eye",
                                         "Apply gentle pressure to the inner corner of the eye for one minute",
                                         "Tilt the head back and hold the eyes open without blinking for five full minutes",
                                         "Rinse the eye thoroughly with water right after instilling the eye drop"
                                     ],
                                     "answer": 1,
                                     "rationale": "Correct: Applying gentle pressure to the inner corner of the eye over the tear duct for about a minute (nasolacrimal occlusion) prevents the drop from draining into the nasolacrimal duct and being absorbed systemically, which matters especially with beta blocker drops since systemic beta-blockade can occur if too much is absorbed. Incorrect: Blinking rapidly increases drainage into the tear duct rather than preventing it. Holding the eyes open without blinking does not block the nasolacrimal duct. Rinsing the eye with water would wash out the medication rather than reduce systemic absorption.",
                                     "topic": "Visual &amp; Sensory Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with diabetic retinopathy asks why the ophthalmologist is more concerned about the proliferative stage than the earlier stage. Which explanation should the nurse give?",
                                     "options": [
                                         "The proliferative stage mainly involves small vessel changes and microaneurysms that leak fluid",
                                         "The proliferative stage is fully reversible with tight blood pressure control alone every time",
                                         "The proliferative stage involves fragile new vessels from poor blood flow that bleed easily",
                                         "The proliferative stage affects only the lens clarity rather than the retina itself directly"
                                     ],
                                     "answer": 2,
                                     "rationale": "Correct: In proliferative diabetic retinopathy, the retina responds to poor blood flow by growing new, fragile blood vessels that bleed easily and threaten vision more seriously than the earlier stage. Incorrect: Small vessel changes and microaneurysms that leak describe the earlier, non-proliferative stage, not the more advanced proliferative stage. Reversibility with blood pressure control describes hypertensive retinopathy, not diabetic retinopathy. Diabetic retinopathy affects the retina, not the lens; lens clouding describes cataracts.",
                                     "topic": "Visual &amp; Sensory Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client asks the nurse which eye condition on their problem list is most likely to improve if they get their chronic health condition under control. The nurse should identify which condition?",
                                     "options": [
                                         "Cataracts, which improve once the lens clouding is treated with medication",
                                         "Dry macular degeneration, which improves once central vision is restored",
                                         "Open-angle glaucoma, which reverses once trabecular meshwork damage heals",
                                         "Hypertensive retinopathy, which improves with good blood pressure control"
                                     ],
                                     "answer": 3,
                                     "rationale": "Correct: Hypertensive retinopathy results from chronic high blood pressure damaging retinal vessels and, unlike most other conditions discussed, is reversible with good blood pressure control. Incorrect: Cataracts have no medication that reverses lens clouding; only surgery removes and replaces the clouded lens. Dry macular degeneration involves irreversible thinning of the macula, so management focuses on slowing progression, not restoring lost vision. Open-angle glaucoma results from chronic trabecular meshwork dysfunction and does not reverse once drainage damage has occurred.",
                                     "topic": "Visual &amp; Sensory Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with Meniere's disease tells the nurse, 'My doctor will just give me a pill to cure this once and for all.' Which response by the nurse is most accurate?",
                                     "options": [
                                         "Management focuses mainly on diet and lifestyle changes such as reducing sodium and caffeine",
                                         "A single dose of a carbonic anhydrase inhibitor will fully resolve the endolymphatic hydrops",
                                         "Surgery to remove the affected inner ear structure is the only recognized effective treatment",
                                         "Beta blocker eye drops will reduce the excess endolymph fluid that is causing the vertigo"
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: Meniere's disease results from endolymphatic hydrops, an abnormal buildup of inner ear fluid, and has no direct pharmacologic cure; management is primarily dietary and lifestyle trigger management such as reducing sodium and caffeine intake. Incorrect: Carbonic anhydrase inhibitors are described on this page for reducing aqueous humor production in glaucoma, not for resolving endolymphatic hydrops. Surgery is not described as the treatment focus for Meniere's disease. Beta blocker drops are described for reducing aqueous humor production in glaucoma, not for treating inner ear fluid buildup.",
                                     "topic": "Visual &amp; Sensory Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with cataracts asks the nurse for eye drops to reverse the clouding of the lens, noting that eye drops work well for a friend's glaucoma. Which response by the nurse is accurate?",
                                     "options": [
                                         "Prostaglandin analog drops will gradually dissolve the clouded lens over several months",
                                         "No medication reverses lens clouding; surgery to remove and replace the lens is required",
                                         "Beta blocker drops will slow the clouding process the way they slow aqueous humor production",
                                         "Carbonic anhydrase inhibitor drops will restore the lens to its original clarity"
                                     ],
                                     "answer": 1,
                                     "rationale": "Correct: Cataracts involve clouding of the lens that no medication can reverse; surgery to remove the clouded lens and replace it with an artificial one is the only treatment. Incorrect: Prostaglandin analog drops act on aqueous humor outflow in glaucoma, not on lens clouding, and cannot dissolve a cataract. Beta blocker drops reduce aqueous humor production for glaucoma; they have no effect on the lens. Carbonic anhydrase inhibitor drops decrease aqueous humor production in glaucoma and do not restore lens clarity.",
                                     "topic": "Visual &amp; Sensory Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "The nurse is teaching a client about findings that should prompt immediate evaluation for retinal detachment. Which findings should the nurse include? Select all that apply.",
                                     "options": [
                                         "Sudden onset of floaters and flashing lights in one eye",
                                         "A curtain-like shadow moving across the visual field",
                                         "Increased risk with myopia (nearsightedness)",
                                         "Gradual blurry vision that has worsened over several years",
                                         "Severe eye pain with halos around lights",
                                         "Increased risk with hyperopia (farsightedness) and lifetime UV exposure"
                                     ],
                                     "answers": [
                                         0,
                                         1,
                                     ...
                                     "rationale": "Correct: Retinal detachment causes sudden, painless, unilateral floaters and flashing lights, often with a curtain or shadow moving across the visual field, and risk increases with myopia, older age, and eye trauma. Incorrect: Gradual blurry vision over years describes chronic conditions such as cataracts or open-angle glaucoma, not the sudden onset of retinal detachment. Severe eye pain with halos describes acute closed-angle glaucoma, which is painful, unlike the painless presentation of retinal detachment. Hyperopia and UV exposure are risk factors for macular degeneration, not retinal detachment, which is instead linked to myopia.",
                                     "topic": "Visual &amp; Sensory Disorders",
                                     "source": "quiz-bank"
                                 }
                             ],
    ...
    },
    {
        ...
        "sets": {
            ...
            "extraPractice": [
                                 {
                                     "stem": "A nurse is comparing lab results for two clients with jaundice. Client A has an elevated unconjugated (indirect) bilirubin with a history of excessive RBC breakdown. Client B has an elevated conjugated (direct) bilirubin with a bile duct blocked by gallstones. Which statement correctly matches each client's bilirubin pattern to the underlying mechanism?",
                                     "options": [
                                         "Client A has hemolytic jaundice because the liver cannot conjugate bilirubin due to hepatocyte damage; Client B has hepatocellular jaundice because bile flow is obstructed.",
                                         "Client A has obstructive jaundice because bilirubin cannot exit the liver; Client B has hemolytic jaundice because RBC breakdown exceeds conjugation capacity.",
                                         "Client A has hemolytic jaundice because RBC breakdown outpaces conjugation; Client B has obstructive jaundice because conjugated bile cannot flow out of the ducts.",
                                         "Client A has hepatocellular jaundice because the liver cells are damaged; Client B has hemolytic jaundice because bile ducts are blocked by hemolyzed cells."
                                     ],
                                     "answer": 2,
                                     "rationale": "Correct: In hemolytic jaundice, RBC breakdown overproduces bilirubin faster than the liver can conjugate it, so the unconjugated fraction rises; in obstructive jaundice, the liver has already conjugated the bilirubin but bile cannot exit due to blockage, so the conjugated fraction rises. Incorrect: Option A reverses the classifications for both clients. Option B swaps the mechanisms entirely, attributing obstruction to Client A and hemolysis to Client B. Option D misclassifies Client A as hepatocellular and invents bile duct blockage from hemolyzed cells for Client B, which is not a page-described mechanism.",
                                     "topic": "Liver Anatomy, Function &amp; Jaundice",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with gallstone-induced bile duct obstruction reports dark, foamy urine and clay-colored stools with generalized itching. Which explanation correctly links all three findings to the same underlying process?",
                                     "options": [
                                         "Conjugated bilirubin is water-soluble and spills into blood then urine; bile salts absent from the gut turn stool clay-colored; bile salts in the skin cause pruritus.",
                                         "Unconjugated bilirubin overproduction from hemolysis backs into urine; the liver's regenerating hepatocytes cause clay-colored stool; ammonia buildup in the skin causes pruritus.",
                                         "Kupffer cells fail to filter bacteria from the blood, causing dark urine; decreased albumin causes clay-colored stool; prolonged PT causes generalized itching and skin bruising.",
                                         "AST and ALT elevate and directly stain the urine dark; low total protein causes clay stool from decreased oncotic pressure; elevated ammonia deposits in skin causing pruritus."
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: Conjugated bilirubin is water-soluble, so it backs into the blood and then the urine causing dark, foamy urine; without bile salts reaching the intestine the stool loses its brown pigment and becomes clay-colored; and bile salts deposited in the skin cause pruritus. Incorrect: Option B incorrectly labels the urine-spilling bilirubin as unconjugated and invents a hepatocyte-regeneration cause for clay stool. Option C invents a Kupffer-cell/albumin/PT explanation unrelated to bilirubin excretion or bile salt deposition. Option D misattributes dark urine to liver enzymes, clay stool to low albumin/oncotic pressure, and pruritus to ammonia rather than bile salts.",
                                     "topic": "Liver Anatomy, Function &amp; Jaundice",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with hepatitis and hepatocellular jaundice states, \"My bilirubin problem must be from bile blocked in my ducts, like gallstones, since my skin turned yellow.\" Which response by the nurse is correct based on the client's diagnosis?",
                                     "options": [
                                         "\"You're right, hepatocellular jaundice always occurs together with a bile duct obstruction from gallstones, so both mechanisms are present here.\"",
                                         "\"Actually, in hepatocellular jaundice the damaged liver cells can't conjugate bilirubin, so it's unconjugated, not from a blocked duct.\"",
                                         "\"Actually, your damaged liver cells are conjugating bilirubin normally, but the bile cannot flow out of the ducts, so your bilirubin is conjugated.\"",
                                         "\"You're right, but the elevated bilirubin type in your case is unconjugated because gallstones are blocking conjugated bilirubin from leaving the ducts.\""
                                     ],
                                     "answer": 1,
                                     "rationale": "Correct: In hepatocellular jaundice the liver cells themselves are damaged and cannot conjugate bilirubin, so the bilirubin that accumulates is unconjugated, unlike an obstruction where the liver has already conjugated it. Incorrect: Option A wrongly claims hepatocellular jaundice always coexists with a bile duct obstruction. Option C describes the obstructive pattern, where the liver conjugates normally but bile cannot flow out, which does not fit a hepatocellular diagnosis. Option D affirms the client's obstruction belief and misattributes the unconjugated fraction to gallstones blocking conjugated bilirubin.",
                                     "topic": "Liver Anatomy, Function &amp; Jaundice",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client's AST/ALT return in the several-thousands range. The nurse recalls that this number alone is not a reliable severity indicator. Which additional assessment finding would best indicate the client is progressing toward hepatic encephalopathy?",
                                     "options": [
                                         "Total protein and albumin trending upward toward normal limits",
                                         "Prothrombin time shortening toward normal despite liver injury",
                                         "AST and ALT continuing to rise numerically each shift",
                                         "Elevated serum ammonia, since the liver can no longer clear it"
                                     ],
                                     "answer": 3,
                                     "rationale": "Correct: Serum ammonia rises because the liver can no longer break it down, and ammonia is the key driver of hepatic encephalopathy, making it a more relevant progression marker than the enzyme number itself. Incorrect: Option A reverses the expected trend, since total protein and albumin decrease, not increase, with liver failure. Option B reverses the expected PT trend, since PT prolongs (lengthens) rather than shortens as clotting factor production falls. Option C relies on the AST/ALT number, which the page states is not a reliable indicator of severity.",
                                     "topic": "Liver Anatomy, Function &amp; Jaundice",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client asks why an oral form of a medication is prescribed at a much higher dose than the IV form of the same drug. Which explanation reflects the pathophysiology of portal circulation?",
                                     "options": [
                                         "Oral drugs bypass the liver entirely and enter systemic circulation faster, requiring a higher dose to achieve the same effect as an IV dose.",
                                         "The hepatic portal vein carries oxygenated blood from the heart directly to the liver, where oral drugs are absorbed before systemic circulation.",
                                         "Oral drugs travel through the portal vein to the liver first and are partially metabolized before reaching systemic circulation.",
                                         "IV drugs pass through the hepatic portal vein before entering systemic circulation, so they undergo the same first-pass metabolism as oral drugs."
                                     ],
                                     "answer": 2,
                                     "rationale": "Correct: Oral drugs are absorbed from the intestines and travel through the hepatic portal vein to the liver first, where they are partially metabolized (the first-pass effect) before reaching systemic circulation, which is why oral doses are often higher than IV doses of the same drug. Incorrect: Option A incorrectly states oral drugs bypass the liver, when passing through the liver first is exactly why higher oral doses are needed. Option B incorrectly describes portal blood as oxygenated; it is deoxygenated blood from the digestive organs. Option D incorrectly applies first-pass metabolism to IV drugs, which enter systemic circulation directly without passing through the portal vein first.",
                                     "topic": "Liver Anatomy, Function &amp; Jaundice",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A student nurse is reviewing liver histology and states, \"Kupffer cells and hepatocytes both regenerate after injury, and both filter bacteria from the blood.\" Which correction should the instructor make?",
                                     "options": [
                                         "Only Kupffer cells filter bacteria and toxins from the blood by lining the sinusoids; hepatocytes are the cell type capable of regenerating if remaining liver tissue is healthy.",
                                         "Only hepatocytes filter bacteria and toxins from the blood by lining the sinusoids; Kupffer cells are the cell type capable of regenerating if remaining liver tissue is healthy.",
                                         "Both Kupffer cells and hepatocytes filter bacteria from the blood, but neither cell type is capable of regeneration after injury.",
                                         "Kupffer cells regenerate to form new lobules, while hepatocytes line the sinusoids and filter toxins from circulating blood."
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: Kupffer cells line the liver's sinusoids and remove bacteria and toxins from the blood, while hepatocytes are one of the few cell types able to regenerate if the remaining liver tissue is healthy. Incorrect: Option B swaps the two roles between the cell types. Option C denies that either cell type can regenerate, when hepatocytes specifically can. Option D again swaps the roles, attributing regeneration to Kupffer cells and filtration to hepatocytes.",
                                     "topic": "Liver Anatomy, Function &amp; Jaundice",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with advanced liver failure has a low serum albumin and a prolonged PT. The nurse recognizes these findings reflect two separate lost liver functions. Which statement correctly explains both?",
                                     "options": [
                                         "Low albumin reflects loss of clotting factor production, and prolonged PT reflects loss of the liver's reservoir function, both increasing bleeding risk overall.",
                                         "Low albumin reflects decreased protein synthesis, lowering oncotic pressure, while prolonged PT reflects decreased prothrombin production and bleeding risk.",
                                         "Low albumin reflects impaired bilirubin filtration, causing jaundice, while prolonged PT reflects impaired drug detoxification, causing toxin accumulation.",
                                         "Low albumin and prolonged PT both result from Kupffer cell failure to filter bacteria, unrelated to the liver's synthetic or clotting functions overall."
                                     ],
                                     "answer": 1,
                                     "rationale": "Correct: Low albumin reflects decreased protein synthesis by the liver, which lowers oncotic pressure and contributes to fluid shifting out of vessels (ascites), while a prolonged PT reflects decreased production of prothrombin, a clotting factor, increasing bleeding risk. Incorrect: Option A mismatches albumin with clotting factor loss and PT with reservoir function, neither of which is correct. Option C misattributes albumin loss to bilirubin filtration and PT prolongation to drug detoxification, which are separate liver jobs. Option D attributes both findings to Kupffer cell failure, which relates to blood filtration of bacteria/toxins, not protein or clotting factor synthesis.",
                                     "topic": "Liver Anatomy, Function &amp; Jaundice",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client's total bilirubin is 1.8 mg/dL, with 70% present as unconjugated bilirubin. The nurse does not observe visible scleral icterus. Which is the best interpretation?",
                                     "options": [
                                         "Jaundice should already be visible because total bilirubin exceeds the normal range of 0.6-1 mg/dL and is approaching 2 mg/dL, a critical threshold.",
                                         "The bilirubin fraction is abnormal because unconjugated bilirubin should make up about 30% of the total, not 70%, per expected reference ratios.",
                                         "Jaundice is absent because the bilirubin is entirely conjugated, which is not visible until levels exceed 2-2.5 mg/dL in most clients.",
                                         "Jaundice is not yet visible; bilirubin must reach about 2-2.5 mg/dL before discoloration appears, though the level is already above normal."
                                     ],
                                     "answer": 3,
                                     "rationale": "Correct: Jaundice is usually not visible until bilirubin reaches about 2-2.5 mg/dL, so a level of 1.8 mg/dL, though above the normal range of roughly 0.6-1 mg/dL, would not yet produce visible discoloration. Incorrect: Option A incorrectly assumes visibility at a level still below the 2-2.5 mg/dL threshold. Option B incorrectly treats the roughly 70% unconjugated/30% conjugated split as abnormal, when this is the typical distribution. Option C contradicts the stem's stated 70% unconjugated fraction by claiming the bilirubin is entirely conjugated.",
                                     "topic": "Liver Anatomy, Function &amp; Jaundice",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with darker skin tone reports feeling generally unwell but has no visible yellowing of the skin on the arms or chest. Which nursing action is the priority to determine whether jaundice is present?",
                                     "options": [
                                         "Rule out jaundice, since the skin was inspected and no discoloration is present on the arms or chest.",
                                         "Assess the palms and soles only, since mucous membranes are not affected by bilirubin deposition.",
                                         "Assess the sclera of the eyes, which is the most reliable site to detect jaundice regardless of skin tone.",
                                         "Rely on the client's subjective report of feeling unwell as the most reliable indicator of bilirubin level."
                                     ],
                                     "answer": 2,
                                     "rationale": "Correct: The sclera of the eyes is the best place to assess for jaundice, especially in a client with darker skin, because it reliably shows discoloration regardless of skin tone. Incorrect: Option A prematurely rules out jaundice based only on limited skin sites, which may not show discoloration reliably in darker skin tones. Option B incorrectly excludes mucous membranes, which can also show bilirubin-related discoloration. Option D prioritizes a subjective report over an objective assessment finding.",
                                     "topic": "Liver Anatomy, Function &amp; Jaundice",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "Two clients present with jaundice. Client 1 has elevated conjugated bilirubin, dark urine, and clay-colored stool. Client 2 has elevated unconjugated bilirubin, normal-colored stool, and no pruritus. Which statement is correct?",
                                     "options": [
                                         "Client 1 most likely has an obstruction preventing conjugated bile from flowing out, while Client 2's pattern fits hemolytic or hepatocellular jaundice.",
                                         "Client 1 most likely has hemolytic jaundice from excess RBC breakdown, while Client 2 has an obstruction blocking bile salts from reaching the skin.",
                                         "Client 1's clay-colored stool indicates the liver has not conjugated any bilirubin, while Client 2's normal stool indicates a bile duct obstruction.",
                                         "Client 1 and Client 2 both have hepatocellular jaundice, since both bilirubin fractions can be elevated simultaneously in liver cell damage such as hepatitis."
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: Client 1's elevated conjugated bilirubin with dark urine and clay stool fits an obstruction where already-conjugated bile cannot flow out, while Client 2's elevated unconjugated bilirubin fits hemolytic or hepatocellular jaundice, where the liver has not yet conjugated the bilirubin. Incorrect: Option B swaps the mechanisms between the two clients. Option C incorrectly explains clay-colored stool as a failure to conjugate bilirubin rather than a bile flow blockage, and misreads Client 2's normal stool as evidence of obstruction. Option D overgeneralizes the fact that hepatitis can elevate both bilirubin fractions simultaneously to a scenario where the two clients' findings are clearly distinguishable.",
                                     "topic": "Liver Anatomy, Function &amp; Jaundice",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A nurse is caring for a client with obstructive jaundice caused by gallstones. Which findings would the nurse expect to assess in this client? Select all that apply.",
                                     "options": [
                                         "Dark, foamy amber urine",
                                         "Clay-colored stool",
                                         "Elevated conjugated (direct) bilirubin",
                                         "Elevated unconjugated (indirect) bilirubin as the primary bilirubin abnormality",
                                         "Pruritus from bile salts depositing in the skin",
                                         "Elevated serum ammonia as the cause of the yellow skin discoloration"
                                     ],
                                     "answers": [
                                         0,
                                         1,
    ...
    },
    {
        ...
        "sets": {
            ...
            "extraPractice": [
                                 {
                                     "stem": "A client exposed to hepatitis B two weeks ago reports fatigue, mild nausea, and headache but has no jaundice or dark urine. The nurse should recognize that this client is",
                                     "options": [
                                         "in the prodromal phase and still highly transmissible before jaundice appears",
                                         "not yet infectious, since jaundice marks the true onset of active viral shedding into stool and blood",
                                         "in the icteric phase already, since these vague symptoms typically appear together with jaundice itself",
                                         "past the period of highest transmissibility, now that these early prodromal symptoms have already started to fade"
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: The prodromal phase begins about two weeks after exposure with nonspecific symptoms like fatigue, nausea, and headache, and the virus is highly transmissible during this phase before jaundice appears. Incorrect: Transmissibility peaks in the prodromal phase, not after jaundice develops; the icteric phase begins one to two weeks later and starts with jaundice, dark urine, and liver tenderness, not these nonspecific symptoms; the client has not passed the period of highest transmissibility, they are in it.",
                                     "topic": "Viral Hepatitis (A, B &amp; C)",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client who recently began sharing needles for IV drug use asks the nurse how to protect against hepatitis. Which response is accurate?",
                                     "options": [
                                         "one vaccine series is said to protect equally well against both hepatitis B and hepatitis C",
                                         "the hepatitis B vaccine protects against B only; no vaccine exists yet for hepatitis C",
                                         "the two-dose hepatitis A vaccine should be given instead, since it also covers needle-sharing blood exposure",
                                         "because hepatitis C carries a higher chronic infection risk, vaccination against it should start immediately today"
                                     ],
                                     "answer": 1,
                                     "rationale": "Correct: A three-dose hepatitis B vaccine series exists, but no vaccine has been developed for hepatitis C, so safe needle practices remain essential for preventing hepatitis C even after B vaccination. Incorrect: The hepatitis B and hepatitis A vaccines are separate series and do not cover hepatitis C; the hepatitis A vaccine targets fecal-oral exposure, not needle sharing; hepatitis C has no vaccine to give regardless of its higher chronic infection risk.",
                                     "topic": "Viral Hepatitis (A, B &amp; C)",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "The nurse is comparing two clients: one who became ill after eating at a restaurant tied to a foodborne outbreak, and another who has had persistently elevated liver enzymes for three months after sharing needles. Which statement correctly differentiates their expected courses?",
                                     "options": [
                                         "both clients face the same chronic infection risk, regardless of how they were actually exposed to the virus",
                                         "the foodborne client faces the higher chronic infection risk, since fecal-oral spread is more likely to persist over time",
                                         "the foodborne client will not develop chronic hepatitis, unlike the needle-exposure client's blood-borne infection",
                                         "the needle-exposure client's symptoms should resolve within days, since blood-borne strains only cause mild, brief illness"
                                     ],
                                     "answer": 2,
                                     "rationale": "Correct: Hepatitis A, spread through the fecal-oral route as in a foodborne outbreak, does not become chronic, while the needle-exposure client's prolonged, insidious course with ongoing enzyme elevation is consistent with a blood-borne strain that carries a real chronic infection risk. Incorrect: The two exposure routes do not carry equal chronic risk; fecal-oral spread does not become chronic at all, so it does not carry the higher risk; blood-borne strains have an insidious onset and can persist for months rather than resolving within days.",
                                     "topic": "Viral Hepatitis (A, B &amp; C)",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client asks the nurse why hepatitis C was historically considered more dangerous long-term than hepatitis B, even though both spread through blood and body fluids. The nurse's response should be based on which comparison?",
                                     "options": [
                                         "hepatitis B is spread only through sexual contact, while hepatitis C is spread only through blood transfusions",
                                         "hepatitis B causes fulminant hepatitis in most cases, while hepatitis C never progresses to liver failure at all",
                                         "hepatitis B has a two-week incubation period, while hepatitis C's incubation lasts about six months on average",
                                         "about 80% of hepatitis C infections become chronic, versus about 10% for hepatitis B, per current data"
                                     ],
                                     "answer": 3,
                                     "rationale": "Correct: About 80% of hepatitis C infections progress to chronic infection compared with about 10% of hepatitis B infections, which is why hepatitis C posed such a major long-term problem before effective treatment existed. Incorrect: Both hepatitis B and C are spread through blood and body fluids such as needle sharing and sexual contact, not exclusively one route each; fulminant hepatitis can occur with any strain's severe initial case, it is not specific to hepatitis B; both B and C have an insidious onset with a long incubation before symptoms appear, not a two-week incubation for B.",
                                     "topic": "Viral Hepatitis (A, B &amp; C)",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client diagnosed with acute hepatitis B five weeks ago reports that jaundice has resolved and energy is improving, but the nurse notes the liver remains palpable and mildly tender on exam. The nurse should interpret this finding as",
                                     "options": [
                                         "expected during recovery, since the liver can stay enlarged and tender for weeks after jaundice fades",
                                         "a sign the client is entering the icteric phase and jaundice will return again soon after this visit",
                                         "evidence the infection has become chronic, since acute hepatitis never causes any liver enlargement at all",
                                         "a sign the client is now in the prodromal phase of an entirely new, separate infection process"
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: During the recovery phase, jaundice resolves and enzymes normalize over roughly two to twelve weeks, but the liver can remain enlarged and tender even as other symptoms fade. Incorrect: The icteric phase, marked by jaundice, occurs before recovery, not after jaundice has already resolved; acute hepatitis commonly involves an enlarged, tender liver during the icteric phase, so this finding alone does not indicate chronic infection; nothing in this presentation suggests a new exposure or prodromal phase, this is the expected recovery course.",
                                     "topic": "Viral Hepatitis (A, B &amp; C)",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with chronic hepatitis C and stable, compensated liver function asks about taking acetaminophen for a headache. Which response is accurate?",
                                     "options": [
                                         "acetaminophen must be avoided completely, since any chronic hepatitis diagnosis makes it fully contraindicated always",
                                         "acetaminophen may be taken, but stay under two grams daily rather than the usual four-gram adult limit",
                                         "acetaminophen may be taken up to the usual four grams per day, since the liver does not metabolize it at all",
                                         "acetaminophen is only unsafe in hepatitis A, so the usual adult dose of four grams daily is fine to take"
                                     ],
                                     "answer": 1,
                                     "rationale": "Correct: Clients with chronic or active hepatitis may still take acetaminophen but should stay under two grams per day, rather than the usual four-gram limit, since the liver already cannot metabolize normally; complete avoidance is reserved for serious, advanced liver disease. Incorrect: Complete avoidance applies to serious, advanced liver disease, not every chronic hepatitis diagnosis; the usual four-gram limit is not safe here because the liver's metabolism is already impaired; the dosing concern applies to any hepatitis strain affecting liver function, not only hepatitis A.",
                                     "topic": "Viral Hepatitis (A, B &amp; C)",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with chronic hepatitis B has normal AST levels and no fibrosis on imaging, while another client with chronic hepatitis C has a detectable viral load. Which statement about treatment eligibility is correct?",
                                     "options": [
                                         "neither client should be treated until liver failure develops, since both therapies are reserved only for end-stage disease",
                                         "the hepatitis B client should start entecavir and interferon now, since chronic hepatitis B always requires treatment regardless",
                                         "the hepatitis C client should start antivirals now, while the hepatitis B client does not yet meet treatment criteria",
                                         "the hepatitis C client should wait for elevated AST and inflammation before starting therapy, matching hepatitis B's own criteria"
                                     ],
                                     "answer": 2,
                                     "rationale": "Correct: Anyone with a detectable hepatitis C viral load is now treated with direct-acting antivirals, while chronic hepatitis B treatment with interferons and nucleoside analogs is reserved for high-risk clients with elevated AST, hepatic inflammation, or advanced fibrosis, which this client does not have. Incorrect: Treatment is not reserved for end-stage disease in either case; chronic hepatitis B treatment depends on meeting high-risk criteria, it is not automatic; hepatitis C treatment does not wait for the hepatitis B criteria, any detectable viral load now qualifies for treatment.",
                                     "topic": "Viral Hepatitis (A, B &amp; C)",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with acute viral hepatitis suddenly develops worsening mental status and rapidly rising liver enzymes within days of diagnosis. The nurse recognizes this presentation as most consistent with",
                                     "options": [
                                         "hepatocellular carcinoma, a long-term complication linked to hepatitis B and C",
                                         "cirrhosis, which represents permanent liver scarring accumulated over years",
                                         "chronic hepatitis, which develops gradually in 10% to 80% of cases depending on strain",
                                         "fulminant hepatitis progressing rapidly toward acute liver failure"
                                     ],
                                     "answer": 3,
                                     "rationale": "Correct: Fulminant viral hepatitis is a severe initial case that progresses to acute liver failure, which fits this client's sudden mental status changes and rapidly worsening liver function. Incorrect: Hepatocellular carcinoma and cirrhosis develop as long-term complications over years, not within days; chronic hepatitis develops gradually as the virus fails to clear, it does not present with sudden, rapid deterioration like this.",
                                     "topic": "Viral Hepatitis (A, B &amp; C)",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A pregnant client asks how she could have contracted hepatitis C despite having no history of IV drug use or unprotected sex. The nurse should explain that hepatitis C, unlike hepatitis A, can also spread",
                                     "options": [
                                         "from mother to fetus, or through rare medical mishaps, beyond blood and body fluid contact",
                                         "through contaminated food or water in areas with poor sanitation and inadequate hand hygiene",
                                         "only through direct sexual contact with an infected partner, making other exposure routes very unlikely",
                                         "through airborne respiratory droplets during close, prolonged contact with an infected person indoors"
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: In addition to IV drug use and sexual contact, hepatitis C can also spread through mother-to-fetal transmission and rare medical mishaps, which explains exposure without those two risk factors. Incorrect: Spread through contaminated food or water with poor sanitation describes hepatitis A's fecal-oral route, not hepatitis C; hepatitis C is not limited to sexual contact alone, and airborne respiratory spread is not a transmission route described for any of these strains.",
                                     "topic": "Viral Hepatitis (A, B &amp; C)",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A nurse is planning immunization teaching for a new mother regarding hepatitis vaccines. Which statement correctly reflects the recommendations?",
                                     "options": [
                                         "hepatitis A and hepatitis B vaccines are each three-dose series required for every infant starting right at birth",
                                         "hepatitis B is a three-dose series for infants and health workers; hepatitis A is a two-dose series for high-risk groups",
                                         "hepatitis A vaccine is required for every infant, while hepatitis B vaccine is reserved only for international travelers going abroad",
                                         "hepatitis C now has an approved two-dose vaccine series required for all infants, much like hepatitis A's own schedule"
                                     ],
                                     "answer": 1,
                                     "rationale": "Correct: The hepatitis B vaccine is a three-dose series required for all infants and health care workers, while the hepatitis A vaccine is a two-dose series recommended mainly for high-risk groups and travelers rather than universally required. Incorrect: The two vaccines differ in dose number and target population, they are not identical three-dose series for every infant; hepatitis A is not required for all infants and hepatitis B is not limited to travelers, that reverses their actual recommendations; no vaccine exists for hepatitis C.",
                                     "topic": "Viral Hepatitis (A, B &amp; C)",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "The nurse is teaching a client newly diagnosed with chronic hepatitis C about the disease. Which statements should the nurse include? Select all that apply.",
                                     "options": [
                                         "Hepatitis C progresses to chronic infection far more often than hepatitis B (about 80% vs about 10%)",
                                         "Direct-acting antivirals can essentially eliminate the hepatitis C virus from the body in most treated clients",
                                         "A hepatitis C vaccine is available now and should be given routinely as a two-dose childhood series",
                                         "Chronic hepatitis C increases the long-term risk for cirrhosis and hepatocellular carcinoma over time",
                                         "Hepatitis C is transmitted primarily through contaminated food and water in areas with poor sanitation",
                                         "Treatment for hepatitis C is only started once liver enzymes become severely elevated, similar to hepatitis B criteria"
                                     ],
                                     "answers": [
                                         0,
                                         1,
                                     ...
                                     "rationale": "Correct: Hepatitis C has a much higher chronic infection rate (about 80%) than hepatitis B (about 10%); direct-acting antivirals can essentially eliminate the virus in most clients; chronic hepatitis C, like chronic hepatitis B, is linked to long-term cirrhosis and hepatocellular carcinoma. Incorrect: No vaccine exists for hepatitis C, the two-dose series described belongs to hepatitis A; hepatitis C spreads through blood and body fluids such as IV drug use, sexual contact, and mother-to-fetal transmission, not contaminated food or water, which is hepatitis A's route; hepatitis C treatment with direct-acting antivirals is now offered to anyone with a detectable viral load, unlike hepatitis B's stricter high-risk treatment criteria.",
                                     "topic": "Viral Hepatitis (A, B &amp; C)",
                                     "source": "quiz-bank"
                                 }
                             ],
    ...
    },
    {
        ...
        "sets": {
            ...
            "extraPractice": [
                                 {
                                     "stem": "A client newly diagnosed with cirrhosis tells the nurse, 'I don't understand — my friend had hepatitis and got better, so if I just stop drinking, my liver should heal too, right?' Which response is most accurate?",
                                     "options": [
                                         "Hepatitis is reversible inflammation, but cirrhosis is permanent scarring — stopping alcohol only slows damage, it cannot reverse it.",
                                         "Both hepatitis and cirrhosis are forms of reversible inflammation, so stopping alcohol now should allow your liver to fully return to normal over time.",
                                         "Cirrhosis is caused only by alcohol use, so stopping drinking now should fully restore normal liver function, structure, and lab values.",
                                         "Because hepatitis and cirrhosis have the same fibrotic changes, stopping alcohol will reverse the disease exactly as it does with hepatitis."
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: hepatitis is reversible inflammation, while cirrhosis is irreversible fibrotic scarring; stopping the toxin can slow further progression but cannot undo existing damage. Incorrect: option 2 wrongly calls cirrhosis reversible inflammation like hepatitis; option 3 wrongly claims alcohol is the only cause and that stopping fully restores function; option 4 wrongly claims hepatitis involves the same fibrotic changes as cirrhosis.",
                                     "topic": "Cirrhosis &amp; Liver Failure",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A student nurse states, 'Since alcoholic cirrhosis is the most common type of cirrhosis, most clients with cirrhosis must have a history of alcohol use.' Which statement should the nurse use to correct this misunderstanding?",
                                     "options": [
                                         "Alcoholic cirrhosis actually accounts for less than 10% of all cirrhosis cases, so hepatitis B and C together cause the clear majority.",
                                         "Alcohol is the single most common individual cause, yet it accounts for only about 25% of all cirrhosis cases overall.",
                                         "Because alcohol is the most common cause, roughly 75% of all cirrhosis cases nationwide are directly linked to alcohol use.",
                                         "Alcoholic cirrhosis and non-alcoholic fatty liver disease together account for 100% of all reported cirrhosis cases."
                                     ],
                                     "answer": 1,
                                     "rationale": "Correct: alcohol is the single most common individual cause of cirrhosis but still accounts for only about 25% of all cases, since hepatitis B/C, NAFLD/NASH, autoimmune, hereditary metabolic, and idiopathic causes make up the rest. Incorrect: option 1 understates alcohol's role below the stated 25%; option 3 overstates it as 75%; option 4 falsely claims two causes account for 100% of cases, ignoring hepatitis and other causes.",
                                     "topic": "Cirrhosis &amp; Liver Failure",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with cirrhosis has a prolonged PT from decreased clotting factor production and known esophageal varices from portal hypertension. The client suddenly vomits a large volume of bright red blood. Which mechanism explains this acute event, as distinguished from the client's baseline bleeding tendency?",
                                     "options": [
                                         "The liver's inability to produce clotting factors has now caused spontaneous, diffuse bleeding throughout the entire GI tract and skin.",
                                         "Low albumin has reduced colloid oncotic pressure, allowing plasma to leak directly into the stomach, esophagus, and peritoneal space.",
                                         "Portal hypertension caused a distended esophageal varix to rupture, producing acute, high-mortality hemorrhage requiring emergent care.",
                                         "Hepatic encephalopathy has progressed to the point that ammonia buildup is directly eroding the esophageal lining and mucosa."
                                     ],
                                     "answer": 2,
                                     "rationale": "Correct: portal hypertension distends esophageal veins into varices; rupture causes acute, high-mortality-risk hemorrhage, a distinct mechanism from the chronic bleeding tendency caused by decreased clotting factor production. Incorrect: option 1 describes the general clotting-factor bleeding tendency, not the acute variceal rupture; option 2 describes the mechanism behind edema/ascites, not GI hemorrhage; option 4 misapplies ammonia buildup, which causes hepatic encephalopathy, not esophageal bleeding.",
                                     "topic": "Cirrhosis &amp; Liver Failure",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with a history of heavy alcohol use has hepatic fat deposition and altered hepatocyte function on biopsy, but no inflammation, hepatocyte degeneration, or WBC infiltration. Based on the stages of alcoholic liver disease, which teaching point is accurate?",
                                     "options": [
                                         "This stage, called alcoholic steatohepatitis, is already irreversible even if alcohol use stops immediately now.",
                                         "This stage already involves permanent fibrosis, so damage will continue even without further alcohol use.",
                                         "This client has progressed to alcoholic cirrhosis, and a transplant will eventually be required.",
                                         "This is alcoholic fatty liver, the last reversible stage, so stopping alcohol now could allow full recovery."
                                     ],
                                     "answer": 3,
                                     "rationale": "Correct: alcoholic fatty liver is mild, asymptomatic, and reversible if drinking stops; it involves fat deposition and altered hepatocyte function without the inflammation/degeneration/WBC infiltration that mark steatohepatitis. Incorrect: option 1 mislabels the stage as steatohepatitis, which the stem's findings do not show; option 2 wrongly assigns fibrosis, which develops in the cirrhosis stage; option 3 wrongly assigns cirrhosis, which involves necrosis and permanent scarring not present here.",
                                     "topic": "Cirrhosis &amp; Liver Failure",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with cirrhosis has an ammonia level within normal limits but is increasingly difficult to arouse and does not respond appropriately to voice. Which action reflects correct understanding of how hepatic encephalopathy is diagnosed?",
                                     "options": [
                                         "The nurse prioritizes level of consciousness, since encephalopathy is diagnosed by mental status, not ammonia values alone.",
                                         "The nurse rules out hepatic encephalopathy because a normal ammonia level means toxin buildup in the brain cannot possibly be occurring.",
                                         "The nurse holds lactulose because the ammonia level does not yet meet the specific threshold required to start treatment today.",
                                         "The nurse notifies the provider immediately that the client cannot have hepatic encephalopathy without an elevated ammonia level."
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: level of consciousness, not the ammonia value, is the primary driver of hepatic encephalopathy diagnosis; ammonia correlates with but never alone diagnoses it, and lactulose is given for actual signs/symptoms rather than a lab threshold. Incorrect: options 2 and 4 wrongly treat ammonia as required or definitive for the diagnosis; option 3 wrongly ties lactulose administration to an ammonia threshold instead of clinical symptoms.",
                                     "topic": "Cirrhosis &amp; Liver Failure",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client presents with jaundice, ascites, and confusion three weeks after an acetaminophen overdose, with no prior history of liver disease. Which explanation best fits this presentation compared with cirrhosis?",
                                     "options": [
                                         "This presentation confirms chronic cirrhosis, since jaundice, ascites, and confusion only ever occur after years of slow, chronic fibrosis progression.",
                                         "This is consistent with acute liver failure, which mirrors late-stage cirrhosis clinically but develops suddenly, not from chronic fibrosis.",
                                         "This presentation rules out acute liver failure entirely, because acetaminophen overdose only ever causes acute liver failure within 48 hours, never weeks later.",
                                         "This confirms alcoholic steatohepatitis, since that particular stage also produces jaundice and edema after an acute toxin exposure such as this one today."
                                     ],
                                     "answer": 1,
                                     "rationale": "Correct: acute (fulminant) liver failure can occur 5 days to 8 weeks after acetaminophen overdose, and its clinical presentation looks the same as late-stage cirrhosis, differing only in sudden onset and cause rather than chronic fibrosis. Incorrect: option 1 wrongly requires years of chronic fibrosis, which this sudden case does not show; option 3 wrongly limits acetaminophen-related liver failure to 48 hours, contradicting the 5-day-to-8-week window; option 4 wrongly attributes the picture to alcoholic steatohepatitis, which is tied to alcohol metabolism, not acetaminophen overdose.",
                                     "topic": "Cirrhosis &amp; Liver Failure",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with hepatic encephalopathy is started on lactulose and develops hypokalemia from vomiting. Which statement reflects the priority concern with this combination?",
                                     "options": [
                                         "Hypokalemia will reduce lactulose's ability to acidify the colon, making the drug ineffective at converting ammonia to ammonium.",
                                         "Hypokalemia should prompt the nurse to switch the client from lactulose to rifaximin, since rifaximin is not affected by potassium levels.",
                                         "Hypokalemia increases renal ammonia production, which could worsen the client's hepatic encephalopathy despite lactulose therapy.",
                                         "Hypokalemia indicates the lactulose dose is too high and should be held until stooling stops completely."
                                     ],
                                     "answer": 2,
                                     "rationale": "Correct: potassium must be monitored with lactulose because hypokalemia increases renal ammonia production, which can worsen hepatic encephalopathy even while the client is receiving treatment. Incorrect: option 1 wrongly ties lactulose's colonic acid-forming mechanism to serum potassium rather than bacterial metabolism; option 2 is an unsupported switch not indicated by hypokalemia; option 4 wrongly treats lactulose dosing as based on hypokalemia rather than titration to 2-3 soft stools per day.",
                                     "topic": "Cirrhosis &amp; Liver Failure",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with hepatic encephalopathy continues to have worsening confusion despite lactulose achieving 2-3 soft stools per day. The provider adds rifaximin. Which nursing consideration is most important with this addition?",
                                     "options": [
                                         "Monitor the client's ammonia level closely, since rifaximin's effectiveness is measured the same way as lactulose's.",
                                         "Discontinue lactulose immediately, since rifaximin works by the same hyperosmotic mechanism and combining them is redundant.",
                                         "Expect rifaximin to directly reverse the underlying fibrosis causing the hepatic encephalopathy.",
                                         "Monitor for signs of C. difficile infection, since rifaximin carries an increased risk of this complication."
                                     ],
                                     "answer": 3,
                                     "rationale": "Correct: rifaximin is a second-line antibiotic used when lactulose alone is not controlling symptoms; it inhibits bacterial RNA synthesis to reduce ammonia-producing gut bacteria and carries an increased C. diff infection risk requiring monitoring. Incorrect: option 1 is wrong because ammonia levels are not monitored with rifaximin; option 2 wrongly attributes lactulose's hyperosmotic mechanism to rifaximin and lactulose is not simply discontinued; option 3 is wrong because no drug reverses fibrosis or cirrhosis.",
                                     "topic": "Cirrhosis &amp; Liver Failure",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with cirrhosis has portal hypertension confirmed on imaging but reports feeling completely well with no symptoms. Which nursing understanding is most accurate?",
                                     "options": [
                                         "Portal hypertension is typically asymptomatic, so the nurse should keep monitoring for complications like variceal hemorrhage, ascites, or hepatorenal syndrome.",
                                         "Because the client currently feels asymptomatic, portal hypertension is unlikely to ever progress to any further complications, so monitoring can be safely reduced.",
                                         "The absence of any symptoms confirms that the portal hypertension has fully resolved and blood flow through the portal vein has normalized completely.",
                                         "The client's current lack of symptoms means the liver fibrosis has not yet caused any real resistance to portal blood flow at all."
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: portal hypertension itself is asymptomatic until complications such as variceal hemorrhage, ascites, gut bacteria translocation, hepatorenal syndrome, or heart failure develop, so ongoing monitoring is essential regardless of how the client feels. Incorrect: option 2 wrongly assumes being asymptomatic prevents future complications; option 3 is wrong because no drug or mechanism reverses portal hypertension once it develops; option 4 is wrong because portal hypertension is, by definition, caused by fibrosis already resisting portal blood flow.",
                                     "topic": "Cirrhosis &amp; Liver Failure",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "The nurse is caring for two clients with cirrhosis: Client A has esophageal varices and is now vomiting bright red blood, and Client B has mild confusion and behavioral changes consistent with early hepatic encephalopathy. Which client should the nurse assess first?",
                                     "options": [
                                         "Client B, because hepatic encephalopathy can progress rapidly to coma unresponsive to pain and therefore takes priority over any active bleeding today.",
                                         "Client A, because a bleeding esophageal varix is an active, high-mortality emergency, while Client B's confusion is an earlier-stage presentation.",
                                         "Both clients require identical priority, since bleeding tendency and hepatic encephalopathy both result from the liver's inability to detoxify the blood.",
                                         "Client B, because ammonia buildup causing confusion is more immediately life-threatening than a burst esophageal varix in this case."
                                     ],
                                     "answer": 1,
                                     "rationale": "Correct: a bleeding esophageal varix is described as an active, high-mortality-risk emergency, while Client B's mild confusion and behavioral changes represent the milder end of the hepatic encephalopathy severity range. Incorrect: options 1 and 4 wrongly rank mild confusion above active hemorrhage; option 3 wrongly equates two distinct mechanisms (portal-hypertension bleeding versus ammonia detoxification failure) and ignores the acuity difference between them.",
                                     "topic": "Cirrhosis &amp; Liver Failure",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with cirrhosis has both jaundice and peripheral edema. Which explanation correctly differentiates the underlying mechanism of each finding?",
                                     "options": [
                                         "Jaundice comes from decreased clotting factor production; edema comes from portal hypertension backing up blood flow alone.",
                                         "Jaundice comes from ammonia crossing the blood-brain barrier into brain tissue; edema comes from gut bacteria translocating into the peritoneal cavity.",
                                         "Jaundice comes from fibrosis obstructing biliary channels and trapping bilirubin; edema comes from low albumin reducing oncotic pressure.",
                                         "Jaundice comes from portal hypertension backing up portal blood flow; edema comes from decreased clotting factor production."
                                     ],
                                     "answer": 2,
                                     "rationale": "Correct: chaotic fibrosis obstructs biliary channels, causing bilirubin buildup and jaundice, while edema results from the liver's inability to produce enough albumin, lowering colloid oncotic pressure so fluid third-spaces into tissue. Incorrect: option 1 wrongly attributes jaundice to clotting factors and edema to portal hypertension alone; option 2 wrongly attributes these findings to ammonia and gut bacteria translocation, which relate to hepatic encephalopathy and peritonitis risk; option 4 reverses the correct mechanisms.",
                                     "topic": "Cirrhosis &amp; Liver Failure",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client asks the nurse how serious a cirrhosis diagnosis is and whether hepatic encephalopathy is a common complication. Which response is accurate based on known statistics?",
                                     "options": [
                                         "Cirrhosis has a death rate of about 45%, and hepatic encephalopathy occurs in nearly all diagnosed clients with cirrhosis today.",
                                         "Cirrhosis has a death rate of about 26%, but hepatic encephalopathy is rare, occurring in less than 5% of all diagnosed clients.",
                                         "Cirrhosis has a death rate of about 30%, and hepatic encephalopathy occurs in about 26% of all diagnosed clients overall.",
                                         "Cirrhosis has a death rate of about 26%, and hepatic encephalopathy occurs in about 30-45% of clients overall."
                                     ],
                                     "answer": 3,
                                     "rationale": "Correct: cirrhosis carries a death rate of about 26%, and hepatic encephalopathy occurs in roughly 30-45% of cirrhosis patients. Incorrect: options 1 and 3 misstate the death rate as 45% or 30% instead of 26%; option 2 misstates hepatic encephalopathy as rare when it actually affects 30-45% of clients.",
                                     "topic": "Cirrhosis &amp; Liver Failure",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client asks why liver damage in cirrhosis keeps getting worse even after the initial injury has occurred. Which explanation reflects the correct pathophysiology?",
                                     "options": [
                                         "Ongoing hypoxia and inflammation disrupt normal hepatocyte regeneration, causing disorganized regrowth with poor blood flow that generates more scar tissue and hypoxia.",
                                         "Once inflammation begins, hepatocytes stop regenerating completely, so the existing fibrotic scar tissue remains fixed and unchanged for the rest of the client's life.",
                                         "White blood cell infiltration and inflammatory mediators occur only once at the time of the initial injury and do not contribute to any fibrosis that develops afterward.",
                                         "Acetaldehyde continues to be produced independently of any further alcohol intake, and this ongoing acetaldehyde production alone accounts for the progression of fibrosis."
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: hepatocytes normally regenerate, but ongoing hypoxia and inflammation disrupt this process, producing disorganized regrowth with poor blood flow that generates more scar tissue and hypoxia in a self-worsening cycle. Incorrect: option 2 wrongly claims regeneration stops entirely rather than becoming disorganized; option 3 wrongly claims leukocyte infiltration is a one-time event rather than an ongoing driver of fibrosis; option 4 wrongly claims acetaldehyde is produced independent of alcohol intake and is the sole driver of progression.",
                                     "topic": "Cirrhosis &amp; Liver Failure",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A nurse is teaching a client about the multiple mechanisms that contribute to ascites formation in cirrhosis with portal hypertension. Which of the following are accurate contributing mechanisms? Select all that apply.",
                                     "options": [
                                         "Decreased albumin production lowers colloid oncotic pressure, allowing fluid to shift into the peritoneal cavity.",
                                         "Portal hypertension increases pressure in the portal system, contributing directly to fluid accumulation.",
                                         "RAAS activation and plasma volume expansion contribute to fluid retention.",
                                         "Systemic hypotension and vascular underfilling contribute to the fluid shifts seen in ascites.",
                                         "Elevated ammonia crossing the blood-brain barrier directly causes excess fluid to accumulate within the peritoneal cavity itself.",
                                         "Rifaximin's inhibition of bacterial RNA synthesis reduces portal pressure and prevents ascites from forming."
                                     ],
                                     "answers": [
                                         0,
                                         1,
                                     ...
                                     "rationale": "Correct: ascites results from a combination of low oncotic pressure from decreased albumin, portal hypertension itself, RAAS activation and plasma volume expansion, and systemic hypotension with vascular underfilling — a multi-mechanism process, not a single cause. Incorrect: ammonia crossing the blood-brain barrier causes hepatic encephalopathy, not ascites; rifaximin decreases ammonia-producing gut bacteria for hepatic encephalopathy and does not reduce portal pressure — no drug reverses portal hypertension.",
                                     "topic": "Cirrhosis &amp; Liver Failure",
                                     "source": "quiz-bank"
                                 }
                             ],
    ...
    },
    {
        ...
        "sets": {
            ...
            "extraPractice": [
                                 {
                                     "stem": "A client with a gallstone lodged where the cystic duct joins the common bile duct develops both right-upper-quadrant pain with fever and epigastric pain radiating to the back with an elevated amylase level. What best accounts for both findings appearing together?",
                                     "options": [
                                         "A single gallstone is blocking a duct shared by the gallbladder and pancreas, trapping bile and enzymes together.",
                                         "A pancreatic pseudocyst has formed outside the pancreas and is now compressing the gallbladder from outside the duct.",
                                         "A toxic alcohol metabolite is damaging both the pancreatic acinar cells and the gallbladder wall at the same time.",
                                         "Vitamin K malabsorption from lost bile salts is producing a bleeding disorder that resembles pancreatic inflammation."
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: the cystic/common bile duct and the pancreatic duct share a common pathway into the duodenum, so a single gallstone can block bile flow and trap pancreatic enzymes at the same time, producing both sets of findings. Incorrect: a pseudocyst is a complication of pancreatitis that forms after enzyme damage, not a cause of simultaneous gallbladder symptoms; the alcohol-toxic-metabolite mechanism applies to chronic pancreatitis from alcohol abuse, not to gallstone obstruction; vitamin K malabsorption causes a bleeding tendency, not epigastric pain with an elevated amylase.",
                                     "topic": "Gallbladder &amp; Pancreatic Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "Two clients report similar right-upper-quadrant pain radiating to the back after a fatty meal. Client A has normal vital signs and a soft, non-tender abdomen. Client B has a temperature of 101.8°F, an elevated WBC count, rebound tenderness, and guarding. What do these findings indicate?",
                                     "options": [
                                         "Both clients have simple biliary colic, which commonly produces fever, guarding, and an elevated white count.",
                                         "Client B's fever, leukocytosis, rebound tenderness, and guarding point to cholecystitis rather than uncomplicated biliary colic.",
                                         "Client A's normal exam rules out gallstone disease entirely, since cholelithiasis always produces measurable inflammatory signs.",
                                         "Client B's findings point to a pancreatic abscess, since high fever and leukocytosis only occur with pancreatic infection."
                                     ],
                                     "answer": 1,
                                     "rationale": "Correct: fever, leukocytosis, rebound tenderness, and guarding are signs of inflammation that are more specific to cholecystitis than to uncomplicated biliary colic. Incorrect: biliary colic pain alone does not produce fever, an elevated WBC count, or guarding; most cholelithiasis is asymptomatic, so a normal exam does not rule out stones being present; a pancreatic abscess also presents with high fever, leukocytosis, and an abdominal mass, but nothing here points to the pancreas rather than the gallbladder.",
                                     "topic": "Gallbladder &amp; Pancreatic Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with acute pancreatitis develops muscle twitching and a positive Trousseau sign. Which mechanism explains this finding?",
                                     "options": [
                                         "Trapped trypsin is directly binding circulating calcium ions and lowering the client's serum calcium level.",
                                         "Kallikrein-driven increases in vascular permeability are allowing calcium to leak into the peritoneal cavity.",
                                         "Free fatty acids released by trapped lipase are binding calcium and depositing it in the retroperitoneum.",
                                         "Elastase-related hemorrhage is diluting the client's serum calcium concentration through ongoing internal blood loss."
                                     ],
                                     "answer": 2,
                                     "rationale": "Correct: lipase's normal job is fat breakdown, so when trapped in the pancreas it generates free fatty acids that bind calcium and deposit it in the retroperitoneum, lowering serum calcium and producing tetany. Incorrect: trypsin's trapped effect is edema, necrosis, and hemorrhage, not calcium binding; kallikrein's trapped effect is edema and increased vascular permeability, not calcium loss; elastase's trapped effect is hemorrhage, which is not the mechanism behind this client's hypocalcemic finding.",
                                     "topic": "Gallbladder &amp; Pancreatic Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with severe acute pancreatitis develops hypotension and tachycardia progressing toward shock, without evidence of significant bleeding. Which trapped enzyme's effect best explains this presentation?",
                                     "options": [
                                         "Trypsin, whose trapped effect is edema, necrosis, and hemorrhage from ongoing pancreatic tissue autodigestion, producing visible blood loss.",
                                         "Elastase, whose trapped effect is hemorrhage from direct damage to pancreatic blood vessels, also producing visible blood loss over time.",
                                         "Phospholipase A, whose trapped effect is fat necrosis within the pancreatic tissue itself, not vascular leakage or hypotension.",
                                         "Kallikrein, whose trapped effect includes increased vascular permeability and smooth-muscle contraction that can contribute to shock."
                                     ],
                                     "answer": 3,
                                     "rationale": "Correct: kallikrein's trapped effect includes increased vascular permeability, which lets fluid leak out of the vascular space, plus smooth-muscle contraction, both of which can contribute to shock without necessarily causing overt hemorrhage. Incorrect: trypsin and elastase are both linked to hemorrhage, not this permeability/shock presentation; phospholipase A's trapped effect is fat necrosis, not vascular permeability or shock.",
                                     "topic": "Gallbladder &amp; Pancreatic Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client recovering from necrotizing hemorrhagic pancreatitis develops a very high fever, marked leukocytosis, and a palpable abdominal mass. CT shows a large fluid-filled cavity inside the pancreatic tissue itself. Which complication does this describe?",
                                     "options": [
                                         "A pancreatic abscess, an infected cavity inside the pancreas resulting from extensive tissue necrosis and infection.",
                                         "A pancreatic pseudocyst, a necrotic fluid collection that forms outside the pancreas, often identified later on imaging.",
                                         "Chronic pancreatitis, a fibrotic process that gradually replaces both acinar and islet cells over months to years.",
                                         "Hypovolemic shock, caused by ongoing fluid loss through increased vascular wall permeability, usually with tachycardia."
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: a pancreatic abscess is a large fluid-filled cavity inside the pancreas resulting from extensive necrosis, presenting with the usual pancreatitis picture plus an abdominal mass, very high fever, and leukocytosis from infection. Incorrect: a pseudocyst forms outside the pancreas and is not itself an infected cavity; chronic pancreatitis is a progressive fibrotic disease, not an acute fluid-filled cavity; hypovolemic shock presents with hypotension and tachycardia, not a palpable mass with very high fever.",
                                     "topic": "Gallbladder &amp; Pancreatic Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client asks why her gallstone-related pancreatitis resolved after surgery, while her friend's alcohol-related pancreatitis keeps causing pain, weight loss, and now diabetes even after she stopped drinking. What is the best explanation?",
                                     "options": [
                                         "Both conditions are the same reversible process, and the friend's symptoms will fully resolve given time and rest.",
                                         "The client's blocked duct resolved with stone removal, while the friend's chronic disease has destroyed acinar and islet cells.",
                                         "The friend's diabetes and weight loss are caused by a pseudocyst that will resolve once it is surgically drained next week.",
                                         "The friend's ongoing symptoms mean she must still be drinking, since chronic pancreatitis always resolves fully with abstinence alone."
                                     ],
                                     "answer": 1,
                                     "rationale": "Correct: acute pancreatitis from a gallstone resolves once the obstruction is removed, while chronic pancreatitis from alcohol abuse is a progressive disease in which a toxic metabolite has already destroyed acinar cells (causing fat malabsorption) and islet cells (causing diabetes), damage that does not reverse. Incorrect: the two are not the same reversible process; a pseudocyst is a separate pancreatitis complication and would not explain diabetes or restore islet function; chronic pancreatitis persists even with abstinence because the tissue damage is fibrotic and permanent.",
                                     "topic": "Gallbladder &amp; Pancreatic Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "The nurse is counseling a client of Indigenous heritage on gallstone risk compared to a white American client of the same age, sex, and weight. Which statement is accurate?",
                                     "options": [
                                         "Her lifetime risk is about the same, since ethnicity does not affect cholesterol or bilirubin metabolism.",
                                         "Her lifetime risk is lower, at 10-15%, compared to a white American client's 60-70% risk.",
                                         "Her lifetime risk is higher, at 60-70%, compared to a white American client's 10-15% risk.",
                                         "Her lifetime risk cannot be estimated, since ethnicity only influences pigmented stone formation."
                                     ],
                                     "answer": 2,
                                     "rationale": "Correct: genetic predisposition is a stated risk factor for gallstones, with Indigenous populations having a 60-70% lifetime risk compared to 10-15% in white Americans. Incorrect: ethnicity is a described risk factor, not a neutral one; the percentages are reversed in the option citing 10-15% vs 60-70%; the numeric difference is a general gallstone risk statistic, not limited to pigmented stone formation.",
                                     "topic": "Gallbladder &amp; Pancreatic Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with acute pancreatitis has severe epigastric pain that worsens with any abdominal palpation. Which two mechanisms together best explain this pain?",
                                     "options": [
                                         "Biliary colic from a stone in the cystic duct plus pruritus from bile salts deposited in the skin.",
                                         "Steatorrhea from undigested dietary fat plus clay-colored stools from bilirubin that never reached the intestine.",
                                         "Hypocalcemia-related muscle tetany plus hemorrhage caused by trapped elastase within the pancreas.",
                                         "Edema-driven distension of the pancreatic ducts and capsule plus chemical irritation of the peritoneum."
                                     ],
                                     "answer": 3,
                                     "rationale": "Correct: pancreatitis pain arises from two sources together, edema-driven distension of the pancreatic ducts and capsule plus chemical irritation and inflammation of the peritoneum, which is why palpation worsens the pain. Incorrect: biliary colic and pruritus are gallbladder- and bile-salt-related symptoms, not sources of pancreatic pain; steatorrhea and clay-colored stools are obstructive bile-flow symptoms, not pain mechanisms; tetany and hemorrhage are complications of specific trapped enzymes, not the described pain source.",
                                     "topic": "Gallbladder &amp; Pancreatic Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with a common bile duct stone reports greasy, foul-smelling stools that are difficult to flush. Which additional finding results from the SAME underlying mechanism of bile obstruction?",
                                     "options": [
                                         "Dark, foamy urine, from conjugated bilirubin backing into the blood and spilling into the urine.",
                                         "An elevated serum amylase level, from ongoing autodigestion of pancreatic tissue by trapped trypsin enzyme.",
                                         "A palpable epigastric mass, arising from a pseudocyst pressing outward against the abdominal wall.",
                                         "New muscle twitching, from calcium binding by free fatty acids deposited in the retroperitoneum."
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: steatorrhea and dark, foamy urine result from the same obstructed bile flow — bile salts fail to reach the duodenum (causing fatty, undigested stool) while conjugated bilirubin backs into the blood and spills into the urine. Incorrect: an elevated amylase reflects pancreatic organ damage from trapped enzymes, a separate mechanism; a palpable epigastric mass suggests a pancreatitis complication (pseudocyst), not biliary obstruction; muscle twitching from calcium binding is caused by trapped lipase in the pancreas, not by bile obstruction.",
                                     "topic": "Gallbladder &amp; Pancreatic Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with cholecystitis and a client with acute pancreatitis are both requesting pain medication. Based on first-line therapy for each condition, what should the nurse anticipate?",
                                     "options": [
                                         "Both clients should receive opioids first, since NSAIDs are contraindicated in abdominal inflammatory conditions.",
                                         "The cholecystitis client should receive IV ketorolac first, while the pancreatitis client should receive an opioid first.",
                                         "The pancreatitis client should receive IV ketorolac first, while the cholecystitis client should receive dicyclomine first.",
                                         "Both clients should receive bile acid therapy first, since it manages pain for both conditions until surgery."
                                     ],
                                     "answer": 1,
                                     "rationale": "Correct: IV ketorolac, an NSAID, is first-line pain control for cholelithiasis and cholecystitis, while opioids such as hydromorphone or morphine are first-line for acute and chronic pancreatitis. Incorrect: NSAIDs are not contraindicated in these conditions and are in fact first-line for gallbladder pain; the drug order is reversed in the option pairing ketorolac with pancreatitis, and dicyclomine is an antispasmodic adjunct, not first-line pain control; bile acid therapy dissolves stones for clients who cannot have surgery and is not a pain medication.",
                                     "topic": "Gallbladder &amp; Pancreatic Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A client with chronic pancreatitis tells the nurse she will take her pancrelipase capsule once in the morning, since that is when her pain is worst. What is the nurse's best response?",
                                     "options": [
                                         "Agree with her plan, since pancrelipase only needs to be present during a pain flare, not with other meals, to work.",
                                         "Explain that pancrelipase should be replaced with insulin, since diabetes is her primary problem to treat.",
                                         "Explain that pancrelipase must be taken with every meal and snack to replace missing digestive enzymes.",
                                         "Explain that pancrelipase works best on an empty stomach, taken between meals rather than with food, to avoid dilution."
                                     ],
                                     "answer": 2,
                                     "rationale": "Correct: pancrelipase replaces digestive enzymes that chronic pancreatitis clients no longer produce, and it must be taken with every single meal and snack so the fat and other nutrients in that food can be digested; adherence is essential. Incorrect: taking it only once a day would leave other meals and snacks undigested; insulin may be needed if islet cells are lost, but that does not remove the need for enzyme replacement with food; the enzymes need to be present with food in the gut, not on an empty stomach between meals.",
                                     "topic": "Gallbladder &amp; Pancreatic Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "The nurse is assigned two clients in the emergency department. Client 1 has intermittent right-upper-quadrant pain after a fatty meal, a normal temperature, and a soft abdomen. Client 2 has right-upper-quadrant pain, a temperature of 102°F, guarding, and rebound tenderness. Which client should the nurse prioritize for immediate provider notification?",
                                     "options": [
                                         "Client 1, since biliary colic pain is typically more severe than any inflammatory abdominal pain, even without fever or guarding.",
                                         "Neither client, since both presentations reflect simple cholelithiasis that can be managed the same way as outpatients without surgery.",
                                         "Client 1, since fatty food intolerance always precedes an eventual gallbladder surgical emergency needing urgent surgical care.",
                                         "Client 2, since fever, guarding, and rebound tenderness suggest cholecystitis, risking decreased blood flow and perforation."
                                     ],
                                     "answer": 3,
                                     "rationale": "Correct: fever, guarding, and rebound tenderness point to cholecystitis, which is more dangerous than simple cholelithiasis because pressure from the inflamed, distended gallbladder wall decreases blood flow, risking ischemia, necrosis, and perforation if untreated. Incorrect: biliary colic pain severity alone does not indicate greater danger than inflammatory disease; the two presentations are not equivalent since only Client 2 shows signs of inflammation; fatty food intolerance is a nonspecific cholelithiasis symptom and does not by itself predict a surgical emergency.",
                                     "topic": "Gallbladder &amp; Pancreatic Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
                                     "stem": "A nursing instructor asks students to compare two numeric facts from this unit. Which pairing is correct?",
                                     "options": [
                                         "About 70% of gallstones are cholesterol stones, and about 20% of acute pancreatitis cases become severe enough to require hospitalization.",
                                         "About 20% of gallstones are cholesterol stones, and about 70% of acute pancreatitis cases become severe enough to require hospitalization.",
                                         "About 70% of acute pancreatitis cases resolve without ever causing gallstones, and 20% of gallstones are pigmented.",
                                         "About 60-70% of gallstones are pigmented stones, and about 20% of cholecystitis cases progress to chronic pancreatitis."
                                     ],
                                     "answer": 0,
                                     "rationale": "Correct: cholesterol stones make up about 70% of gallstones, and roughly 20% of acute pancreatitis cases become severe enough to require hospitalization while most cases are mild and resolve spontaneously. Incorrect: the percentages are swapped in the option pairing 20% cholesterol stones with 70% severe pancreatitis; spontaneous resolution of pancreatitis is not tied to a 70% rate of never causing gallstones; the 60-70% figure describes Indigenous population gallstone risk, not pigmented stone share, and a 20% cholecystitis-to-chronic-pancreatitis progression rate is not a stated fact.",
                                     "topic": "Gallbladder &amp; Pancreatic Disorders",
                                     "source": "quiz-bank"
                                 },
                                 {
    ...
    {
        "id": "week5-esophageal-gastric-disorders",
        "label": "Esophageal &amp; Gastric Disorders",
        "week": 5,
        "sets": {
            "mustKnow": [],
            "extraPractice": [
                {
                    "stem": "A client recovering from a stroke develops dysphagia that starts with solids and later progresses to liquids. An esophagram shows no structural narrowing or mass. Which cause of dysphagia does this presentation best support?",
                    "options": [
                        "Neuromuscular cause (nerve damage)",
                        "Mechanical cause (esophageal tumor)",
                        "Mechanical cause (esophageal stricture)",
                        "Mechanical cause (esophageal diverticulum)"
                    ],
                    "answer": 0,
                    "rationale": "Correct: Stroke is listed as a neuromuscular cause of dysphagia because it disrupts esophageal innervation, and a normal esophagram rules out a structural blockage. Incorrect: An esophageal tumor is tempting because tumors also cause progressive solid-then-liquid dysphagia, but tumors are mechanical blockages that would show as a mass or narrowing on the esophagram, which this client does not have.",
                    "topic": "Esophageal &amp; Gastric Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with GERD has used OTC antacids nightly for months and stops them abruptly. Two days later, the client reports heartburn far worse than before, with no new dietary triggers reported. What should the nurse recognize as the most likely cause?",
                    "options": [
                        "Development of a new esophageal perforation",
                        "Rebound effect from stopping the antacids",
                        "Progression of GERD to Barrett's esophagus",
                        "An allergic reaction to the antacid"
                    ],
                    "answer": 1,
                    "rationale": "Correct: The page describes an intense rebound effect after stopping antacids, with heartburn returning rapidly and severely, which fits this abrupt two-day worsening. Incorrect: Barrett's esophagus is tempting since it is the most severe GERD complication, but it develops from chronic, long-term untreated GERD and would not suddenly appear within two days of stopping one medication.",
                    "topic": "Esophageal &amp; Gastric Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "An imaging report describes part of a client's stomach permanently positioned above the diaphragm, with a thin, defective peritoneal membrane forming a true sac around it. Which type of hiatal hernia does this describe?",
                    "options": [
                    ...
                    "answer": 2,
                    "rationale": "Correct: A paraesophageal hernia involves part of the stomach staying permanently above the diaphragm, with a thin, defective peritoneum forming a true sac, exactly as described. Incorrect: A sliding hernia is tempting because it is the more common type, but in a sliding hernia the peritoneum stays intact and restrains the hernia's size, which does not match a true herniated sac.",
                    "topic": "Esophageal &amp; Gastric Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "The nurse is planning teaching for two clients: one with 15 years of poorly controlled GERD and new dysphagia, and one with a 4-day episode of acute gastritis from NSAID use. Which client is the priority concern for Barrett's esophagus?",
                    "options": [
                        "The client with acute gastritis, due to NSAID use",
                        "Neither, since ulcers don't raise this specific risk",
                        "Both equally, since both involve gastric acid",
                        "The client with long-standing reflux disease"
                    ],
                    "answer": 3,
                    "rationale": "Correct: Barrett's esophagus develops from chronic, long-standing GERD, and providers monitor for it in long-term GERD patients; this client's 15-year history with new dysphagia fits that risk profile. Incorrect: The acute gastritis client is tempting because NSAIDs also cause GI injury, but the page ties NSAID-related acute gastritis to gastric injury, not to Barrett's esophagus, which is specifically a GERD complication.",
                    "topic": "Esophageal &amp; Gastric Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client reports epigastric burning and postprandial discomfort that has persisted for six weeks. There is no history of autoimmune disease. Based on duration alone, how should the nurse classify this presentation?",
                    "options": [
                        "Chronic gastritis",
                        "Acute gastritis",
                    ...
                    "answer": 0,
                    "rationale": "Correct: Acute gastritis generally lasts only 2 to 10 days, so six weeks of symptoms points to chronic gastritis, which can persist for weeks to years and can also result from chronic H. pylori infection rather than only autoimmune causes. Incorrect: Acute gastritis is tempting because postprandial burning is a classic finding for both forms, but the six-week duration alone rules out the acute timeframe.",
                    "topic": "Esophageal &amp; Gastric Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "Two clients present to the clinic. Client A has isolated vomiting and epigastric burning after meals. Client B has vomiting, watery stools, and fever for two days. Which client is at greatest immediate risk for fluid volume deficit?",
                    "options": [
                        "Client A, from epigastric burning alone",
                        "Client B, from vomiting and diarrhea",
                        "Both equally, since both involve vomiting",
                        "Neither, since symptoms are short-term"
                    ],
                    "answer": 1,
                    "rationale": "Correct: The page identifies fluid volume deficit/dehydration as the biggest concern in acute gastroenteritis because fluid is lost from vomiting and loose stool at once, and Client B's presentation fits that pattern. Incorrect: Client A's vomiting with epigastric burning fits gastritis, which affects the stomach lining only and lacks the second route of fluid loss that raises Client B's risk.",
                    "topic": "Esophageal &amp; Gastric Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A 65-year-old client with a long history of chronic NSAID use reports burning epigastric pain that begins about 1 to 2 hours after eating, as the stomach empties. Which type of ulcer does this presentation most likely represent?",
                    "options": [
                        "Duodenal ulcer",
                        "Esophageal ulcer",
                        "Gastric ulcer",
                    ...
                    "answer": 2,
                    "rationale": "Correct: Gastric ulcers classically cause burning pain 1 to 2 hours after eating as the stomach empties, and are more associated with chronic NSAID use and an older age of onset (50-70) — both match this client. Incorrect: Duodenal ulcer is tempting since it is the single most common peptic ulcer location overall, but its pain classically occurs 2 to 4 hours after eating, not 1 to 2 hours, so the timing does not fit.",
                    "topic": "Esophageal &amp; Gastric Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with long-standing peptic ulcer disease develops persistent vomiting, an inability to tolerate oral intake, and abdominal distension, without sudden severe pain or rigidity. Which complication from the HOP mnemonic does this suggest?",
                    "options": [
                        "Hemorrhage (active GI bleeding)",
                        "Perforation (erosion through wall)",
                        "Hypovolemia (fluid volume loss)",
                        "Obstruction (from scarring)"
                    ],
                    "answer": 3,
                    "rationale": "Correct: Persistent vomiting, oral intolerance, and distension without sudden pain reflect obstruction, since the mnemonic describes ulcer scar tissue and strictures binding areas and obstructing the intestines. Incorrect: Hemorrhage is tempting since it's also a HOP complication, but hemorrhage presents with bleeding such as hematemesis or black stool, not the vomiting-and-distension picture described here.",
                    "topic": "Esophageal &amp; Gastric Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client recently diagnosed with a peptic ulcer says, 'I've been so stressed at work lately, that's obviously what caused this ulcer.' What is the nurse's best response, based on current understanding?",
                    "options": [
                        "Stress doesn't cause ulcers, but worsens them",
                        "Stress is the primary cause, as the client says",
                        "Stress has no effect on ulcers at all",
                        "Only NSAIDs affect ulcer healing, not stress"
                    ],
                    "answer": 0,
                    "rationale": "Correct: The page states stress does not directly cause peptic ulcers, an outdated belief, but it can worsen an existing ulcer by increasing gastric acid secretion through the stress response. Incorrect: Agreeing that stress is the primary cause reinforces the exact outdated misconception the page corrects, rather than the current understanding that H. pylori, NSAIDs, and other factors are the actual causes.",
                    "topic": "Esophageal &amp; Gastric Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client who takes warfarin daily needs an H2 receptor blocker for GERD symptoms. Which consideration should most influence the nurse's medication discussion with the prescriber?",
                    "options": [
                        "Cimetidine is preferred since it's the newer agent",
                        "Cimetidine inhibits CYP450, raising the risk",
                        "Famotidine cannot be given with anticoagulants",
                        "Both agents carry identical interaction risk"
                    ],
                    "answer": 1,
                    "rationale": "Correct: The page notes cimetidine is a CYP450 inhibitor with significant drug interactions including warfarin, which is why famotidine, with much less interaction risk, is generally preferred instead. Incorrect: Calling cimetidine 'preferred' is backwards; the page states famotidine is the more commonly used and preferred agent precisely because it avoids this interaction risk.",
                    "topic": "Esophageal &amp; Gastric Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with confirmed Barrett's esophagus has taken omeprazole daily for several years and expresses worry after reading about long-term PPI risks like bone fracture. What should guide the nurse's response?",
                    "options": [
                        "Stop the PPI immediately to prevent bone loss",
                        "Switch to an antacid, which has no long-term risk",
                        "Continue the PPI, with ongoing monitoring",
                        "Switch to an H2 blocker, since it works better"
                    ],
                    "answer": 2,
                    "rationale": "Correct: The page states that for clients with real PUD or Barrett's esophagus risk, providers often judge the benefits of long-term PPI therapy to outweigh the risks and continue it with monitoring. Incorrect: Switching to an H2 blocker seems like a safer compromise, but the page states PPIs work better than H2 blockers, so switching would undertreat this client's Barrett's-related risk.",
                    "topic": "Esophageal &amp; Gastric Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client is prescribed sucralfate for a duodenal ulcer and also takes an oral thyroid medication each morning. How should the nurse schedule these two medications?",
                    "options": [
                        "Give them together for convenience and adherence",
                        "Separate them by only fifteen minutes",
                        "Give the thyroid medication IV instead",
                        "Separate them by about two hours"
                    ],
                    "answer": 3,
                    "rationale": "Correct: The page states sucralfate can decrease the absorption of other drugs, so other medications should be taken separately, about two hours apart. Incorrect: Separating by only fifteen minutes acknowledges a need for spacing, but the page specifies about two hours, not a brief fifteen-minute gap, to avoid reduced absorption.",
                    "topic": "Esophageal &amp; Gastric Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "The nurse is teaching a client about famotidine, an H2 receptor blocker used for GERD and peptic ulcer disease. Which statements are accurate? Select all that apply.",
                    "options": [
                        "Reduces gastric acid secretion by about 60-70%",
                        "Should be given IV slowly to avoid bradycardia",
                        "Irreversibly inhibits the H+/K+ ATPase proton pump",
                        "Causes more CYP450 interactions than cimetidine",
                        "Give at least 1 hour apart from antacids",
                        "Given prophylactically to critically ill clients"
                    ],
                    "answers": [
                        0,
                        1,
                    ...
                    "rationale": "Correct: H2 blockers reduce gastric acid secretion by about 60-70%, should be given IV slowly since rapid administration can cause bradycardia, should be spaced at least 1 hour apart from antacids, and are used for stress ulcer prophylaxis in hospitalized/critically ill clients. Incorrect: Irreversibly inhibiting the H+/K+ ATPase proton pump describes PPIs, not H2 blockers, and famotidine actually causes fewer CYP450 interactions than cimetidine, not more.",
                    "topic": "Esophageal &amp; Gastric Disorders",
                    "source": "quiz-bank"
                }
            ],
    ...
    {
        "id": "week5-lower-gi-disorders",
        "label": "Lower GI Disorders",
        "week": 5,
        "sets": {
            "mustKnow": [],
            "extraPractice": [
                {
                    "stem": "A client with sudden-onset severe RLQ pain and low-grade fever tells the nurse that the pain, which was severe an hour ago, has now completely disappeared, and the client reports feeling much better. What is the correct interpretation of this change?",
                    "options": [
                        "Recognize possible appendix rupture; notify the provider now.",
                        "Document the pain relief as evidence appendicitis is resolving.",
                        "Attribute the relief to less inflammation and keep monitoring.",
                        "Conclude rebound tenderness has resolved and stop assessing."
                    ],
                    "answer": 0,
                    "rationale": "Correct: Sudden, complete relief of severe appendicitis pain is not reassuring — it can mean the appendix has ruptured, so the provider must be notified immediately. Incorrect: Option B is the closest trap because pain relief sounds like improvement, but appendicitis does not spontaneously resolve; the same complete relief is specifically taught as a rupture warning sign, not a sign of healing.",
                    "topic": "Lower GI Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "Two clients arrive with lower abdominal pain. Client A has pain that began periumbilically and localized to the RLQ, with rebound tenderness. Client B has pain localized to the LLQ, a fever, an elevated WBC count, and a history of chronic constipation. Which statement correctly matches each client to the most likely diagnosis?",
                    "options": [
                        "Client A likely has diverticulitis; Client B likely has appendicitis.",
                        "Client A likely has appendicitis; Client B likely has diverticulitis.",
                        "Both clients likely have peritonitis based on quadrant pain alone.",
                        "Client A likely has ulcerative colitis; Client B likely has Crohn's disease."
                    ],
                    "answer": 1,
                    "rationale": "Correct: Appendicitis classically presents with periumbilical pain localizing to the RLQ with rebound tenderness, while diverticulitis classically presents with LLQ pain in a client with a history of chronic constipation (a diverticulosis risk factor) — the opposite quadrant from appendicitis. Incorrect: Option A reverses both quadrants, swapping the two conditions' classic locations. Options C and D introduce diagnoses not supported by either client's described findings.",
                    "topic": "Lower GI Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with IBD undergoes colonoscopy showing patchy, deep ulcerations in a cobblestone pattern, and the client reports watery diarrhea and a palpable RLQ mass. Which condition do these findings best support?",
                    "options": [
                        "Ulcerative colitis, since bloody diarrhea is the classic finding.",
                        "Ulcerative colitis, since inflammation spreads continuously from the rectum.",
                        "Crohn's disease, since skip lesions are a hallmark feature here.",
                        "Crohn's disease, since inflammation is limited to the mucosal layer."
                    ],
                    "answer": 2,
                    "rationale": "Correct: Patchy skip lesions with a cobblestone appearance, watery diarrhea, and an RLQ mass are all hallmark Crohn's disease features, and Crohn's is transmural (all bowel wall layers). Incorrect: Option D correctly names Crohn's disease but reverses the mechanism — mucosa-only involvement describes ulcerative colitis, not Crohn's. Options A and B describe real ulcerative colitis features (bloody diarrhea, continuous rectal spread) that do not match this client's patchy, watery-diarrhea presentation.",
                    "topic": "Lower GI Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with a history of Crohn's disease reports today's diarrhea \"looked a little red, but that's probably just from something I ate.\" The stool sample confirms the diarrhea is bloody. How should the nurse interpret this finding?",
                    "options": [
                        "As expected, since bloody diarrhea is the Crohn's hallmark sign.",
                        "As unrelated, since diet never changes stool appearance in IBD.",
                        "As reassuring, since bloody stool suggests a lower cancer risk.",
                        "As atypical, since watery diarrhea is the Crohn's hallmark."
                    ],
                    "answer": 3,
                    "rationale": "Correct: Watery diarrhea, not bloody diarrhea, is the hallmark feature taught for Crohn's disease, so bloody stool in this client is an atypical finding worth further follow-up rather than dismissing it as diet-related. Incorrect: Option A is the closest trap because it sounds authoritative, but it swaps the diarrhea types — bloody diarrhea is the hallmark of ulcerative colitis, not Crohn's disease.",
                    "topic": "Lower GI Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A nursing student caring for a client with suspected peritonitis reports the abdomen as \"distended and soft.\" What should the supervising nurse recognize as the priority reassessment?",
                    "options": [
                        "Reassess for a rigid abdomen, the true hallmark of peritonitis.",
                        "Reassess bowel sounds, since hyperactivity is the hallmark finding.",
                        "Reassess for RLQ tenderness as the true hallmark finding instead.",
                        "No reassessment needed; a soft, distended abdomen fits peritonitis."
                    ],
                    "answer": 0,
                    "rationale": "Correct: The biggest clinical sign of peritonitis is a rigid, board-like abdomen, which is distinctly different from a distended, soft abdomen, so the student's finding does not match what is expected and needs reassessment. Incorrect: Option D is the closest trap because distension can occur in abdominal disease generally, but peritonitis is specifically taught as producing rigidity, not softness, so it cannot be accepted at face value.",
                    "topic": "Lower GI Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A new nurse states that the tachycardia and hypotension seen in peritonitis are caused only by the sympathetic nervous system response to pain. How should the preceptor correct this statement?",
                    "options": [
                        "Agree, since pain is the only driver of these vital sign changes.",
                        "Explain that fluid shifts from third spacing are the main driver.",
                        "Explain that decreased peristalsis alone causes these vital sign changes.",
                        "Explain that these changes appear only after paralytic ileus develops."
                    ],
                    "answer": 1,
                    "rationale": "Correct: While sympathetic activation from pain contributes, the vital sign changes in peritonitis are mostly related to the fluid shifts (third spacing) that peritonitis causes, so pain alone is an incomplete explanation. Incorrect: Option A is the closest trap because pain is a real contributing factor, but the teaching point specifically ranks fluid shifts as the larger driver, not the sole one.",
                    "topic": "Lower GI Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "The nurse is caring for two clients: Client A has appendicitis with an intact, unruptured appendix and mild RLQ tenderness. Client B sustained a ruptured spleen after trauma. Based on the common mechanism behind peritonitis, which client is at greater immediate risk for developing it?",
                    "options": [
                        "Client A, since appendicitis is the single most common cause overall.",
                        "Neither, since peritonitis only develops from a ruptured GI organ.",
                        "Client B, since rupture lets contents leak into the cavity.",
                        "Both equally, since any lower abdominal condition carries equal risk."
                    ],
                    "answer": 2,
                    "rationale": "Correct: Peritonitis causes share a common theme of rupture or perforation letting contents that should stay contained escape into the peritoneal cavity; Client B's ruptured spleen fits this mechanism directly, while Client A's appendix is still intact. Incorrect: Option B is the closest trap because it recalls that rupture is the theme, but it wrongly excludes the spleen, which is explicitly listed as a peritonitis cause alongside the gut organs.",
                    "topic": "Lower GI Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client newly diagnosed with IBS states, \"My doctor said this is basically a stress illness — the stress is what's causing my bowel problems.\" What is the nurse's best response?",
                    "options": [
                        "\"That's right, stress is the primary cause of IBS for most clients.\"",
                        "\"Stress only worsens symptoms for clients with the IBS-D subtype.\"",
                        "\"Your bowel symptoms and stress levels are actually unrelated.\"",
                        "\"Stress doesn't cause IBS, but it can make your symptoms worse.\""
                    ],
                    "answer": 3,
                    "rationale": "Correct: Psychosocial stress is almost never a primary cause of IBS, but it is taught to exacerbate/worsen existing symptoms, and the relationship also runs the other way since IBS itself is stressful to live with. Incorrect: Option A is the closest trap because it repeats the client's own belief convincingly, but it directly contradicts the point that stress is not the primary cause.",
                    "topic": "Lower GI Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client asks why a routine colonoscopy found \"pouches in the colon\" even though the client has never had any related symptoms. Which explanation is accurate?",
                    "options": [
                        "This is diverticulosis, usually silent unless a pouch becomes inflamed.",
                        "This is diverticulitis, usually asymptomatic until it perforates suddenly.",
                        "This is diverticulosis, which always progresses to toxic megacolon untreated.",
                        "This is diverticulitis, which develops from a chronic high-fiber diet."
                    ],
                    "answer": 0,
                    "rationale": "Correct: Diverticulosis is the presence of colon pouches and is generally asymptomatic, typically found incidentally or once it progresses to diverticulitis (inflammation of a pouch). Incorrect: Option D is the closest trap because it correctly links diet to pouch disease, but it reverses the diet fact — a low-fiber diet causing chronic constipation is the taught cause, not a high-fiber diet, and this describes diverticulosis rather than diverticulitis.",
                    "topic": "Lower GI Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "The nurse reviews a new sulfasalazine prescription for a client with mild-to-moderate Crohn's disease. The client has a documented sulfa allergy and a history of anemia. What is the priority nursing action?",
                    "options": [
                        "Administer as prescribed, using extra caution for the anemia history.",
                        "Hold the medication and notify the provider about the sulfa allergy.",
                        "Hold the medication only because the anemia history is concerning.",
                        "Administer as prescribed; the sulfa allergy does not apply here."
                    ],
                    "answer": 1,
                    "rationale": "Correct: Sulfasalazine is contraindicated in clients with a sulfa allergy because it converts to sulfapyridine in the intestines, so the medication should be held and the provider notified. Incorrect: Option C is the closest trap because anemia is a real precaution listed for this drug, but the page teaches anemia as a \"use caution\" issue, not a contraindication like the sulfa allergy is.",
                    "topic": "Lower GI Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "Before a client's first infliximab infusion, which pre-screening finding is the priority for the nurse to report to the provider?",
                    "options": [
                        "The client's vaccination record is fully up to date.",
                        "The client's baseline CRP level is within normal limits.",
                        "The client's TB skin test result comes back positive.",
                        "The client's baseline vaccine titers show adequate immunity."
                    ],
                    "answer": 2,
                    "rationale": "Correct: Because infliximab suppresses the immune system, clients must be screened for TB/latent TB before starting; a positive result is a priority finding that needs provider follow-up before the immunosuppressive infusion begins. Incorrect: Options A, B, and D are the closest traps because they are all real parts of infliximab pre-screening and monitoring, but each describes a normal, reassuring result rather than the concerning finding that changes the plan of care.",
                    "topic": "Lower GI Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with a history of ulcerative colitis reports sudden severe abdominal distension, fever, and a rapidly rising heart rate. Which complication should the nurse suspect first?",
                    "options": [
                        "A fistula, the most common serious complication of ulcerative colitis.",
                        "Skip lesions progressing directly into a bowel obstruction.",
                        "New granuloma formation causing sudden bowel perforation.",
                        "Toxic megacolon, a life-threatening dilation of the large intestine."
                    ],
                    "answer": 3,
                    "rationale": "Correct: Toxic megacolon is a rapid, life-threatening dilation of the large intestine and a recognized serious complication of ulcerative colitis, matching this client's sudden distension, fever, and tachycardia. Incorrect: Option A is the closest trap because fistulas are a real IBD complication, but they are taught as a Crohn's disease complication, not a hallmark ulcerative colitis complication like toxic megacolon.",
                    "topic": "Lower GI Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "The nurse is teaching a client about complications associated with ulcerative colitis. Which of the following should be included? Select all that apply.",
                    "options": [
                        "Toxic megacolon, a rapid dilation of the colon",
                        "Fistulas connecting the bowel to nearby organs or skin",
                        "Hemorrhage from fragile granulation tissue",
                        "Granulomas identified on colonoscopy imaging",
                        "A higher risk of colon cancer than with Crohn disease",
                        "Increased risk of venous thromboembolism (VTE/DVT)"
                    ],
                    "answers": [
                        0,
                        2,
                    ...
                    "rationale": "Correct: Ulcerative colitis complications taught on this page include toxic megacolon, hemorrhage from fragile granulation tissue, a much higher colon cancer risk than Crohn's disease, and increased VTE/DVT risk (shared by both IBD conditions). Incorrect: Fistulas and granulomas are hallmark Crohn's disease features (transmural fistula formation and granulomas), not ulcerative colitis findings, making them the closest traps for a student mixing up the two conditions.",
                    "topic": "Lower GI Disorders",
                    "source": "quiz-bank"
                }
            ],
    ...
    {
        "id": "week5-gi-pharmacology",
        "label": "GI Symptom Pharmacology",
        "week": 5,
        "sets": {
            "mustKnow": [],
            "extraPractice": [
                {
                    "stem": "Mrs. Alvarez takes a daily SSRI for depression and receives a single IV dose of ondansetron for postoperative nausea. Which statement by the nurse best reflects appropriate understanding of this combination?",
                    "options": [
                        "This is fine to give, but she should be monitored closely.",
                        "The ondansetron must be held indefinitely whenever a client takes any SSRI.",
                        "This interaction only matters if she is also taking an antipsychotic.",
                        "No monitoring is needed, since ondansetron doesn't affect serotonin."
                    ],
                    "answer": 0,
                    "rationale": "Correct: Ondansetron affects serotonin, so combining it with a daily serotonergic drug like an SSRI raises serotonin syndrome risk; a single dose is usually fine but the combination warrants closer monitoring, especially on the first dose. Incorrect: Option 2 (\"only matters if also taking an antipsychotic\") is wrong because the page ties serotonin syndrome risk to serotonergic drugs (SSRIs, SNRIs, TCAs, MAOIs, buspirone, tramadol), not antipsychotics — that combination raises EPS/NMS risk with a different drug, metoclopramide.",
                    "topic": "GI Symptom Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A student nurse states, \"Hydroxyzine must be an H2 blocker since it's used for stomach-related symptoms.\" How should the instructor correct this statement?",
                    "options": [
                        "Hydroxyzine blocks H2 receptors in the stomach to reduce acid production.",
                        "Hydroxyzine is an H1 blocker that works in the inner ear, not an H2 blocker.",
                        "Hydroxyzine blocks dopamine receptors in the CTZ like ondansetron does.",
                        "Hydroxyzine and H2 blockers treat the same condition, so the label doesn't matter."
                    ],
                    "answer": 1,
                    "rationale": "Correct: Hydroxyzine is explicitly an H1 receptor blocker acting in the inner ear, used for motion sickness, dizziness, and nausea — not an H2 blocker, which is a different drug class for a different purpose. Incorrect: Option 2 borrows ondansetron's chemoreceptor trigger zone (CTZ)/serotonin mechanism and misapplies it to hydroxyzine, which works through H1 blockade in the inner ear, not dopamine or the CTZ.",
                    "topic": "GI Symptom Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "Mr. Diallo has taken metoclopramide regularly for several months and now develops repetitive tongue twisting, lip smacking, and chewing motions. This presentation is most consistent with:",
                    "options": [
                        "Akathisia, since he feels a constant urge to move.",
                        "Acute dystonia, since the contractions are involuntary.",
                        "Tardive dyskinesia, appearing after prolonged use.",
                        "Parkinsonism, since tremors and limb rigidity are present."
                    ],
                    "answer": 2,
                    "rationale": "Correct: Tardive dyskinesia is the late-onset EPS finding that develops with prolonged exposure, presenting as repetitive involuntary facial movements such as tongue twisting, chewing, and lip smacking — matching both the months-long timeline and the specific findings. Incorrect: Option 1 (acute dystonia) describes involuntary muscle contractions generally, not the facial/oral movements or the late-onset, prolonged-use pattern described here.",
                    "topic": "GI Symptom Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "The nurse is caring for two clients on metoclopramide. Client A, three days post-op, still has absent bowel sounds. Client B, on metoclopramide for months combined with an antipsychotic, now has new muscle rigidity and a 102°F fever. Which client should the nurse assess first?",
                    "options": [
                        "Client A, since absent bowel sounds need urgent metoclopramide dosing.",
                        "Client A, since prokinetic use is always the higher priority.",
                        "Client B, since rigidity and fever simply indicate acute dystonia.",
                        "Client B, since rigidity and fever are early signs of NMS."
                    ],
                    "answer": 3,
                    "rationale": "Correct: Rigid muscles and fever are described as the first signs of neuroleptic malignant syndrome (NMS), a rare but life-threatening complication that can progress to confusion and seizures, so Client B needs immediate assessment. Incorrect: Option 2 mislabels the same findings as acute dystonia (involuntary muscle contractions), which is a different, less severe EPS finding not defined by fever; absent bowel sounds after surgery (Client A) is an expected use for the prokinetic effect, not an emergency.",
                    "topic": "GI Symptom Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client taking an atropine-containing antidiarrheal combination asks why the nurse keeps checking his heart rate for \"just a diarrhea medication.\" What is the nurse's best explanation?",
                    "options": [
                        "This drug's anticholinergic effect can cause bradycardia.",
                        "Heart rate is checked because these combination drugs commonly cause tachycardia.",
                        "Heart rate is checked to detect the sedation these drugs typically cause.",
                        "Heart rate is checked to detect the constipation these drugs can cause."
                    ],
                    "answer": 0,
                    "rationale": "Correct: Atropine-containing antidiarrheal combinations can cause bradycardia because atropine is anticholinergic and drying, so heart rate monitoring is specifically tied to that effect. Incorrect: Option 1 reverses the actual direction of the cardiac effect (bradycardia, not tachycardia); drowsiness and constipation are real concerns with antidiarrheals but are not why heart rate specifically is monitored.",
                    "topic": "GI Symptom Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "An elderly client receiving hydroxyzine for nausea develops new confusion, blurred vision, dry mucous membranes, and a flushed, hot face during the shift. Which additional findings, if present, would also fit the anticholinergic toxidrome taught for this drug? Select all that apply.",
                    "options": [
                        "Worsening confusion and disorientation",
                        "Blurred vision",
                        "Dry mucous membranes and dry skin",
                        "Flushed skin with elevated temperature",
                    ...
                    "rationale": "Correct: The mnemonic taught for this toxidrome is \"mad as a hatter\" (CNS/mental status changes), \"blind as a bat\" (blurred vision), \"dry as a bone\" (dry mucous membranes), \"red as a beet\" (flushing), and \"hot as a hare\" (hyperthermia) — options 0-3 all match these. Incorrect: Diarrhea (option 4) is a listed adverse reaction of ondansetron, a different antiemetic, and is the opposite of the drying effect anticholinergics cause; bradycardia (option 5) is tied on this page to atropine-containing antidiarrheals, not H1-blocking antiemetics.",
                    "topic": "GI Symptom Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client asks why she received ondansetron for nausea from a migraine, since she'd only heard of it being used for chemotherapy patients. What is the nurse's best explanation?",
                    "options": [
                        "Ondansetron only works for chemo- and radiation-induced nausea; this order is an error.",
                        "It was originally for chemo/radiation nausea, now broadly applied.",
                        "Ondansetron blocks dopamine receptors, so it treats all causes of nausea.",
                        "Ondansetron can only be given IV for nausea that isn't chemo-related."
                    ],
                    "answer": 1,
                    "rationale": "Correct: Ondansetron was originally developed for chemotherapy- and radiation-induced nausea/vomiting but is now used broadly for any type of nausea, including non-oncologic causes like migraine. Incorrect: Option 2 misattributes ondansetron's mechanism as dopamine blockade, which is actually metoclopramide's mechanism; ondansetron is a serotonin (5-HT3) blocker, and it can be given PO or IV, not IV-only.",
                    "topic": "GI Symptom Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with cystic fibrosis-related GI motility issues and a client who just finished chemotherapy are both prescribed metoclopramide. Which statement correctly distinguishes the reason for use in each client?",
                    "options": [
                        "Both clients receive it purely for its antiemetic effect on the CTZ.",
                        "The CF client receives it as an antiemetic; the chemo client, as a prokinetic.",
                        "The CF client receives it as a prokinetic; the chemo client, as an antiemetic.",
                        "Neither use is appropriate, since metoclopramide only treats opioid-induced nausea."
                    ],
                    "answer": 2,
                    "rationale": "Correct: Metoclopramide's prokinetic use targets decreased peristalsis, as seen in cystic fibrosis, while its antiemetic use covers nausea/vomiting from chemotherapy, radiation, and opioids — so the CF client is prokinetic use and the chemo client is antiemetic use. Incorrect: Option 1 reverses this exact pairing; option 0 misattributes a CTZ mechanism to metoclopramide, which is actually ondansetron's site of action, since metoclopramide works by blocking dopamine and increasing LES tone/peristalsis.",
                    "topic": "GI Symptom Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "An elderly client is prescribed both hydroxyzine and metoclopramide for nausea. Based on their combined effects, which nursing concern is the priority?",
                    "options": [
                        "Increased risk of bradycardia from combined anticholinergic effects.",
                        "Increased risk of tardive dyskinesia from the hydroxyzine.",
                        "Decreased peristalsis from the hydroxyzine's H1 blockade.",
                        "Increased fall risk from additive sedation from the combination."
                    ],
                    "answer": 3,
                    "rationale": "Correct: Both hydroxyzine (significant sedation, anticholinergic effects) and metoclopramide (can also sedate) contribute additive sedation, and the page specifically flags elderly clients on these sedating antiemetics as having increased fall risk. Incorrect: Tardive dyskinesia is an EPS finding tied to metoclopramide's dopamine-blocking effect, not hydroxyzine; metoclopramide increases, not decreases, peristalsis, and that effect isn't caused by H1 blockade.",
                    "topic": "GI Symptom Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A nurse prepares to administer hydroxyzine IV push for a client's nausea because the client already has IV access and cannot tolerate oral intake. What should the charge nurse do?",
                    "options": [
                        "Stop the nurse; hydroxyzine should never be given IV.",
                        "Allow it, since existing IV access makes IV push the safest route.",
                        "Allow it, but only if the client is also receiving ondansetron.",
                        "Stop the nurse; hydroxyzine should be given IM only in elderly clients."
                    ],
                    "answer": 0,
                    "rationale": "Correct: Hydroxyzine should never be given IV, since IV administration can cause significant tissue damage, thrombosis, and gangrene; it can be given IM instead. Incorrect: Option 3 correctly identifies IM as the route but wrongly restricts it to elderly clients only — the IM route and IV prohibition apply to any client, not just older adults.",
                    "topic": "GI Symptom Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "Client A receives a single dose of metoclopramide after surgery. Client B takes metoclopramide daily along with an antipsychotic for a chronic condition. Which client is at higher risk for EPS?",
                    "options": [
                        "Client A, because postoperative metoclopramide use carries the highest EPS risk.",
                        "Client B, since regular use with an antipsychotic raises EPS risk.",
                        "Both clients have equal EPS risk regardless of dosing frequency or other medications.",
                        "Neither client is at risk, since EPS only occurs with antipsychotics alone."
                    ],
                    "answer": 1,
                    "rationale": "Correct: EPS with metoclopramide is more common with regular/prolonged use or when combined with antipsychotic medications, so Client B's daily use plus antipsychotic combination carries the higher risk. Incorrect: Option 3 contradicts the fact that metoclopramide itself, via dopamine blockade, can cause EPS even without an antipsychotic; a single postoperative dose (Client A) is not the higher-risk pattern described.",
                    "topic": "GI Symptom Pharmacology",
                    "source": "quiz-bank"
                }
            ],
    ...
    },
    {
        ...
        "sets": {
            ...
            "extraPractice": [
                {
                    "stem": "A nurse compares two clients on the endocrine unit. Client A has hypertension, a moon face, and purple striae. Client B has hypotension, salt cravings, and tanned-looking skin. Client B's presentation best fits which diagnosis?",
                    "options": [
                        "Addison's disease",
                        "Cushing's syndrome",
                        "Pheochromocytoma",
                    ...
                    "answer": 0,
                    "rationale": "Correct: Addison's disease causes hypoaldosteronism (hypotension, salt craving) and hyperpigmentation from co-secreted MSH. Incorrect: Cushing's syndrome is the closest distractor because it is the mirror-image adrenal cortex disorder, but it produces hypertension, moon face, and striae (Client A's picture), not hypotension and tanning.",
                    "topic": "Endocrine Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client has been on high-dose prednisone for 18 months for a chronic inflammatory condition and now shows cushingoid features. The provider is discontinuing the steroid. Which approach is correct for this type of Cushing's syndrome?",
                    "options": [
                        "Stop the prednisone abruptly",
                        "Taper the prednisone dose slowly",
                        "Schedule adrenal gland surgery",
                        "Begin pituitary radiation therapy"
                    ],
                    "answer": 1,
                    "rationale": "Correct: exogenous Cushing's syndrome from chronic steroid use is treated by slowly tapering the dose to the lowest symptom-controlling level, never stopping abruptly. Incorrect: abrupt cessation (the tempting choice) is explicitly warned against on the page; surgery and radiation are treatments for primary and secondary Cushing's, not exogenous steroid-induced Cushing's.",
                    "topic": "Endocrine Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with long-standing Cushing's syndrome is scheduled for surgery tomorrow. The nurse identifies a risk for hemodynamic instability during the procedure because chronically elevated cortisol has done what?",
                    "options": [
                        "Increased ACTH secretion from the pituitary",
                        "Caused the adrenal gland to hypertrophy",
                        "Blunted the stress-cortisol feedback loop",
                        "Increased aldosterone secretion alone"
                    ],
                    "answer": 2,
                    "rationale": "Correct: chronically elevated cortisol prevents the feedback loop from letting cortisol rise further in response to a new stressor like surgery, so the client may need supplemental ACTH or cortisol. Incorrect: ACTH is actually suppressed (not increased) by the chronic cortisol excess, and the adrenal gland can atrophy from disuse over time, not hypertrophy.",
                    "topic": "Endocrine Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with Addison's disease reports craving salty foods. Laboratory results show sodium 128 mEq/L and potassium 5.6 mEq/L. This electrolyte pattern results from deficiency of which hormone?",
                    "options": [
                        "Deficiency of cortisol only",
                        "Deficiency of ACTH signaling",
                        "Deficiency of adrenal androgens",
                        "Deficiency of aldosterone"
                    ],
                    "answer": 3,
                    "rationale": "Correct: aldosterone loss causes sodium and water loss with reciprocal potassium retention, plus salt craving. Incorrect: cortisol deficiency mainly drives hypoglycemia and fatigue, not this electrolyte pattern; ACTH is actually elevated (not deficient) as the pituitary's compensatory response.",
                    "topic": "Endocrine Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client on long-term hydrocortisone for Addison's disease tells the nurse, 'I feel fine now, so I'm going to stop taking my steroid.' The nurse explains that abrupt cessation can precipitate what?",
                    "options": [
                        "Addisonian crisis",
                        "Cushingoid features",
                        "SIADH",
                    ...
                    "answer": 0,
                    "rationale": "Correct: abruptly stopping corticosteroid therapy in Addison's disease is a direct trigger for an Addisonian crisis, a life-threatening emergency. Incorrect: Cushingoid features come from steroid excess, not withdrawal; SIADH and diabetes insipidus involve the separate ADH axis, not adrenal cortex withdrawal.",
                    "topic": "Endocrine Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client is newly diagnosed with Addison's disease after presenting with advanced symptoms. Manifestations of Addison's disease typically do not appear until approximately what percentage of the adrenal cortex has been destroyed?",
                    "options": [
                        "50%",
                        "90%",
                        "25%",
                    ...
                    "answer": 1,
                    "rationale": "Correct: the page states manifestations typically don't become evident until about 90% of the adrenal cortex has been destroyed, explaining the advanced presentation. Incorrect: 75% is the closest distractor but understates how much destruction the page specifies has usually occurred before symptoms appear.",
                    "topic": "Endocrine Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with Addison's disease is prescribed both hydrocortisone and fludrocortisone. A student asks why hydrocortisone alone, at a higher dose, isn't just used to cover everything. The instructor explains that fludrocortisone specifically provides what?",
                    "options": [
                    ...
                    "answer": 2,
                    "rationale": "Correct: fludrocortisone is the only mineralocorticoid replacement drug available and works like aldosterone on salt and water balance. Incorrect: glucocorticoid activity is already supplied by hydrocortisone (the closest distractor, since hydrocortisone does have some of both activities); ACTH suppression and androgen replacement are not the stated purpose of fludrocortisone.",
                    "topic": "Endocrine Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with Addison's disease develops a respiratory infection. Per standard sick-day teaching, how should the client adjust the glucocorticoid dose during this stress event?",
                    "options": [
                        "Skip doses until symptoms resolve",
                        "Double the dose for one day",
                        "Add fludrocortisone at the same dose",
                        "Triple the dose for three days"
                    ],
                    "answer": 3,
                    "rationale": "Correct: the '3-by-3 rule' teaches taking three times the usual glucocorticoid dose for three days during any stress event, in coordination with the provider. Incorrect: doubling for one day (the closest distractor) does not match the taught rule, and skipping doses during illness is dangerous since stress increases the need for glucocorticoid, not less.",
                    "topic": "Endocrine Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client reports sudden episodes of severe headache, sweating, and palpitations with blood pressure spikes triggered by stress or exercise, resolving between episodes. As opposed to the sustained hypertension of Cushing's syndrome, this episodic pattern is most consistent with which condition?",
                    "options": [
                        "Pheochromocytoma",
                        "Addison's disease",
                        "SIADH",
                    ...
                    "answer": 0,
                    "rationale": "Correct: pheochromocytoma causes the classic triad of headache, diaphoresis, and tachycardia in sporadic episodes triggered by sympathetic stimulation, unlike Cushing's steadier hypertension. Incorrect: Addison's disease causes hypotension, not hypertensive spikes; SIADH and diabetes insipidus are ADH disorders without this catecholamine-driven triad.",
                    "topic": "Endocrine Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A nursing student states, 'Phenoxybenzamine seems like a poor choice for pheochromocytoma because its receptor blockade can't be reversed.' Using only pheochromocytoma-specific reasoning, how should the instructor correct this statement?",
                    "options": [
                        "Irreversible blockade is unsafe and must be avoided at all costs",
                        "Irreversible blockade gives long-lasting alpha-receptor control",
                        "Phenoxybenzamine is only ever used after surgery, never before",
                        "The irreversible effect only ever affects beta receptors, not alpha"
                    ],
                    "answer": 1,
                    "rationale": "Correct: the page notes that although irreversible receptor blockade is usually undesirable, in pheochromocytoma it is exactly what's wanted for long-lasting alpha-receptor blockade before and during surgical manipulation. Incorrect: it is given before surgery (about 10-14 days prior), continuing briefly after, not only afterward, and it blocks alpha receptors, not beta.",
                    "topic": "Endocrine Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with SIADH has a serum sodium of 130 mEq/L, weight gain, and low urine output. The provider is deciding whether to add a loop diuretic. Based on the sodium threshold given for SIADH management, is a loop diuretic appropriate here?",
                    "options": [
                        "No, loop diuretics are never used in SIADH",
                        "No, the sodium is too high for diuretics",
                        "Yes, sodium is above 125 mEq/L",
                        "Yes, but only combined with desmopressin"
                    ],
                    "answer": 2,
                    "rationale": "Correct: loop diuretics can be given in SIADH only when sodium is above 125 mEq/L, and 130 mEq/L meets that threshold. Incorrect: loop diuretics are used in SIADH under that specific condition, not never; desmopressin treats diabetes insipidus, the opposite ADH problem, and would worsen SIADH's water retention.",
                    "topic": "Endocrine Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with a history of small cell lung carcinoma and a client recovering from a recent head injury both develop hyponatremia and concentrated urine consistent with SIADH. Which client's cause reflects the single most common cause of SIADH?",
                    "options": [
                        "Neither; SSRIs are the most common cause",
                        "The client with the head injury",
                        "Neither; hypothyroidism is the most common cause",
                        "The client with small cell lung carcinoma"
                    ],
                    "answer": 3,
                    "rationale": "Correct: a malignant tumor, specifically small cell carcinoma of the lung, is described as by far the most common cause of SIADH. Incorrect: head trauma is a listed CNS cause but not the most common one; SSRIs and hypothyroidism are also listed causes, but neither is identified as the leading cause.",
                    "topic": "Endocrine Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "Two clients are being evaluated. Client A has serum sodium 152 mEq/L, dilute urine, and 6 L of urine output in 8 hours. Client B has serum sodium 128 mEq/L, concentrated urine, and minimal urine output. Client A's findings are most consistent with which condition?",
                    "options": [
                        "Diabetes insipidus",
                        "SIADH",
                        "Addison's disease",
                    ...
                    "answer": 0,
                    "rationale": "Correct: diabetes insipidus produces very high serum sodium, dilute urine, and massive urine output (up to 15 L/day), matching Client A. Incorrect: SIADH (the closest distractor, and Client B's picture) causes low sodium with concentrated urine and low output, the opposite pattern; Addison's and Cushing's involve cortisol/aldosterone, not this urine-output pattern.",
                    "topic": "Endocrine Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client taking long-term lithium for bipolar disorder develops polyuria and dilute urine from nephrogenic diabetes insipidus. The provider asks why desmopressin isn't the treatment of choice here. The nurse explains this is because of what?",
                    "options": [
                        "The pituitary has stopped releasing ADH",
                        "The kidneys can't respond to ADH itself",
                        "Desmopressin only treats permanent DI cases",
                        "Lithium has destroyed the pituitary gland"
                    ],
                    "answer": 1,
                    "rationale": "Correct: in nephrogenic DI the kidneys themselves cannot respond to ADH, so giving more ADH via desmopressin does not help; a thiazide diuretic is used instead. Incorrect: the pituitary release problem (the closest distractor) describes neurogenic DI, not nephrogenic; lithium causes a kidney-level problem, not pituitary destruction.",
                    "topic": "Endocrine Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A nurse is planning care for a client with SIADH. Select all measures that are appropriate treatments for this client.",
                    "options": [
                        "Fluid restriction",
                        "Desmopressin nasal spray administration",
                        "Treating the underlying cause",
                        "Thiazide diuretic (HCTZ) administration",
                    ...
                    "rationale": "Correct: fluid restriction is a core non-drug measure, treating/removing the underlying cause (tumor, causative drug, or waiting out trauma) is directed therapy, demeclocycline is used for chronic/refractory SIADH, and salt tablets help replace lost sodium. Incorrect: desmopressin and thiazide diuretics are diabetes insipidus treatments (for neurogenic and nephrogenic DI respectively) and would worsen SIADH's water retention rather than treat it.",
                    "topic": "Endocrine Disorders",
                    "source": "quiz-bank"
                }
            ],
    ...
    {
        "id": "week5-thyroid-parathyroid-disorders",
        "label": "Thyroid &amp; Parathyroid Disorders",
        "week": 5,
        "sets": {
            "mustKnow": [],
            "extraPractice": [
                {
                    "stem": "A nurse is assessing a client recently diagnosed with Graves' disease. Which findings should the nurse expect to identify as consistent with this diagnosis? Select all that apply.",
                    "options": [
                        "Heat intolerance",
                        "Weight loss despite a normal appetite",
                        "Bradycardia with a noticeably slowed heart rate",
                        "Increased risk for atrial fibrillation",
                        "Cold intolerance with a slowed heart rate",
                        "A bruit heard over the enlarged thyroid gland"
                    ],
                    "answers": [
                        0,
                        1,
                    ...
                    "rationale": "Correct: Graves' disease (primary hyperthyroidism) speeds metabolism, producing heat intolerance and weight loss, and enhanced catecholamine sensitivity raises the risk for arrhythmias such as atrial fibrillation; the enlarged, hypervascular gland often produces an audible bruit. Incorrect: Bradycardia and cold intolerance are hypothyroidism findings, the opposite metabolic direction from hyperthyroidism/Graves' disease.",
                    "topic": "Thyroid &amp; Parathyroid Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A nurse is comparing thyroid lab results for two clients being evaluated for hypothyroidism. Client A has an increased TSH with decreased T3 and T4. Client B has a decreased TSH with decreased T3 and T4. Which statement correctly identifies each client's type of hypothyroidism?",
                    "options": [
                        "Client A has primary hypothyroidism; Client B has secondary hypothyroidism.",
                        "Client A has secondary hypothyroidism; Client B has primary hypothyroidism instead.",
                        "Both clients have primary hypothyroidism, differing only in severity.",
                        "Both clients have hyperthyroidism, differing only in the underlying cause."
                    ],
                    "answer": 0,
                    "rationale": "Correct: An increased TSH with decreased T3/T4 (Client A) shows the pituitary compensating for a failing thyroid gland, which is primary hypothyroidism; a decreased TSH with decreased T3/T4 (Client B) shows pituitary failure to secrete TSH, which is secondary hypothyroidism. Incorrect: The reversed pairing mismatches each client's TSH direction with the wrong type of hypothyroidism -- the client with the INCREASED TSH is the one whose thyroid gland itself has failed, not the one with a decreased TSH.",
                    "topic": "Thyroid &amp; Parathyroid Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "The nurse is assessing two clients with a history of hyperthyroidism. Client 1 reports feeling anxious and has lost 8 lb (3.6 kg) over the past month. Client 2, one day after a thyroidectomy, has a temperature of 103.1 F (39.5 C), a heart rate of 160/min, and new confusion. Which client requires the nurse's immediate intervention?",
                    "options": [
                        "Client 1, because the weight loss and anxiety require urgent treatment.",
                        "Client 2, because the findings suggest thyroid storm.",
                        "Both clients, because each has symptoms of hyperthyroidism.",
                        "Neither client, because these findings are expected after thyroidectomy."
                    ],
                    "answer": 1,
                    "rationale": "Correct: Fever, marked tachycardia, and new confusion after a major stressor such as surgery match the life-threatening thyroid storm described on the page, which can cause death within 48 hours if untreated. Incorrect: Client 1's weight loss and anxiety are typical, non-emergent hyperthyroid manifestations rather than the extreme presentation of thyroid storm, so Client 2 -- not both clients equally -- is the priority.",
                    "topic": "Thyroid &amp; Parathyroid Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client's laboratory results show a TSH of 12 mIU/L (high), a free T4 of 0.6 ng/dL (low), and a positive anti-thyroid peroxidase antibody. Which condition do these findings support?",
                    "options": [
                        "Graves' disease",
                    ...
                    "answer": 2,
                    "rationale": "Correct: A high TSH with a low T4 and a positive anti-thyroid peroxidase antibody (the hallmark test on the page) is the classic pattern of Hashimoto's thyroiditis, the most common cause of primary hypothyroidism. Incorrect: Graves' disease would show a LOW TSH with a HIGH T4, the opposite lab pattern; secondary hypothyroidism would show a low, not high, TSH.",
                    "topic": "Thyroid &amp; Parathyroid Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client taking amiodarone for a cardiac arrhythmia states, 'Since this medication contains iodine, I know it can only make my thyroid overactive.' Which response by the nurse is correct?",
                    "options": [
                        "Amiodarone only causes hyperthyroidism because of its iodine content.",
                        "Amiodarone only affects the parathyroid glands, not the thyroid.",
                        "Amiodarone causes hypothyroidism exclusively, never hyperthyroidism.",
                        "Amiodarone can cause either hyperthyroidism or hypothyroidism."
                    ],
                    "answer": 3,
                    "rationale": "Correct: The page identifies amiodarone as a medication that can cause EITHER hypothyroidism or hyperthyroidism, so thyroid function requires monitoring in either direction. Incorrect: Confirming the client's belief that it 'only' causes overactivity ignores that amiodarone is also a recognized risk factor for hypothyroidism, and claiming it affects only the parathyroid glands misidentifies the organ involved.",
                    "topic": "Thyroid &amp; Parathyroid Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client in her second trimester of pregnancy who takes PTU for hyperthyroidism asks the nurse why her provider wants to switch her to a different medication. Which explanation is correct?",
                    "options": [
                        "PTU carries a hepatotoxicity risk and is switched after trimester one.",
                        "PTU is safe throughout all three trimesters and never needs changing.",
                        "PTU is not safe at any point during pregnancy and should never be used.",
                        "PTU stops suppressing thyroid hormone after the first trimester."
                    ],
                    "answer": 0,
                    "rationale": "Correct: PTU carries a black box warning for hepatotoxicity, so it can be used cautiously only in the first trimester before being changed to a different medication for the second and third trimesters. Incorrect: PTU is not safe throughout the entire pregnancy, but it is also not unsafe from the very start -- it is specifically permitted during the first trimester; the switch is due to liver toxicity risk, not because PTU stops working.",
                    "topic": "Thyroid &amp; Parathyroid Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client taking both levothyroxine and warfarin reports feeling 'a little more tired than usual' this week. The nurse also notes new bruising on the client's forearms. Which finding is the priority for the nurse to address?",
                    "options": [
                        "The fatigue, because it indicates the levothyroxine dose is too low.",
                        "The bruising, because levothyroxine increases the effect of warfarin.",
                        "The fatigue, because it indicates the levothyroxine dose is too high.",
                        "The bruising, because warfarin alone explains it, regardless of levothyroxine."
                    ],
                    "answer": 1,
                    "rationale": "Correct: Levothyroxine increases the effect of warfarin, raising bleeding risk, so new bruising in a client on both drugs is the priority safety concern requiring closer monitoring. Incorrect: Mild fatigue alone is a vague complaint that does not clearly indicate a specific dosing problem, and blaming the bruising on warfarin 'alone' ignores the page's specific warning about the levothyroxine-warfarin interaction.",
                    "topic": "Thyroid &amp; Parathyroid Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "An older adult client with a history of untreated hypothyroidism for several years is found to be minimally responsive with a very low body temperature. Which condition should the nurse suspect?",
                    "options": [
                        "Thyroid storm",
                    ...
                    "answer": 2,
                    "rationale": "Correct: Myxedema coma is the life-threatening complication of severe, prolonged, untreated hypothyroidism that causes loss of brain function, matching this client's history and presentation. Incorrect: Thyroid storm is the extreme complication of hyperthyroidism, the opposite condition, and presents with fever and tachycardia rather than a very low temperature and unresponsiveness.",
                    "topic": "Thyroid &amp; Parathyroid Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "Two days after a thyroidectomy, a client reports new muscle cramping in the hands and appears more irritable than earlier in the shift. Vital signs are within normal limits. Which action should the nurse take first?",
                    "options": [
                        "Prepare to give levothyroxine, since surgery can cause hypothyroidism.",
                        "Notify the provider to obtain an order for calcitonin.",
                        "Document the finding and reassess again in eight hours.",
                        "Assess the client for Chvostek's and Trousseau's signs."
                    ],
                    "answer": 3,
                    "rationale": "Correct: Muscle cramping and irritability after thyroidectomy are early signs of hypocalcemia from possible parathyroid gland injury, so the nurse should assess for Chvostek's and Trousseau's signs, the bedside checks named on the page. Incorrect: Calcitonin lowers calcium in hyperparathyroidism, the opposite problem, and levothyroxine treats hypothyroidism, not the hypocalcemia caused by parathyroid damage; waiting eight hours delays assessment of a possibly worsening electrolyte imbalance.",
                    "topic": "Thyroid &amp; Parathyroid Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A nurse is reviewing calcium and phosphate trends for a client with hypoparathyroidism and a different client with hyperparathyroidism. Which statement about their expected lab patterns is correct?",
                    "options": [
                        "Hypoparathyroidism raises phosphate and lowers calcium; hyperparathyroidism raises calcium.",
                        "Both disorders raise calcium and lower phosphate levels.",
                        "Hypoparathyroidism raises calcium and lowers phosphate; hyperparathyroidism lowers calcium overall.",
                        "Both disorders lower calcium and raise phosphate levels."
                    ],
                    "answer": 0,
                    "rationale": "Correct: Low PTH in hypoparathyroidism causes hypocalcemia with increased phosphate (since PTH normally increases phosphate excretion), while excess PTH in hyperparathyroidism produces hypercalcemia. Incorrect: The option that reverses each disorder's calcium direction has it backwards -- it is hyperparathyroidism, not hypoparathyroidism, that raises calcium, since PTH's core job is raising calcium levels.",
                    "topic": "Thyroid &amp; Parathyroid Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client is found to have an enlarged thyroid gland on physical exam but has no other signs of thyroid dysfunction and normal thyroid hormone levels. The client asks the nurse if this means the thyroid is not working properly. Which response is correct?",
                    "options": [
                        "The thyroid must be producing excess hormone.",
                        "This is called a nontoxic goiter.",
                        "This means hypothyroidism is beginning.",
                        "This can only happen with hyperparathyroidism."
                    ],
                    "answer": 1,
                    "rationale": "Correct: A goiter without accompanying symptoms of thyroid dysfunction is called a nontoxic goiter, which the page describes as enlargement that can occur with normal hormone levels. Incorrect: Claiming the gland must be overactive or that hypothyroidism is starting contradicts the stated normal hormone levels, and goiter is a thyroid gland finding, not a parathyroid one.",
                    "topic": "Thyroid &amp; Parathyroid Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client's radioactive iodine uptake scan shows increased uptake that is diffusely distributed throughout the entire thyroid gland. Which condition does this finding support?",
                    "options": [
                    ...
                    "answer": 2,
                    "rationale": "Correct: The page states that in Graves' disease, radioactive iodine uptake is increased and diffusely distributed over the entire gland. Incorrect: A cancerous nodule would instead produce a focal, localized area of uptake rather than a diffuse pattern; Hashimoto's thyroiditis is a hypothyroid condition and would not show increased uptake reflecting hormone overproduction.",
                    "topic": "Thyroid &amp; Parathyroid Disorders",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with a history of Graves' disease reports occasional blurry vision during a routine follow-up visit. On examination, the nurse notes bilateral bulging of the eyes with periorbital swelling. Which action should the nurse prioritize?",
                    "options": [
                        "Reassure the client that bulging eyes are a cosmetic finding only.",
                        "Attribute the blurry vision to normal aging and take no action.",
                        "Delay any eye referral until thyroid hormone levels normalize.",
                        "Refer the client for a prompt eye examination."
                    ],
                    "answer": 3,
                    "rationale": "Correct: The page teaches that any client with a history of hyperthyroidism/Graves' disease needs an eye exam, since Graves' ophthalmopathy can impair vision. Incorrect: Dismissing exophthalmos as purely cosmetic ignores its documented vision-impairment risk, and the client's blurry vision alongside objective bulging and swelling is a Graves' ophthalmopathy finding, not an unrelated age-related symptom or something to delay evaluating.",
                    "topic": "Thyroid &amp; Parathyroid Disorders",
                    "source": "quiz-bank"
                }
            ],
    ...
    {
        "id": "week6-ischemic-heart-disease-heart-failure",
        "label": "Ischemic Heart Disease &amp; Heart Failure",
        "week": 6,
        "sets": {
            "mustKnow": [],
            "extraPractice": [
                {
                    "stem": "A client with a 15-year history of type 2 diabetes and hypertension has known coronary plaque on angiogram. During exertion, the nurse notes the client's chest pain worsens rather than improves despite the body's expected compensatory response. Which mechanism best explains this finding?",
                    "options": [
                        "Damaged endothelium is vasoconstricting",
                        "The plaque has fully occluded the vessel",
                        "Collateral circulation is compensating poorly",
                        "Estrogen loss has accelerated plaque rupture"
                    ],
                    "answer": 0,
                    "rationale": "Correct: Endothelial dysfunction causes coronary arteries to vasoconstrict instead of dilating when the heart needs more oxygen, worsening ischemia on top of existing plaque narrowing — driven by this client's diabetes and hypertension. Incorrect: 'Fully occluded vessel' is the closest distractor, but a completely occluded lumen would typically produce pain unrelieved by rest (MI), not exertional worsening from a known angiographic plaque; this scenario reflects the vasoconstrictive endothelial response, not total occlusion.",
                    "topic": "Ischemic Heart Disease &amp; Heart Failure",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client asks why a blockage in the LAD is more feared clinically than a similar blockage in a vessel with well-developed collateral circulation. What is the nurse's best explanation?",
                    "options": [
                        "It vasoconstricts instead of dilating during ischemia",
                        "It has no collateral circulation to fall back on",
                        "It is grouped with valve disorders in the \"plumbing\" category",
                        "It feeds the right ventricle, which perfuses the body"
                    ],
                    "answer": 1,
                    "rationale": "Correct: The LAD's danger comes specifically from having no collateral circulation to fall back on, so a blockage leaves no backup blood supply — this is why it's called the 'widow maker.' Incorrect: 'Grouped with valve disorders in the plumbing category' is true of the page's broader classification of plumbing problems but doesn't explain why the LAD specifically is more lethal than a vessel with collateral flow.",
                    "topic": "Ischemic Heart Disease &amp; Heart Failure",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A 58-year-old woman tells the nurse she isn't worried about developing CAD because \"women are protected from heart disease.\" She reached menopause three years ago. Which response is most accurate?",
                    "options": [
                        "Estrogen protects her regardless of menopausal status",
                        "Her risk is lower — postmenopausal women make more estrogen",
                        "Her risk has increased as estrogen's protection declines",
                        "Gender doesn't affect CAD risk once factors are controlled"
                    ],
                    "answer": 2,
                    "rationale": "Correct: Estrogen is cardioprotective before menopause, so a woman's CAD risk increases as that protective effect declines after menopause. Incorrect: The closest distractor claims postmenopausal women 'make more estrogen,' which reverses the actual physiology — menopause is defined by declining estrogen, not increased estrogen.",
                    "topic": "Ischemic Heart Disease &amp; Heart Failure",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with a known history of stable angina reports today's chest discomfort started with light housework, has lasted about 15 minutes despite sitting down to rest, and feels different from prior episodes. What should the nurse prioritize?",
                    "options": [
                        "Reassure the client that stable angina can last 15 minutes",
                        "Have the client take a nitrate and wait 15 more minutes",
                        "Chart this as a typical anginal episode",
                        "Treat this as a possible MI and seek urgent care"
                    ],
                    "answer": 3,
                    "rationale": "Correct: Stable angina typically lasts only 2–5 minutes and resolves with rest; pain triggered by minimal exertion that persists 15 minutes despite rest no longer fits that pattern and is a red flag for unstable angina or MI requiring urgent evaluation. Incorrect: 'Take a nitrate and wait 15 more minutes' is the closest distractor, but delaying further action ignores that the rest-relief criterion for stable angina has already failed.",
                    "topic": "Ischemic Heart Disease &amp; Heart Failure",
                    "source": "quiz-bank"
                },
                {
                    "stem": "Two clients report chest pain during exertion. Client A's pain resolves within 4 minutes of sitting down. Client B's pain has persisted for 20 minutes despite rest and now radiates to the jaw with nausea. Which client's presentation is most consistent with MI rather than stable angina?",
                    "options": [
                        "Client B — pain is not relieved by rest",
                        "Client A — pain occurred during exertion",
                        "Client B — pain lasted only 4 minutes",
                        "Client A — pain radiates to the jaw"
                    ],
                    "answer": 0,
                    "rationale": "Correct: Pain not relieved by rest is the specific feature this content uses to distinguish MI from stable angina, which is why Client B's presentation is concerning. Incorrect: The closest distractor swaps the durations — Client A's pain (not Client B's) lasted about 4 minutes, consistent with stable angina's typical 2–5 minute window.",
                    "topic": "Ischemic Heart Disease &amp; Heart Failure",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A woman having an MI tells the nurse, \"It can't be my heart — I don't have the crushing chest pressure my husband had.\" Which response reflects accurate teaching from this content?",
                    "options": [
                        "Women's MIs always present with classic chest pressure",
                        "Women often present atypically, not with pressure",
                        "Chest pain is required to diagnose MI in any client",
                        "Nausea and fatigue rule out a cardiac cause in women"
                    ],
                    "answer": 1,
                    "rationale": "Correct: Women often present atypically — with hot/burning discomfort, pain outside the chest, indigestion, nausea, or fatigue rather than classic chest pressure — a documented reason MI is missed or delayed in women. Incorrect: The claim that women's MIs 'always' present with classic chest pressure is the opposite of this content's point about atypical presentation.",
                    "topic": "Ischemic Heart Disease &amp; Heart Failure",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client points with one finger to a specific spot on the chest wall and says, \"It hurts right here.\" Based on this content, how should the nurse interpret this description?",
                    "options": [
                        "This is classic for cardiac chest pain",
                        "This confirms unstable angina",
                        "This suggests a non-cardiac source",
                        "This matches a typical MI radiating pattern"
                    ],
                    "answer": 2,
                    "rationale": "Correct: A focal description the client can pinpoint ('right here') is characteristic of non-cardiac chest pain, per this content's comparison table. Incorrect: The closest distractor calls this 'classic for cardiac chest pain,' but cardiac pain is described as diffuse and hard to pinpoint (pressure, tightness, 'an elephant sitting on my chest'), the opposite of a pointed-to focal location.",
                    "topic": "Ischemic Heart Disease &amp; Heart Failure",
                    "source": "quiz-bank"
                },
                {
                    "stem": "In the heart failure hemodynamic chain described in this content, which change occurs first, setting off the rest of the sequence?",
                    "options": [
                        "Increased afterload",
                        "Increased preload",
                    ...
                    "answer": 3,
                    "rationale": "Correct: In the HF hemodynamic chain, contractility decreases first, which then drives the rest of the sequence. Incorrect: 'Increased preload' is the closest distractor because it is the hallmark fluid-overload finding, but it is the second step in the chain — a consequence of decreased contractility, not the initiating event.",
                    "topic": "Ischemic Heart Disease &amp; Heart Failure",
                    "source": "quiz-bank"
                },
                {
                    "stem": "An echocardiogram shows a stiff, non-compliant left ventricle that cannot relax and fill properly. The client also has amyloid deposits noted on biopsy and is developing right-sided heart failure. Which type of cardiomyopathy is most consistent with this picture?",
                    "options": [
                    ...
                    "answer": 0,
                    "rationale": "Correct: A stiff, non-compliant ventricle with impaired relaxation/filling, amyloid deposits, and a tendency toward right-sided heart failure are the defining features of restrictive cardiomyopathy on this page. Incorrect: Dilated cardiomyopathy is the closest distractor since peripartum cardiomyopathy (offered as another option) is actually listed as a cause/association of dilated — not restrictive — cardiomyopathy, and dilated leads to HFrEF, not the picture described here.",
                    "topic": "Ischemic Heart Disease &amp; Heart Failure",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with severe COPD and a separate client with a 10-year history of stable angina both ask whether their condition puts them at risk for heart failure. Based on this content, which statement is accurate?",
                    "options": [
                        "Neither COPD nor stable angina raises HF risk",
                        "COPD raises HF risk; stable angina does not",
                        "Stable angina raises HF risk; COPD does not",
                        "Both raise HF risk equally"
                    ],
                    "answer": 1,
                    "rationale": "Correct: This content explicitly lists COPD as a heart failure cause/risk factor (via right-sided strain), while stable angina by itself is specifically called out as generally NOT a heart failure risk factor. Incorrect: The closest distractor reverses this pairing, claiming stable angina raises HF risk while COPD does not — exactly backwards from what the page states.",
                    "topic": "Ischemic Heart Disease &amp; Heart Failure",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A male client and a female client both had an MI last year. Based on the statistics in this content, which statement about their heart failure risk is accurate?",
                    "options": [
                        "The male client has a higher HF risk after MI",
                        "Both clients have identical HF risk after MI",
                        "The female client has higher HF risk",
                        "Neither client has increased HF risk after MI"
                    ],
                    "answer": 2,
                    "rationale": "Correct: This content states that about 22% of men versus 46% of women who have an MI go on to develop heart failure, meaning the female client's risk is roughly double. Incorrect: The closest distractor claims the male client has the higher risk, which reverses the actual statistic.",
                    "topic": "Ischemic Heart Disease &amp; Heart Failure",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with a history of alcohol use disorder and current marijuana use asks which of these substances is linked to heart failure risk per this content. Which is accurate?",
                    "options": [
                        "Marijuana raises HF risk; alcohol does not",
                        "Both are equally linked to HF risk",
                        "Neither is linked to HF risk",
                        "Alcohol raises HF risk; marijuana does not"
                    ],
                    "answer": 3,
                    "rationale": "Correct: This content specifically notes that alcohol, cocaine, and crack are associated with heart failure risk, while marijuana is currently not associated with that risk. Incorrect: The closest distractor reverses this, claiming marijuana raises risk while alcohol does not — the opposite of what is stated.",
                    "topic": "Ischemic Heart Disease &amp; Heart Failure",
                    "source": "quiz-bank"
                },
                {
                    "stem": "The nurse auscultates a low-pitched heart sound occurring just after S2 in a 52-year-old client. How should the nurse interpret this finding based on this content?",
                    "options": [
                        "An S3 gallop",
                        "A normal S1 split",
                        "A pericardial friction rub",
                        "A benign finding in this age group"
                    ],
                    "answer": 0,
                    "rationale": "Correct: A low-pitched sound heard just after S2 in early diastole is an S3 gallop, and in adults over 40 (this client is 52), it is considered an indicator of heart failure per this content. Incorrect: The closest distractor calls this 'a benign finding in this age group,' but the page specifically states an S3 is a heart failure indicator in adults over 40, not a benign finding.",
                    "topic": "Ischemic Heart Disease &amp; Heart Failure",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client's echocardiogram shows an ejection fraction of 38%, down from a prior normal reading. Which classification and mechanism are consistent with this finding?",
                    "options": [
                        "HFpEF, from impaired ventricular relaxation",
                        "HFrEF, from impaired contractile function",
                        "HFpEF, from preserved ejection fraction and normal relaxation",
                        "Normal cardiac function requiring no follow-up"
                    ],
                    "answer": 1,
                    "rationale": "Correct: An EF of 38% falls below the HFrEF threshold of under 40%, reflecting impaired contractile (pumping) function. Incorrect: The closest distractor labels this HFpEF from impaired relaxation, but HFpEF corresponds to an EF of 40–50% with preserved contractility — an EF of 38% is too low to fit that category.",
                    "topic": "Ischemic Heart Disease &amp; Heart Failure",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with left-sided heart failure is being assessed by the nurse. Which findings should the nurse expect as a result of pulmonary congestion? Select all that apply.",
                    "options": [
                    ...
                    "rationale": "Correct: Left-sided heart failure causes pulmonary congestion, producing crackles, paroxysmal nocturnal dyspnea, frothy/blood-tinged sputum, and orthopnea requiring a tripod position — all from blood backing up into the lungs. Incorrect: Jugular venous distension and dependent edema are systemic congestion findings caused by right-sided heart failure, where blood backs up into the venous system rather than the lungs, per the page's 'left = lungs, right = body' framing.",
                    "topic": "Ischemic Heart Disease &amp; Heart Failure",
                    "source": "quiz-bank"
                }
            ],
    ...
    {
        "id": "week6-cardiac-dysrhythmias",
        "label": "Cardiac Dysrhythmias",
        "week": 6,
        "sets": {
            "mustKnow": [],
            "extraPractice": [
                {
                    "stem": "A client reports sudden-onset palpitations that started 'out of nowhere' 10 minutes ago. The monitor shows a regular, narrow-QRS rhythm at 190 bpm with no discernible P waves. Which rhythm does this most likely represent?",
                    "options": [
                        "Sinus tachycardia",
                        "Atrial flutter",
                        "PSVT",
                    ...
                    "answer": 2,
                    "rationale": "Correct: PSVT presents with sudden, paroxysmal onset, a regular rhythm, narrow QRS, a rate of 150-250 bpm, and P waves that are not discernible — matching every finding here. Incorrect: Sinus tachycardia is the closest distractor, but its rate tops out at 150 bpm, it has a gradual (not sudden/paroxysmal) onset, and it keeps a normal, visible P wave — none of which fit this presentation.",
                    "topic": "Cardiac Dysrhythmias",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client's telemetry shows a regular ventricular rhythm at 100 bpm, narrow QRS complexes, and a sawtooth-shaped baseline replacing the P waves. Which rhythm is this?",
                    "options": [
                        "Atrial flutter",
                        "Atrial fibrillation",
                        "PSVT",
                    ...
                    "answer": 0,
                    "rationale": "Correct: Atrial flutter produces a regular rhythm with narrow QRS complexes and characteristic sawtooth ('shark-tooth') flutter waves in place of P waves. Incorrect: Atrial fibrillation is the closest distractor because it's also an atrial re-entry-type rhythm, but it produces an irregularly irregular rhythm with fine fibrillation waves, not a regular rhythm with organized sawtooth waves.",
                    "topic": "Cardiac Dysrhythmias",
                    "source": "quiz-bank"
                },
                {
                    "stem": "On telemetry, the nurse notes a normal QRS complex followed immediately by a wide, early beat, and this pattern repeats every other beat throughout the strip. Which term describes this pattern?",
                    "options": [
                        "Trigeminy",
                        "Quadrigeminy",
                        "Sinus arrhythmia",
                    ...
                    "answer": 3,
                    "rationale": "Correct: Bigeminy is defined as a PVC occurring every other beat, matching the alternating normal/early-wide-beat pattern described. Incorrect: Trigeminy is the closest distractor, but it refers to a PVC every third beat, not every other beat.",
                    "topic": "Cardiac Dysrhythmias",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A new graduate nurse says, 'Any time I see two PVCs with wide QRS complexes right next to each other, that's ventricular tachycardia.' How should the nurse be corrected?",
                    "options": [
                        "Two PVCs in a row already qualifies as V-tach",
                        "V-tach requires three or more PVCs in a row",
                        "V-tach is defined by rate alone, not PVC count",
                        "PVCs must be in bigeminy to qualify as V-tach"
                    ],
                    "answer": 1,
                    "rationale": "Correct: V-tach is defined as three or more PVCs occurring consecutively, so two wide-QRS beats in a row do not yet meet that threshold. Incorrect: The nurse's own statement (two PVCs = V-tach) is the tempting misconception, since it inappropriately shortens the required run length from three beats down to two.",
                    "topic": "Cardiac Dysrhythmias",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client's telemetry shows sinus bradycardia at 48 bpm. The client is alert, denies dizziness, fatigue, syncope, dyspnea, or chest discomfort, and reports running competitively for years. What should the nurse do?",
                    "options": [
                        "Continue routine monitoring without treating the rate",
                        "Prepare to administer atropine",
                        "Notify the provider to arrange pacemaker placement",
                        "Have the client perform vagal maneuvers to raise the heart rate"
                    ],
                    "answer": 0,
                    "rationale": "Correct: Sinus bradycardia is treated only if the patient is symptomatic, and this client — like many highly fit individuals who naturally run slower — shows none of the symptoms of decreased cardiac output. Incorrect: Atropine is the closest distractor, but it's reserved for severe or symptomatic bradycardia, which this asymptomatic, athletic client does not have.",
                    "topic": "Cardiac Dysrhythmias",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A postoperative client develops sinus tachycardia at 128 bpm. The nurse also notes dry mucous membranes and poor skin turgor, though the client denies pain or anxiety. Which underlying cause should the nurse suspect first?",
                    "options": [
                        "Pain",
                        "Anxiety",
                    ...
                    "answer": 2,
                    "rationale": "Correct: Sinus tachycardia is often one of the first signs of fluid volume deficit, and the dry mucous membranes and poor skin turgor support that cause here. Incorrect: Pain is the closest distractor as a listed cause of sinus tachycardia, but the client explicitly denies pain, making fluid volume deficit the better-supported cue.",
                    "topic": "Cardiac Dysrhythmias",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client's EKG shows occasional early beats with abnormal-looking P waves but normal PR intervals and normal QRS complexes, and the pattern has become more frequent over several telemetry checks. What should the nurse anticipate doing next?",
                    "options": [
                        "Preparing the client for emergency cardioversion",
                        "Administering an antiarrhythmic specifically for these early beats",
                        "Initiating CPR precautions at the bedside",
                        "Checking the client's electrolyte and oxygenation status"
                    ],
                    "answer": 3,
                    "rationale": "Correct: Frequent PACs raise the risk of developing atrial fibrillation, so the nurse should check the client's electrolyte and oxygenation status. Incorrect: Emergency cardioversion is the closest distractor because it sounds like an appropriately cautious escalation, but PACs are described as generally benign and don't call for that level of intervention.",
                    "topic": "Cardiac Dysrhythmias",
                    "source": "quiz-bank"
                },
                {
                    "stem": "Two clients both have atrial fibrillation. Client A has a ventricular rate of 170 bpm; Client B has a ventricular rate of 110 bpm. Based on the page's teaching, which statement is accurate?",
                    "options": [
                        "Client B is more likely to be symptomatic than Client A",
                        "Client A is more likely to be symptomatic than Client B",
                        "Both clients are equally likely to be symptomatic since both are in AFib",
                        "Neither client is likely to be symptomatic since AFib is often silent"
                    ],
                    "answer": 1,
                    "rationale": "Correct: A ventricular rate of 170 is far more likely to be symptomatic than a rate of 110, since symptom burden depends on how much cardiac output the client is actually getting. Incorrect: The 'equally likely' option is the closest distractor because both clients share the same rhythm diagnosis, but the page ties symptom likelihood to the ventricular rate itself, not just the presence of AFib.",
                    "topic": "Cardiac Dysrhythmias",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client asks how serious it is to leave atrial fibrillation untreated. Which statement accurately reflects the risks taught on this page?",
                    "options": [
                        "Doubles cardiac death risk; stroke risk up 4-5x.",
                        "Triples cardiac death risk; stroke risk unchanged.",
                        "Cardiac death risk unchanged; stroke risk doubles.",
                        "Present in under 5% of strokes; rarely serious."
                    ],
                    "answer": 0,
                    "rationale": "Correct: Untreated AFib roughly doubles the risk of cardiac death and increases stroke risk 4- to 5-fold. Incorrect: The option pairing 'stroke risk doubles' is the closest distractor because it uses a real AFib statistic, but the page attaches 'doubles' to cardiac death risk and the 4- to 5-fold increase to stroke risk, not the reverse.",
                    "topic": "Cardiac Dysrhythmias",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client newly diagnosed with atrial fibrillation asks why they need both a beta blocker and an anticoagulant when only one heart problem was found. What is the nurse's best explanation?",
                    "options": [
                        "Anticoagulant only matters before cardioversion",
                        "Beta blocker treats stroke risk; anticoagulant controls rate",
                        "One drug controls rate; the other prevents stroke",
                        "Only the beta blocker is truly needed"
                    ],
                    "answer": 2,
                    "rationale": "Correct: AFib treatment has two parts — rate control (beta blockers, calcium channel blockers, digitalis, or amiodarone) and stroke prevention (anticoagulants or antiplatelets) — so each drug targets a different problem. Incorrect: Swapping the drug roles is the closest distractor because it names the same two treatment goals but reverses which drug class accomplishes which one.",
                    "topic": "Cardiac Dysrhythmias",
                    "source": "quiz-bank"
                },
                {
                    "stem": "The telemetry monitor at the nurses' station suddenly displays a chaotic waveform consistent with ventricular fibrillation for a client down the hall. What should the nurse do first?",
                    "options": [
                        "Call a code and begin CPR based on the monitor alone",
                        "Silence the alarm and reassess the monitor in five minutes",
                        "Increase the alarm limits so the monitor stops flagging the rhythm",
                        "Go to the client and check responsiveness and pulse directly"
                    ],
                    "answer": 3,
                    "rationale": "Correct: Telemetry monitors can glitch and produce a false V-fib-looking waveform, so the nurse must always go to the patient and check a pulse directly before treating what the monitor shows. Incorrect: Calling a code from the monitor alone is the closest distractor because V-fib is a true emergency requiring immediate action, but the page specifically warns against acting on the monitor display without first verifying the patient's actual status.",
                    "topic": "Cardiac Dysrhythmias",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A young, healthy client's telemetry shows a heart rate ranging from 55 to 78 bpm, speeding up with each inhalation and slowing with each exhalation, with a normal P wave and PR interval throughout. How should the nurse interpret this rhythm?",
                    "options": [
                        "Sinus bradycardia requiring atropine",
                        "Sinus arrhythmia, a normal variant",
                        "Sick sinus syndrome requiring a pacemaker",
                        "PACs due to an irritable atrial focus"
                    ],
                    "answer": 1,
                    "rationale": "Correct: Sinus arrhythmia is a normal variant where the rate fluctuates with the respiratory cycle (faster on inhalation, slower on exhalation) with an otherwise normal P wave and PR interval — common in younger people. Incorrect: Sinus bradycardia is the closest distractor because part of this rate range dips below 60 bpm, but true sinus bradycardia is regular rather than varying with respiration.",
                    "topic": "Cardiac Dysrhythmias",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client on digoxin develops a new dysrhythmia. Of the three mechanisms behind dysrhythmias described on this page, which one does digoxin toxicity produce?",
                    "options": [
                        "Triggered activity",
                    ...
                    "answer": 0,
                    "rationale": "Correct: Digoxin toxicity is named as an example cause of triggered activity — an extra impulse generated during or just after repolarization. Incorrect: Inappropriate automaticity is the closest distractor since it's also a mechanism category on this page, but its listed examples are electrolyte imbalance and MI, not digoxin toxicity.",
                    "topic": "Cardiac Dysrhythmias",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A nursing student reviewing a 6-second EKG strip says, \"This QRS complex looks wide, so the client must have an atrial repolarization problem.\" How should the nurse correct this statement?",
                    "options": [
                        "Atrial repolarization is buried inside the QRS complex, not a separate event",
                        "The student is correct; a wide QRS always indicates an atrial repolarization abnormality",
                        "Atrial repolarization would appear as a separate wave after the T wave, unrelated to QRS width",
                        "Atrial repolarization produces no electrical activity, so QRS width cannot reflect it either way"
                    ],
                    "answer": 0,
                    "rationale": "Correct: Atrial repolarization happens at the same time as ventricular depolarization, so it is buried inside the QRS complex and never shows up as its own wave — a wide QRS instead reflects a problem with ventricular depolarization (the QRS complex's actual job), not atrial repolarization. Incorrect: The closest distractor claims the student is correct — tempting because both events do overlap on the strip, but the page specifically attributes QRS width to ventricular depolarization, and atrial repolarization has no separate wave of its own to blame for a width change.",
                    "topic": "Cardiac Dysrhythmias",
                    "source": "quiz-bank"
                },
                {
                    "stem": "Select all findings that are consistent with atrial fibrillation.",
                    "options": [
                        "Irregularly irregular ventricular rhythm",
                        "Fine fibrillation waves in place of P waves",
                        "Ventricular rate typically 100-175 bpm",
                        "Loss of the atrial kick reduces cardiac output by about 20%",
                        "Regular sawtooth flutter waves in place of P waves",
                        "Atrial rate as high as 250 bpm with a fixed conduction ratio"
                    ],
                    "answers": [
                        0,
                        1,
                    ...
                    "rationale": "Correct: Atrial fibrillation is characterized by an irregularly irregular rhythm, fine fibrillation waves rather than a discernible P wave, a typical ventricular rate of ~100-175 bpm, and loss of the atrial kick that costs about 20% of cardiac output. Incorrect: Sawtooth flutter waves and a fixed atrial-to-ventricular conduction ratio (e.g., 2:1, 3:1) are features of atrial flutter, not atrial fibrillation, which by definition has no organized flutter waves or fixed conduction ratio.",
                    "topic": "Cardiac Dysrhythmias",
                    "source": "quiz-bank"
                }
            ],
    ...
    {
        "id": "week6-peripheral-vascular-disease",
        ...
        "sets": {
            ...
            "extraPractice": [
                {
                    "stem": "A client with peripheral artery disease has several risk factors: a 15-year history of type 2 diabetes, an LDL cholesterol of 165 mg/dL, and a 30-year, one-pack-a-day smoking history. The client asks the nurse which risk factor is most important to address first. Which response is accurate?",
                    "options": [
                        "Focus on blood sugar control",
                        "Focus on lowering cholesterol",
                        "Focus on smoking cessation",
                        "Focus on your age-related risk"
                    ],
                    "answer": 2,
                    "rationale": "Correct: The page identifies smoking as \"the single biggest risk factor\" for PAD, noting that more than 80% of PAD patients are current or former smokers and that smoking doubles the risk of amputation, so it takes priority over the client's other risk factors. Incorrect: Blood sugar control matters because uncontrolled diabetes is a listed risk factor, but the page does not rank diabetes as the single biggest risk factor — that distinction belongs to smoking.",
                    "topic": "Peripheral Vascular Disease",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A 34-year-old client who has smoked one pack per day for 15 years is diagnosed with permanent arterial occlusion determined to have an autoimmune basis. Which cause of arterial occlusion does this describe?",
                    "options": [
                        "Buerger disease",
                        "Thrombus formation",
                    ...
                    "answer": 0,
                    "rationale": "Correct: The page describes thromboangiitis obliterans (Buerger disease) as an autoimmune condition strongly associated with smokers that causes permanent arterial occlusion, matching both the smoking history and the autoimmune basis. Incorrect: Raynaud's phenomenon is the next closest option because it also involves smaller-vessel arterial compromise, but the page describes it as sudden vasospasm associated with scleroderma and pulmonary hypertension, not a permanent autoimmune occlusion.",
                    "topic": "Peripheral Vascular Disease",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client reports leg discomfort described as constant aching and tiredness that is present even at rest and does not worsen with walking. The nurse recognizes this description is most consistent with which condition, rather than peripheral artery disease?",
                    "options": [
                        "Buerger disease",
                        "Raynaud's phenomenon",
                    ...
                    "answer": 3,
                    "rationale": "Correct: The page explicitly describes chronic venous insufficiency as causing aching and tiredness in the legs — NOT burning or heaviness — which fits a constant discomfort unrelated to exertion. Incorrect: Arterial insufficiency (PAD) is the closest distractor because it also causes leg discomfort, but the page defines its hallmark symptom as intermittent claudication — exertional cramping that is relieved by rest — not a constant ache present at rest.",
                    "topic": "Peripheral Vascular Disease",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with PAD reports new numbness and weakness in the foot. On assessment the nurse also notes the pedal pulse cannot be palpated. Which additional finding would most strongly support the nurse's concern for significant arterial compromise, per the 5 P's?",
                    "options": [
                    ...
                    "answer": 1,
                    "rationale": "Correct: The page's 5 P's mnemonic for significant arterial compromise is Pain, Pallor, Pulselessness, Paresthesias, and Paralysis; the client already has paresthesia (numbness), paralysis (weakness), and pulselessness, so pallor would complete another of the five criteria. Incorrect: Localized edema is the closest distractor because it is a real finding on this page, but it is listed under chronic venous insufficiency, not among the 5 P's of arterial compromise.",
                    "topic": "Peripheral Vascular Disease",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client's ankle-brachial index (ABI) is reported as 0.4. Based on this value, which action is the priority?",
                    "options": [
                        "Document as a normal finding",
                        "Recheck the ABI in one year",
                        "Notify the provider immediately",
                        "Reassure the client this is normal for age"
                    ],
                    "answer": 2,
                    "rationale": "Correct: The page states an ABI of 0.5 or below indicates severe arterial disease, and a value of 0.4 falls below that threshold, warranting prompt provider notification. Incorrect: Documenting the finding as normal is the closest distractor because a normal ABI (~1.0–1.4) is also stated on the page, but 0.4 is far below that normal range, not within it.",
                    "topic": "Peripheral Vascular Disease",
                    "source": "quiz-bank"
                },
                {
                    "stem": "Two clients are being assessed for lower-extremity vascular disease. Client 1 has a shiny, hairless, thickened lower leg with an ulcer on top of the foot. Client 2 has a leathery, dark-discolored leg with an ulcer near the ankle and visible varicose veins. Which client's findings are most consistent with peripheral artery disease?",
                    "options": [
                        "Client 1",
                        "Client 2",
                        "Both clients",
                    ...
                    "answer": 0,
                    "rationale": "Correct: The page attributes shiny, thick, hairless skin and ulcers at the toes/dorsum of the foot to PAD (arterial disease), which matches Client 1's presentation. Incorrect: Client 2 is the closest distractor because both clients have lower-extremity ulcers, but leathery/dark skin, ankle ulcers, and varicose veins are the page's stated findings for chronic venous insufficiency, not PAD.",
                    "topic": "Peripheral Vascular Disease",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A nurse suspects PAD in a client and wants to elicit both pallor and dependent rubor during assessment. Which technique should the nurse use?",
                    "options": [
                        "Keep the limb level and inspect once",
                        "Apply a tourniquet above the knee",
                        "Palpate pulses only; skip inspecting skin color",
                        "Elevate then lower the limb, comparing color"
                    ],
                    "answer": 3,
                    "rationale": "Correct: The page states pallor occurs with limb elevation and dependent rubor appears when the limb is hanging down, so eliciting both requires changing the limb's position and comparing the color at each. Incorrect: Keeping the limb level and inspecting once is the closest distractor because it still involves visual inspection, but a single level position cannot reveal position-dependent color changes.",
                    "topic": "Peripheral Vascular Disease",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client newly diagnosed with chronic venous insufficiency states, \"This means one of my leg arteries is blocked, like a clogged pipe.\" Which response by the nurse is accurate?",
                    "options": [
                        "That's correct — arterial blockage is the underlying cause",
                        "It's caused by malfunctioning vein walls and valves",
                        "It's caused by high cholesterol clogging the leg veins",
                        "It's an autoimmune reaction affecting the vein walls"
                    ],
                    "answer": 1,
                    "rationale": "Correct: The page states chronic venous insufficiency is caused by dysfunction of the venous walls and valves, leading to venous stasis, not an arterial blockage. Incorrect: The high-cholesterol option is the closest distractor because cholesterol is a real page-stated risk factor, but it is listed under PAD (an arterial condition), not as the cause of venous valve dysfunction.",
                    "topic": "Peripheral Vascular Disease",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with PAD and claudication says, \"I've stopped walking because it causes leg pain, and I don't want to make my circulation worse.\" Which response reflects accurate teaching?",
                    "options": [
                        "Continue resting and avoid walking",
                        "Limit walking to once a week",
                        "Continue regular walking as tolerated",
                        "Switch to a low-fat diet instead of walking"
                    ],
                    "answer": 2,
                    "rationale": "Correct: The page lists increased physical activity as a shared PAD/PVD treatment because it encourages the body to build collateral circulation around blocked vessels, directly countering the client's belief that walking worsens circulation. Incorrect: Continuing to rest and avoid walking is the closest distractor because it feels protective, but the page presents activity, not rest, as the therapeutic recommendation.",
                    "topic": "Peripheral Vascular Disease",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client taking multiple medications with known CYP450 interactions is prescribed a drug for intermittent claudication. Which medication requires the nurse to specifically screen for these interactions?",
                    "options": [
                        "Cilostazol",
                        "Pentoxifylline",
                        "Clopidogrel",
                    ...
                    "answer": 0,
                    "rationale": "Correct: The page states cilostazol (Pletal) has CYP450 drug interactions, making it the claudication drug requiring this specific screening. Incorrect: Pentoxifylline is the closest distractor because it is the other drug listed for intermittent claudication, but the page attributes only nausea, vomiting, dizziness, and TID dosing to it, with no CYP450 interaction noted.",
                    "topic": "Peripheral Vascular Disease",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A nurse is reviewing the medication plan for a client newly diagnosed with PAD who is not yet on a claudication-specific drug. Based on typical PAD management described in the material, which additional medication combination should the nurse expect to see ordered?",
                    "options": [
                        "An opioid and a muscle relaxant",
                        "An antihistamine and a diuretic",
                        "A beta-blocker and a loop diuretic",
                        "A statin plus an antiplatelet"
                    ],
                    "answer": 3,
                    "rationale": "Correct: The page states most patients with PAD are also placed on a statin plus an antiplatelet or anticoagulant agent (examples given: aspirin, clopidogrel, warfarin, apixaban). Incorrect: A beta-blocker and a loop diuretic is the closest distractor because both are plausible cardiovascular medications, but neither is mentioned anywhere on this page as part of standard PAD management.",
                    "topic": "Peripheral Vascular Disease",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A nurse is assessing a client with peripheral artery disease (PAD). Select all findings that are consistent with PAD.",
                    "options": [
                        "Non-healing wound on the lower leg",
                        "Bilateral leg edema",
                        "Diminished or absent pedal pulses",
                        "Leathery, dark discoloration of the skin",
                        "Dependent rubor when the leg is lowered",
                    ...
                    "rationale": "Correct: The page lists non-healing wounds, diminished or absent pulses, dependent rubor, and erectile dysfunction as manifestations of PAD. Incorrect: Bilateral leg edema and leathery, dark skin discoloration are the closest distractors because both are real page findings, but both are listed under chronic venous insufficiency, not PAD.",
                    "topic": "Peripheral Vascular Disease",
                    "source": "quiz-bank"
                }
            ],
    ...
    },
    {
        ...
        "sets": {
            ...
            "extraPractice": [
                {
                    "stem": "A client reports fatigue with minimal exertion and worsening dyspnea when lying flat. The nurse learns the fatigue results from reduced forward cardiac output, and the dyspnea results from blood flowing backward into the left atrium and lungs. Which valve disorder best fits this symptom pattern?",
                    "options": [
                        "Aortic stenosis",
                    ...
                    "answer": 1,
                    "rationale": "Correct: Mitral regurgitation causes fatigue from reduced forward cardiac output and dyspnea from backward flow into the left atrium and pulmonary veins/lungs, exactly as described on the page. Incorrect: Aortic stenosis instead causes syncope, lightheadedness, and chest pain from inadequate coronary flow, not this fatigue/dyspnea pattern from backward flow.",
                    "topic": "Valve Disease",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with severe aortic stenosis develops chest pain. Which mechanism, as taught for this condition, explains the pain?",
                    "options": [
                        "Papillary muscle rupture disrupting leaflet closure",
                        "Backward flow of blood into the left atrium",
                        "Reduced coronary blood flow past the valve",
                        "Vegetation formation impairing valve closure"
                    ],
                    "answer": 2,
                    "rationale": "Correct: In aortic stenosis, the coronary arteries branch off just past the valve and don't receive adequate forward flow when it's stenotic, causing chest pain. Incorrect: Backward flow into the left atrium is the mitral regurgitation mechanism that causes dyspnea, not the chest pain of aortic stenosis.",
                    "topic": "Valve Disease",
                    "source": "quiz-bank"
                },
                {
                    "stem": "Papillary muscle rupture is listed as a mechanism of valve damage that applies only to valves anchored by papillary muscles/chordae tendineae. Which pair of valves can be affected by this mechanism?",
                    "options": [
                    ...
                    "answer": 0,
                    "rationale": "Correct: The tricuspid and mitral valves are the AV valves, anchored by papillary muscles/chordae tendineae, so papillary muscle rupture applies only to them. Incorrect: Pulmonic and aortic are the semilunar valves, which are not anchored by papillary muscles, so this mechanism doesn't apply to them.",
                    "topic": "Valve Disease",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client who already had a standard echocardiogram asks the nurse why a transesophageal echocardiogram (TEE) is now needed. Which response is accurate?",
                    "options": [
                        "The TTE probably missed something because it's less reliable",
                        "The TEE is required before any valve surgery regardless of TTE results",
                        "The TEE evaluates the right side of the heart, which the TTE cannot see",
                        "The TEE gives a closer, more detailed view than the TTE"
                    ],
                    "answer": 3,
                    "rationale": "Correct: The page describes the TEE as a more invasive alternative to the TTE that provides a closer, more detailed view — nothing implies the TTE was inadequate. Incorrect: Telling the client the TTE 'missed something because it's less reliable' misrepresents the TTE, which the page describes as the standard test, not an unreliable one.",
                    "topic": "Valve Disease",
                    "source": "quiz-bank"
                },
                {
                    "stem": "Two clients are scheduled for elective dental extractions. Client A has a prosthetic aortic valve; Client B has no cardiac history. For whom is prophylactic antibiotic therapy indicated before the procedure?",
                    "options": [
                        "Client B only",
                        "Client A only",
                        "Both clients",
                    ...
                    "answer": 1,
                    "rationale": "Correct: Clients with prosthetic heart valves require prophylactic antibiotics before dental procedures because dental work is a known source of transient bacteremia that can infect the prosthetic valve. Incorrect: 'Both clients' incorrectly extends this precaution to Client B, who has no cardiac history and therefore no stated indication for prophylaxis.",
                    "topic": "Valve Disease",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with vegetations on the tricuspid valve develops new-onset shortness of breath and hypoxia. Based on the routing of right-sided septic emboli, where have the emboli most likely traveled?",
                    "options": [
                        "Brain",
                        "Spleen",
                        "Lungs",
                    ...
                    "answer": 2,
                    "rationale": "Correct: Septic emboli breaking off from the tricuspid valve (right-sided) travel to the lungs, per the page. Incorrect: Brain is a destination for emboli from a LEFT-sided valve, not the tricuspid valve, making it the closest but wrong distractor here.",
                    "topic": "Valve Disease",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A nurse is teaching about neurologic complications of infective endocarditis. Which statement about the scope of this risk is accurate?",
                    "options": [
                        "About 40% develop neurologic or embolic stroke-type symptoms",
                        "About 10% develop neurologic or embolic stroke-type symptoms",
                        "About 65% develop neurologic or embolic stroke-type symptoms",
                        "About 90% develop neurologic or embolic stroke-type symptoms"
                    ],
                    "answer": 0,
                    "rationale": "Correct: The page states roughly 40% of infective endocarditis patients develop neurologic or embolic stroke-type symptoms. Incorrect: 10% is the closest lower distractor but understates the specific rate given on the page.",
                    "topic": "Valve Disease",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client presents with fever, chills, unintentional weight loss, and joint pain, with a murmur that is difficult to auscultate. Which condition do these findings best fit?",
                    "options": [
                        "Aortic stenosis",
                        "Mitral regurgitation",
                    ...
                    "answer": 3,
                    "rationale": "Correct: Fever, chills, weight loss, inability to eat, muscle/joint pain, and a murmur that's hard to hear are the symptom profile the page attributes to infective endocarditis. Incorrect: Rheumatic heart disease is only named as another cause of valve damage on the page, without this symptom list attached to it.",
                    "topic": "Valve Disease",
                    "source": "quiz-bank"
                },
                {
                    "stem": "The nurse explains that a vegetation on a heart valve is dangerous for two separate reasons. Which option captures BOTH mechanisms of harm as described?",
                    "options": [
                        "It calcifies the leaflets permanently over time",
                        "It impairs valve closure and can embolize",
                        "It only obstructs forward flow through the valve",
                        "It only travels to distant organs, sparing the valve"
                    ],
                    "answer": 1,
                    "rationale": "Correct: The page states vegetations impair the valve's ability to close properly AND can break off and embolize elsewhere in the body — both mechanisms together. Incorrect: Calcification is listed separately as its own general mechanism of valve damage, distinct from what vegetations specifically do.",
                    "topic": "Valve Disease",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with significant valve disease and an active bloodstream infection is scheduled for valve replacement. What is the priority action regarding the infection?",
                    "options": [
                        "Proceed to surgery, then start antibiotics postoperatively only",
                        "Delay antibiotics until after hospital discharge",
                        "Clear the infection with antibiotics before and after surgery",
                        "Administer antibiotics only if the client develops a fever intraoperatively"
                    ],
                    "answer": 2,
                    "rationale": "Correct: The page states that when infection is involved, any active bloodstream infection must be cleared with antibiotics before AND after surgery. Incorrect: Starting antibiotics postoperatively only ignores the stated need to clear the infection before surgery as well.",
                    "topic": "Valve Disease",
                    "source": "quiz-bank"
                },
                {
                    "stem": "On exam, the nurse finds tender, raised nodules on the pads of a client's fingertips. Which peripheral sign is this, distinguished from a similar but non-tender lesion on the palms?",
                    "options": [
                        "Osler's nodes",
                        "Janeway lesions",
                    ...
                    "answer": 0,
                    "rationale": "Correct: Osler's nodes are tender, raised nodules on the fingertips, distinguished from Janeway lesions, which are non-tender flat spots on the palms or soles. Incorrect: Janeway lesions are the closest distractor because they look similar but are non-tender and located on the palms/soles, not the fingertips.",
                    "topic": "Valve Disease",
                    "source": "quiz-bank"
                },
                {
                    "stem": "The nurse is teaching a group of nursing students about infective endocarditis. Which statements are accurate? Select all that apply.",
                    "options": [
                        "S. aureus and S. epidermidis are the most common causative organisms.",
                        "The tricuspid valve is the most commonly affected valve in infective endocarditis.",
                        "Prosthetic heart valves and IV drug use are the two named risk groups.",
                        "Petechiae are thin, dark red-brown lines found under the nail beds.",
                        "Roth spots are lesions seen on the retina during an eye exam.",
                        "Rheumatic heart disease develops from an infection introduced through IV drug injection."
                    ],
                    "answers": [
                        0,
                        1,
                    ...
                    "rationale": "Correct: The page states S. aureus/S. epidermidis are the most common organisms, the tricuspid valve is the most commonly affected valve, prosthetic-valve patients and IV drug users are the two named risk groups, and Roth spots are seen on the retina during an eye exam. Incorrect: The 'thin, dark red-brown lines under the nail beds' description belongs to splinter hemorrhages, not petechiae (which are pinpoint red/purple spots); and rheumatic heart disease is described as originating from a childhood rheumatic illness, not from IV drug injection.",
                    "topic": "Valve Disease",
                    "source": "quiz-bank"
                }
            ],
    ...
    {
        "id": "week6-cardiac-pharmacology",
        "label": "Cardiac Pharmacology",
        "week": 6,
        "sets": {
            "mustKnow": [],
            "extraPractice": [
                {
                    "stem": "A client taking daily oral isosorbide for anginal prevention develops chest pain at home and plans to take an extra isosorbide tablet before calling anyone. What should the nurse teach instead?",
                    "options": [
                        "Double the next scheduled isosorbide dose",
                        "Use sublingual nitroglycerin now",
                        "Apply a nitroglycerin patch instead",
                        "Skip the next isosorbide dose"
                    ],
                    "answer": 1,
                    "rationale": "Correct: The page specifies that for breakthrough chest pain on isosorbide, the patient should use sublingual nitroglycerin rather than an extra isosorbide dose — isosorbide is for prevention only. Incorrect: Doubling the isosorbide dose is the exact misconception the page warns against; taking an extra dose isn't the taught response to a breakthrough attack.",
                    "topic": "Cardiac Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client received one sublingual nitroglycerin tablet 6 minutes ago for chest pain. Heart rate has risen from 78 to 96 bpm, and the client still rates the chest pain 6/10. What should the nurse do?",
                    "options": [
                        "Reassure the client that tachycardia is expected",
                        "Give a second sublingual nitroglycerin tablet",
                        "Recheck blood pressure and repeat in 5 minutes",
                        "Call 911 for the unrelieved chest pain"
                    ],
                    "answer": 3,
                    "rationale": "Correct: The page's danger callout is explicit that chest pain unrelieved 5 minutes after a sublingual dose itself raises concern for unstable angina or STEMI, and the priority is to call 911. Incorrect: Giving a second dose looks reasonable since up to 3 doses every 5 minutes are allowed, but that protocol detail doesn't override the specific 911 instruction once the 5-minute mark is reached; the heart-rate rise is expected reflex tachycardia from the vasodilating mechanism, not a competing problem.",
                    "topic": "Cardiac Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with stable angina has a blood pressure of 92/58 and continues to have anginal episodes despite a maximized nitrate and beta blocker regimen. Which antianginal addition is most appropriate given the blood pressure?",
                    "options": [
                        "Ranolazine",
                        "Increase the isosorbide dose",
                        "Add transdermal nitroglycerin",
                        "Add IV nitroglycerin"
                    ],
                    "answer": 0,
                    "rationale": "Correct: The page notes ranolazine, unlike the other antianginals, does not drop blood pressure or heart rate the way nitrates do, making it appropriate for a client who is already relatively hypotensive. Incorrect: Increasing isosorbide is the closest distractor — it sounds like a reasonable escalation, but every nitrate formulation works by venodilation and would worsen this client's existing hypotension.",
                    "topic": "Cardiac Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client taking ranolazine for angina is newly prescribed dofetilide for atrial fibrillation. What is the nurse's priority concern?",
                    "options": [
                        "Ranolazine will reduce dofetilide's effectiveness",
                        "Digoxin toxicity risk from the combination",
                        "Additive QT-interval prolongation",
                        "Excess bradycardia from both drugs"
                    ],
                    "answer": 2,
                    "rationale": "Correct: The page explicitly ties ranolazine and dofetilide together as both carrying QT-prolongation risk and states that combining QT-prolonging drugs compounds torsades de pointes risk. Incorrect: Digoxin toxicity is a real amiodarone-digoxin interaction elsewhere on the page — it's the closest distractor because it borrows a real 'dangerous combination' concept, but pairs the wrong drugs.",
                    "topic": "Cardiac Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "The nurse is reviewing a client's heart failure regimen. Which of the following are among the '4 pillars' of HFrEF drug therapy? Select all that apply.",
                    "options": [
                    ...
                    "rationale": "Correct: The page names four pillars of HFrEF therapy — a RAS inhibitor, a beta blocker (carvedilol preferred), an MRA (spironolactone), and an SGLT2 inhibitor. Incorrect: Digoxin and loop diuretics are explicitly described as added on top of the four pillars as needed, not part of the core pillars — loop diuretics in particular give no survival benefit, unlike the four pillar drugs.",
                    "topic": "Cardiac Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client on lisinopril for heart failure develops a persistent dry cough and cannot tolerate it. The client asks whether an ARB could just be added alongside the ACE inhibitor. What should the nurse explain?",
                    "options": [
                        "Add an ARB in addition to the ACE inhibitor",
                        "Switch to an ARB in place of the ACE inhibitor",
                        "Add an ARNI alongside the ACE inhibitor",
                        "Continue the ACE inhibitor and add spironolactone"
                    ],
                    "answer": 1,
                    "rationale": "Correct: The page states a patient is on only one RAS inhibitor (ACE inhibitor, ARB, or ARNI) at a time and they're never combined; the standard swap for ACE-inhibitor cough intolerance is to an ARB, per the page's own mnemonic. Incorrect: Adding an ARNI alongside the ACE inhibitor is the closest distractor — it sounds like an upgrade to the 'most effective' RAS inhibitor, but it violates the same never-combine rule as adding an ARB would.",
                    "topic": "Cardiac Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A heart failure client takes carvedilol and digoxin. Before the scheduled digoxin dose, the apical pulse is 54 bpm for a full minute, and the client reports checking home blood pressure as instructed. What should the nurse do?",
                    "options": [
                        "Give the digoxin dose as scheduled",
                        "Give the carvedilol dose only",
                        "Recheck blood pressure before deciding",
                        "Hold digoxin and notify the provider"
                    ],
                    "answer": 3,
                    "rationale": "Correct: The page's rule is to take a full 1-minute apical pulse before digoxin and hold the dose (then notify the provider) if it's below 60 bpm — 54 bpm meets that threshold regardless of the beta blocker. Incorrect: Rechecking blood pressure addresses carvedilol's home-monitoring watch-for (hypotension), a real page fact but the wrong parameter here — the apical-pulse/60-bpm rule belongs specifically to digoxin administration.",
                    "topic": "Cardiac Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A heart failure client on both spironolactone and furosemide has a potassium level of 5.6 mEq/L. Which drug is most likely responsible?",
                    "options": [
                        "Spironolactone — hyperkalemia",
                        "Furosemide — hypokalemia",
                        "Spironolactone — diuretic effect",
                        "Furosemide — potassium retention"
                    ],
                    "answer": 0,
                    "rationale": "Correct: The page specifically flags spironolactone (an MRA) for hyperkalemia, warning that high potassium raises dysrhythmia risk in an already 'sick heart.' Incorrect: Furosemide (a loop diuretic) causes the opposite problem — hypokalemia, the page's classic risk factor for digoxin toxicity — not hyperkalemia; the two drugs' electrolyte effects run in opposite directions.",
                    "topic": "Cardiac Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client newly started on digoxin asks how the drug level will be monitored during the first weeks of therapy. What should the nurse explain?",
                    "options": [
                        "Peak and trough levels drawn around each dose",
                        "A one-time level after the loading dose only",
                        "A digoxin level checked weekly",
                        "Levels drawn only if symptoms develop"
                    ],
                    "answer": 2,
                    "rationale": "Correct: The page specifies weekly digoxin levels, monitored similarly to INR monitoring, as part of preventing toxicity. Incorrect: Peak-and-trough monitoring is the closest distractor — that's how many other drug levels are monitored, but the page explicitly contrasts digoxin monitoring with that model.",
                    "topic": "Cardiac Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "Which client is at greatest risk for digoxin toxicity based on the risk factors described on this page?",
                    "options": [
                        "A middle-aged man on no other cardiac medications",
                        "An older woman also taking a loop diuretic",
                        "A young man newly started on a beta blocker",
                        "An older man on an SGLT2 inhibitor"
                    ],
                    "answer": 1,
                    "rationale": "Correct: The page names older adults, women, and diuretic use (via diuretic-induced hypokalemia) as the higher-risk factors for digoxin toxicity — this client stacks two of the three. Incorrect: An older man on an SGLT2 inhibitor is the closest distractor since age is one real risk factor, but the page does not list SGLT2 inhibitors as a toxicity risk factor the way diuretics are.",
                    "topic": "Cardiac Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client on digoxin reports new blurry vision. Vital signs show a heart rate of 52 bpm. Which finding is the hallmark sign the nurse should prioritize?",
                    "options": [
                        "The reported visual disturbance",
                        "The client's subjective report overall",
                        "Neither finding is significant alone",
                        "The bradycardia"
                    ],
                    "answer": 3,
                    "rationale": "Correct: The page states bradycardia is the hallmark sign of digoxin toxicity, reinforced by the 'SLOW & BLURRY' mnemonic where 'SLOW' is named as the hallmark. Incorrect: Blurry vision ('BLURRY') is a real toxicity sign too and is tempting since it's the client's own complaint, but the page specifically designates bradycardia — not the visual symptom — as the hallmark finding.",
                    "topic": "Cardiac Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "The nurse is preparing to give an IV push antidysrhythmic drug. Which administration detail correctly matches adenosine rather than atropine?",
                    "options": [
                        "Given via stopcock with a rapid flush",
                        "Given as 1 mg every 3–5 minutes, up to 3 mg total",
                        "Given for any bradycardia, symptomatic or not",
                        "Given to speed up a slow heart rate"
                    ],
                    "answer": 0,
                    "rationale": "Correct: Adenosine must be given through a three-way stopcock immediately followed by a rapid saline flush, or it won't reach circulation fast enough to work given its extremely short half-life. Incorrect: The 1 mg every 3–5 minutes, up to 3 mg total regimen is atropine's dosing, not adenosine's (adenosine is 6 mg, then up to 12 mg, then another 12 mg) — a near-miss that swaps the two drugs' dosing rules.",
                    "topic": "Cardiac Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client is being started on dofetilide for atrial fibrillation. During infusion the monitor shows a fast, polymorphic wide-complex rhythm. What should the nurse do, and where should dofetilide have been initiated?",
                    "options": [
                        "Notify the provider only; initiated in an outpatient clinic",
                        "Give adenosine; initiated in a step-down unit",
                        "Start CPR; initiated in-hospital on telemetry",
                        "Recheck the potassium; initiated at home with monitoring"
                    ],
                    "answer": 2,
                    "rationale": "Correct: This rhythm is torsades de pointes, dofetilide's major risk — the page says to start CPR if it occurs, and dofetilide is always started in-hospital on continuous telemetry specifically because of this risk. Incorrect: Rechecking potassium is a plausible general step but isn't the page's stated action for this event, and dofetilide is never started at home given the torsades risk.",
                    "topic": "Cardiac Pharmacology",
                    "source": "quiz-bank"
                },
                {
                    "stem": "A client with new atrial fibrillation and a rapid ventricular response needs both immediate rate control and long-term maintenance of sinus rhythm from a single drug class. Based on the page's rhythm-control comparison, which drug fits both roles?",
                    "options": [
                        "Beta blocker",
                        "Amiodarone",
                        "Adenosine",
                    ...
                    "answer": 1,
                    "rationale": "Correct: The page's comparison table lists amiodarone for both AFib/flutter rate control and for converting/maintaining sinus rhythm, and separately calls it the most broadly-used antidysrhythmic. Incorrect: Beta blockers are the closest distractor — the page says they're generally tried first for rate control — but the table lists conversion/maintenance only under dofetilide and amiodarone, not beta blockers.",
                    "topic": "Cardiac Pharmacology",
                    "source": "quiz-bank"
                }
            ],
