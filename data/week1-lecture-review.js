  ...
  questions: [
    {
      ...
      options: [
        { text: "Defer drawing the cultures until the patient has fever, as temperature elevates sensitivity of the culture plate" },
        { text: "Obtain the cultures immediately before starting any antimicrobial therapy, as giving antibiotics may prevent organism identification" },
        { text: "Wait until the next morning to obtain cultures when the lab is fully staffed and can process them more efficiently" },
        { text: "Collect cultures only if the patient is hospitalized, as community-acquired infections can be presumptively treated" }
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        { text: "Antibiotics for viral upper respiratory infections work in about 4 out of 10 patients and carry a 1 in 1000 risk of serious allergic reaction or severe diarrhea" },
        { text: "Viruses are too large for antibiotics to penetrate, making the medication ineffective against viral pathogens" },
        { text: "The bacteria in the upper respiratory system are naturally resistant to all common antibiotics used for this indication" },
        { text: "Antibiotics will eliminate the normal flora that protects against secondary fungal infections" }
      ],
      answer: 0,
    ...
    },
    {
      ...
      options: [
        { text: "Nafcillin is poorly absorbed from the GI tract and requires IV administration to achieve adequate blood levels" },
        { text: "Penicillinase-resistant penicillins require continuous IV infusion to maintain peak drug concentrations above the bacterial MIC" },
        { text: "Oral nafcillin would be inactivated by stomach acid before absorption, making it therapeutically ineffective" },
        { text: "The IV route allows nafcillin to bypass the normal renal filtration that would eliminate it if given orally" }
      ],
      answer: 0,
    ...
    },
    {
      ...
      options: [
        ...
        { text: "Anaerobic gram-negative rods" },
    ...
    },
    {
      ...
      options: [
        { text: "Yes, acyclovir eliminates all herpes simplex virus from your body, preventing future outbreaks completely" },
        { text: "No, acyclovir decreases symptom severity and duration but does not eliminate the dormant virus from your nerve cells, so outbreaks may recur" },
        { text: "Acyclovir works by preventing new viral particles from being created, but only if started within 24 hours of symptom onset" },
        { text: "The virus will be cured if you take acyclovir for the full 10 days without missing any doses" }
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        { text: "Oseltamivir binds to influenza proteins on the surface of the host cell, preventing viral attachment and entry" },
        { text: "Oseltamivir inhibits neuraminidase, an enzyme that allows newly formed virus particles to be released from infected cells" },
        { text: "Oseltamivir blocks viral DNA polymerase, preventing the replication of viral genetic material in the host cell nucleus" },
        { text: "Oseltamivir enhances the host immune response by upregulating interferon production against influenza virus" }
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        { text: "Pancytopenia from bone marrow suppression" },
        { text: "Nephrotoxicity and need for careful renal dosing" },
        { text: "Potential fertility impairment and teratogenicity" },
        { text: "Seizures from direct CNS toxicity" },
        { text: "Hepatotoxicity requiring liver function monitoring" }
      ],
      answers: [0, 1, 2],
    ...
    },
    {
      ...
      options: [
        { text: "Broad-spectrum antibiotics eliminated normal colonic flora that normally suppress C. difficile growth" },
        { text: "IV antibiotics accumulate in the colon more readily than oral antibiotics, creating a high-concentration environment for C. difficile proliferation" },
        { text: "Hospitalized patients receiving IV antibiotics lose their normal immune response to enteric pathogens" },
        { text: "Broad-spectrum antibiotics cause direct damage to the intestinal mucosa, promoting C. difficile adherence" }
      ],
      answer: 0,
    ...
    },
    {
      ...
      options: [
        { text: "Azithromycin and ceftriaxone work synergistically to penetrate the thick gonorrheal cell wall more effectively than either drug alone" },
        { text: "Using two antibiotics simultaneously reduces the likelihood that gonorrhea will develop resistance to both agents during treatment" },
        { text: "The combination achieves higher peak serum concentrations than monotherapy, improving bacterial kill rates" },
        { text: "Ceftriaxone and azithromycin target different bacterial structures, providing both immediate and delayed bacterial death" }
      ],
      answer: 1,
